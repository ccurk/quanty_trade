...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=25/24h@09-06 09:1x(main18+壳7;判据未触) | 09-06 09:1x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
