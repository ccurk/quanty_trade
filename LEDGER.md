...
| ~~qt-fade-short~~ | 21519f1b | 停机@08-16 12:26Z劣化线(预注册n≥10∧净≤−5U触发:n12/−5.44;原型病非选币病) | — | stopped(**gated劣化,勿auto-start**) | 复活=新壳走FLEET(tpl576+S25存git);壳=收养错标磁铁(3例实证,#57修复a451d32候部署);**FIX-ALIGN@08-17 18:2x壳出场参数已对齐main**(收养行不走松几何);seed5+auto_symbols=false硬停;全史git 766c7d9+8878e8e前 |
...
- 隔离区(规则≤−4U∧n≥4): 4/CYS/TST/龙虾/BMT/BTW/H/APR/AIO/BICO/**BEAT/XNY**(+BEAT[n9/−4.19混合血统,main era仅−0.76 rehab须知]+XNY[n6/−4.23全main空]@08-17 13:0x;+BICO[n8/−4.05资金费磁铁§6结案]@08-17 03:2x;+AIO/APR/H等史git;逐条全文git bb3b883)。**池列值=快照,权威=每轮对账器输出**。**对账器现版v1.3权威副本=quanty-ledger分支ops/route_pools.py@08-14**(谱系61b1bb4←377c567←f970704;默认分支只有v1.0禁跑[2例错误plan实证];v1.1→v1.3语义演进史+COTI/TUT案全文git bb2e/含头注自文档)。**arg4输入纪律(08-15实证):隔离表必须X/USDT形态**(裸名norm不match feed键→漏移)。出池只认头注规则或隔离,失格=aging_watch advisory;brk/lowvol出池阈值未注册(#42)前无自动出口。最近跑@08-20 03:1x: **plan={}**;desired bl15=actual✓,feed89零泄漏,aging_watch=trend全池ACE/COTI/TUT,**want.fade=CLO/HANA/STAR(HANA首达晋升线nS3/S净+2.17;CLO nS6/STAR nS5续)**,want.brk=JCT/ON存档(壳gated/已删不装池);隔离币零成交✓;无新隔离候选(最差JCT−2.28 n1);前史00:1x+08-19两跑(#20重播种清11→feed89)详git 18a2dfb/e2957e9
- 保证金: Σ_running=main0.08×5+trend0.05×3=**0.55≤0.75✓**(08-16 12:3x fade停机后重算;fade0.04×2出式)
- 互斥不变式: feed层@08-20 03:1x复核=main89/trend3(fade停机无live feed),main∩trend=∅✓;种子层=main bl**15**(12隔离+trend3)=desired**无缺口**;重播种**#20=08-19 15:3x ROLLBACK#61c窗重启100→补刀清11→89泄漏0**(首例bl币直漏feed[ACE/TUT+隔离9币],免疫=交易闸级,详§1.5 main行;#19清10/#17/#18同型;#8-#16史git);引擎互斥闸✓live;**fade壳seed5与main auto理论重叠=停机态无违例**(不变式限定running载具;若owner UI复活fade须先重划池,互斥闸+TG示警兜底);隔离币零成交✓(复核@08-20 03:1x,48h窗隔离12币零平仓行)
...
| 18 | M通道 | closed窗口边界播种修复(幻影行族根因) | 幻影三形态全史+标本链见git 26eaf24 #18行(BTW隙5幻影/镜像行/ROBO整60m例) | n/a | **修复部署@08-15**(f4848f8封边界播种;隙型=另一路径未封,形态与矛盾链存git bb3b883);观察4翻案7隙行/观察5同窗0/观察6拉5全旧→观察8@21:2x拉0幻影(45/45全实);行集随重拉波动=懒生成方向;滤行纪律无限期保留;结案重置=隙型机制源码查明或#56部署后复核 →观察14@08-18 18:2x:0/22(连8轮,续至连11)→**观察15@08-19 06:2x:1/22隙型回归**(BEAT L 08-17 08:21-10:18旧窗行无realized_pnl+sid空,非新交易窗;破连11轮清零;懒生成方向一致,滤行纪律有效)→观察16@09:2x:0/16(BEAT隙行随48h窗滚出,新交易窗零幻影续)→观察17@12:2x:0/18→观察18@18:2x:0/16→观察19@21:2x:0/17→观察20-21@08-20(00:1x+03:1x):双轮0/19 |
...
| 63 | S18域(veto机会成本) | **S18闪跌veto×0.750档结构死锁**:0.750原生档因子组合只在闪跌bar当口成立→同bar必触S18,次bar评分坍缩=#61c因果带机制性零流量 | 影子结算v1两轮:首轮n11/wr73%/+8.22%→次轮7ep/−10.60%全接刀续跌型(MVLL0.90二段−5.85,ep2抽查14:09差0.0008未触SL=逐bar吻合)→**累计n18/wr61%/−2.38%转负**;敏感性:剔MVLL单ep+3.47%仍<正判门(均净0.19%<3×费0.33%,n≥20前数学不可达);重放器逻辑+判据全文git ef6d02e | **结案=S18 KEEP@08-19 15:3x** | **反向判据触发(预注册@12:2x)**:S18保护性>机会成本,接刀通道废弃(S27标签让渡#47);SHAZ右删失随案关闭;**重开=新预注册从零累计**;#61c同步rollback;毒亚型注:EDEN负funding(−0.00107)bonus推档=未来重议接刀首排除项 |
...
| 30 | S21类(代码gate) | 追跌空反弹拒空veto候选(gate7e,暂缓):draft单维300m证伪@08-07(误杀24%);下迭代=加第二维(距60m低点反弹幅/自低点时间) | 累计链git 121e975/42e4fc8/541a2bc(跨币US/AIO/ROBO/VELVET=系统性) | **n=17/−38.94**+候审18(**JCT出列@08-19 21:2x vision验**:入场20:10距60m低点[19:30]+5.29%/低点后41m/前15m动量+2.34%↑30m+4.13%↑=V反弹中途拒空非追跌[追跌要件=向下动量+贴近低点],S19域邻接但入场bar红≠顺涨bar不触其报警,归环境β自成一类不计#30;19→18;CLO−1.57/ON−1.42待08-19 vision档验[00:18Z+03:15Z两查404=T+1延迟(08-18档在),下轮≥08:00Z再试];形态吻合≠语境吻合首实证,前3笔预分类全文git 9d0dc94) | 暂缓;执行门=确认型≥20或owner核准;#11若上线覆盖池级burst亚型,#30残余=个币新鲜度维 |
...
| 08-20 03:11-03:2xZ | 例行轮(max) | 1h0(0)/3h+1.22(1)/6h+2.17(3)/12h+2.14(4,wr50/be2)/24h+0.68(11,wr36/be33) | FGI62 Greed(昨46)/BTC+7.2%/市值+4.2%强升日无降压;trending∩池=PUMP(main,48h零笔) | **HOLD 0原子包**(夜间仅1新笔HANA S+1.22;候选门锁原样[#58候a451d32/#55 trend当口分0.28-0.40连0.55底门不及=解锁亦无流量实证@03:18Z/#47候部署+池薄];#30候审CLO/ON vision 08-19档03:15Z仍404=T+1延迟第2查,下轮≥08:00Z再试);ROUTE plan={}(feed89/trend3互斥∅/bl15=desired/隔离零成交✓/无新隔离候选;**want.fade=CLO/HANA/STAR—HANA首达晋升线nS3/+2.17存档**);刹车全绿(6h+2.17/24h+0.68双正);trend保险6h n0✓(两载具引擎活性03:18Z实证);audit零无主;充值信号维持(12h/24h双正+12h wr−be+48pp,钱包225.81未见入金,不重发建议) | 死法24h(11行):trail/TP4W+5.03/快SL空2−2.99(#30候审)/硬超时3−1.32/BE微损2−0.05;48h组净+3.92(19笔,wr53>be41,均净+0.206🟢)/24h均净+0.062🔴禁提频;回滚后段n4/+2.14均净+0.535=4×🟢(24h窗今晚15:30Z滚净化);trend 48h n1深饿续;幻影0/19(obs21);钱包225.81空仓 |
| 08-20 00:12-00:3xZ | 例行轮(max) | 1h−0.02(1)/3h+0.95(2)/6h+0.95(2)/12h+3.31(5,wr40/be4)/24h+0.40(12,wr42/be40) | FGI62↑Greed(昨46)/BTC+7.7%/市值+7.7%强升日无降压;trending∩池=PUMP(main) | **HOLD 0原子包**(#61c回滚后段3笔+0.92零多头=门0.90关闸如预期;全候选门锁原样[#55 trend 48h n1无费覆数据/#58候a451d32/#47组费覆🔴];#30候审CLO/ON vision 08-19档00:18Z **404未发布**=T+1延迟下轮重试);ROUTE plan={}(feed89零泄漏/trend3种子完好/互斥∅/bl15=desired/隔离零成交✓/无新隔离候选[最差JCT−2.28 n1]);刹车全绿(6h+0.95/24h+0.40双正);trend保险6h n0✓;audit零无主(main末条15:30回滚);**充值信号常备令首触发**(12h/24h双正+12h wr−be=40−4=+36pp≥6+修复见效[回滚后多头失血止]→TG建议充至250-300U,现钱包224.64;诚实注记:24h边际薄+0.40且组24h费覆🔴,owner拍板) | 死法24h(12行全main):trail/TP5胜+4.76/快SL空2−2.99(CLO 07:38+ON 11:29=#30候审两笔)/硬超时3−1.32(HOME/PROM回滚前多头−1.12+STAR)/BE微损2−0.05;48h组净+5.25(19笔,wr53>be38,均净+0.276);CLO+4.35/STAR+4.74双引擎,HANA新币2笔+0.95(nS2未达fade晋升线nS≥3);trend 48h n1(ACE−0.06@08-18)深饿续,want.trend=[]晋升管道断流(main多头门0.90→无多头样本产出=结构性,非故障);幻影0/19(obs20);费覆组24h🔴(+0.034<0.134)禁提频[48h+0.276🟢参考];钱包224.64空仓 |
| 08-19 21:13-21:3xZ | 例行轮(max) | 1h0(0)/3h0(0)/6h−0.03(1)/12h+0.08(5,wr20/be57)/24h−0.55(10,wr40/be53) | FGI46/BTC+7.5%/市值+8.1%强升日无降压;trending∩池=PUMP(main,48h零笔;BTW落榜) | **HOLD 0原子包**(自18:3x轮零新平仓;#30候审JCT vision验**出列**19→18[V反弹中途空非追跌,详§4#30],CLO/ON待08-20档;5h流量枯=漏斗定量33.6h窗仅15发[多2/空13≈0.45/h]泊松正常+门态非故障[IDLE 89/89收流];全候选门锁原样[#55 trend24h n0/#58候a451d32/#47组费覆🔴]);ROUTE plan={}(feed89/trend3互斥∅/bl15 desired=actual/隔离零漏;want.fade=CLO+STAR、want.brk=JCT+ON存档);刹车全绿(6h−0.03/24h−0.55);trend保险6h n0✓;audit零无主 | 死法24h(10行):TP/trail4W+3.79/快SL空2−2.99(CLO/ON强升日β)/硬超时3−1.32/trail早死1−0.03;48h组净+4.30(wr53>be~44)**集中度注记:CLO+STAR11笔+9.09,其余6笔−4.79**;trend 48h n1深饿(want.trend=[]无晋升候选);幻影0/17(obs19);费覆组24h🔴(均净−0.055<0.134)禁提频[48h+0.253🟢参考];钱包223.78空仓;充值不触发(24h负) |
| 08-19 18:14-18:3xZ | 例行轮(max) | 24h−2.83(11,wr36/be50) | FGI46 | **HOLD 0原子包**(#61c回滚后首轮,β快SL3笔环境伤;ROUTE plan={};刹车全绿) | stub;全文git e2957e9 |
| 08-19 15:15-15:4xZ | 例行轮(max) | 24h−0.58(12,wr50/be52) | FGI46 | **1原子包=ROLLBACK(#61c终裁)prem0.19→0.35+#63结案S18 KEEP**(判决全文§4#61/#63);ROUTE重播种#20清11(feed100→89);刹车全绿 | stub;全文git 9d0dc94 |
|---|---|---|---|---|---|

> 瘦身注 08-20 00:3x：08-19 12:21/09:12/06:18三HOLD stub随轮裁(#63登记史在§4#63;push验非空立规注在aefedf6;全文git 10745a2系)。
> 瘦身注 08-19 21:3x：08-18 21:13/18:13两stub行裁(#61c发起与幽灵翻案史已在§4#61/§1.5;全文git a32010c/95e4c9f)。
