...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·**feed88@08-17 15:2x**(#59落地:bl15种子✓@15:19;重启重播种100→heatclean-v11清12→88泄漏0) | running | pct0.08 sides=[buy,sell] long_conf_premium=0.35 tpl567;**trailing(act1.0/cb1.2%)+BE(1.0)=基线几何(#49终裁KEEP@08-16 18:2x)**;_exp=closed(verdict 628字存config._exp.verdict+git);**实验槽空闲**;#49终数与裁由存_exp.verdict+git+§4#49(段n30赔率0.43=统计失真keep;ex-BICO n26/+0.04);RECOVER刹线6h空≤−8U继承;#11降级观察(§4);后续实验以本段为基线;**BICO已隔离@08-17 03:2x**(§6结案) |
...
| 08-17 21:12-21:4xZ | 例行轮(max) | 24h−1.56(15) | FGI31 | 0原子包HOLD(费覆🔴锁#55#47);ROUTE plan={};刹车全绿;**ctx n31 vs closed n15=分腿灌水实证(pnl两侧吻合,ctx窗口只作交叉核对)** | 要点存§1.5/§4;全文git e663d02 |
| 08-17 18:11-18:4xZ | 例行轮(max) | 24h−0.87(15) | FGI31 | **1原子包=FIX-ALIGN**(fade停机壳出场几何对齐main:trailing_act2→1/BE1.2→1,_exp载fade槽,eval=a451d32部署后或08-24);队列HOLD;ROUTE plan={};刹车全绿 | 要点存§1.5 fade行;全文git e663d02 |
|---|---|---|---|---|---|
