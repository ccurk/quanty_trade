...
| # | 类型 | 内容 | 依据 | 复现计数 | 状态 |
| 80 | 代码候选(main多头;S33) | **S32已兑现→已裁ROLLBACK@09-03**(拦截侧2/3正确但W-bar放行侧流血;tpl990关guard保码;verdict=config._exp.s32_verdict+git e97b10c;升门/条件化/裁决全史=git 6d82e95及前链版行) | 4死2赢6例全链日志(§2 S32行) | n=4/−5.21 | **残余=W-bar冲顶回落型n3/−4.89零新增第8轮@09-04 18:2x**(PORTAL16:51 W死拉升仅+2.8%不够格未计)(SKR09-02 00:07−1.29/HEMI09-03 06:43−2.02[+15.5%/180m]/MARSCOIN09-03 16:10−1.58[+9.6%/4.5h];判据同型n≥4∧累净≤−4U→启动S33:净已过线差1例);**S33判别子收敛=拉升幅度非bar向**(bar向双破:W有CAP03:13+3.26大赢反例[仅+4.7%/10m拉升],A有MARSCOIN09-04 11:48−1.07亏例[+72%/100m拉升RSI峰79.7];12:2x改判全文git 6d82e95版行);**15:1x轮判别子第2一致点=MARSCOIN14:01多+1.246**(入场0.17187=自12:07高点0.18131回调−5.2%/114m非拉升→赢,vs同币11:48追+72%穿刺=同币同日敌我对照直证);**18:2x轮第3/4一致点=PORTAL16:51死**(16:45新鲜顶RSI78.7/量×3.63/布林上轨,顶后仅6m/回调−1.4%入场→SL−1.10;拉升+2.8%小=幅度单判别子反例)**+MARSCOIN16:34死**(A-bar,日高0.18131下−0.8%再触→SL−1.26);**收敛v2=距顶时间/回调深度为主判别子**(赢例MARS14:01=顶后114m/−5.2%,CAP=+4.7%小拉升;死例全为顶后≤6m或高位再触),拉升幅度+RSI峰辅助;执行窗=FREQ评后(main _exp槽≤1 in-flight) |
