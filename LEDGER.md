...
| qt-breakout-follow | 2111f5f9 | 突破追动量(S26) | 无(5币孤儿:COOKIE/DYM/BTR候#46释,AKE/EDEN候main重启回feed;COTI已晋trend) | **stopped@08-14 06:50Z(评判FAIL,verdict-gated勿auto-start)** | _exp closed=段n15/−3.23≤−3U宽容线(n≥15先到@06:04第15笔,0.22U边距精确复核);诊断=出场截赢payoff倒挂(trail cb0.8%≈池ATR%1/5一触即出,赢+0.08~+0.38 vs 亏走满2.5ATR −0.84~−2.44,EV/笔−0.22;wr60%>50%=入场核非伪);复活=S27新原型周期(#47,门=组费覆🟢+新预注册+重ROUTE灌池;种子仍3币旧值勿直启);tpl577留DB+git档案 |
...
- 保证金: Σ_running=main0.08×5+trend0.05×3+fade0.04×2=**0.63≤0.75✓**(08-14 06:5x brk停机后复核)
- 互斥不变式: feed层✓(overlap=0三running:main87/trend4/fade2,08-14 06:53复核)>种子层blacklist15(期望12=隔离6+trend4+fade2;#46候main空仓窗释COOKIE/DYM/BTR;AKE/EDEN不在种子,main重启自回feed=无冲突[brk已停])>⚠️引擎互斥闸未部署;COTI晋trend=v1.3 plan首个跨态再路由;aging=trend3/fade2 advisory
...
| #46 | 种子同步 | main blacklist 15→12(释COOKIE/DYM/BTR;COTI留守转trend归类)+symbols种子顺带写当期feed;AKE/EDEN不在黑名单,main重启自回feed | 08-14 07:0x | open,阻塞=main持2Z仓(config需stopped);落地窗=main首个空仓PATCH窗 |
...
|---|---|---|---|---|---|
| 08-14 06:41-07:1xZ | 例行轮(max) | close: 1h+2.25(5)/3h+1.29(8)/6h−2.77(19)/12h−9.09(23,wr39)/24h−7.05(29,wr41;真净−7.87=佣−1.20资费+0.38) | FGI29/BTC−0.90%/mcap−0.93%无降压;trending∩池=ACE+COTI(AKE转孤儿仍在榜) | ①**brk评判=FAIL→预注册回滚执行**(段n15/−3.23≤−3U宽容线,n≥15@06:04先到;stop@06:50+_exp closure;诊断=trail0.8%回调截赢payoff倒挂;S27候选#47) ②ROUTE v1.3:COTI晋trend(孤儿再路由,churn1,trend4币overlap0);#42/#45结案+#46登记(bl15→12候窗) ③1原子包 | 钱包≈243.9(avail225.1+2Z保证金18.8,2Z浮−0.70);main段n20/−6.38:空侧6h+2.04(BEAT+3.25)vs长侧6h−5.02,快SL穿刺6笔/−10.99双侧=夜盘震荡接刀(n<10轶事);RECOVER空侧刹线+2.04远离−8U首评19:00Z;trend累n12/−1.66;fade现池零成交;费覆组🔴−0.24/笔禁提频;保证金Σ0.63;audit零无主改动 |
