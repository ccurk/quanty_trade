...
| ~~qt-breakout-follow~~ | 2111f5f9 | owner删除@08-15 15:5x(评判FAIL史+S26+tpl577存git;#47复活=新壳FLEET) | — | deleted | 幽灵运行时00:1x发现→检疫+heatclean固化,00:11后零新笔(复核@12:1x);**#53修复fa93736候部署**(RemoveStrategy无条件Kill+stopping压制复活;同分支#56 closed归因order_id反查),owner部署+重启即根治;详史git 766c7d9 |
...
- **[速记·压缩@08-16 15:5x] DELETE不杀进程竞态→幽灵载具(brk 2111f5f9实证)**: DeleteStrategy先删DB行,RemoveStrategy仅Status==running才Kill→竞态窗进程存活成幽灵(API全404不可控,仍收feed开仓,三层出场+互斥闸仍罩);杀灭唯一通路=**后端重启**;幽灵账目单列不入载具归因(行带sid=2111可滤);#53修复fa93736候部署即根治;机制全文(源码行号+时间线)git 766c7d9系〔00:2x初登〕
...
| 15 | M通道 | 脱管仓sweeper(实仓∩DB无行→重收养/告警) | KOMA 29h/−15.13+源码L48;FOLKS粉尘watch史git 26eaf24 | 0/2 | **部署实证@08-15**(收养去重入f4848f8;FOLKS消失=收养清理佐证)→零新漂移2-3轮结案 |
| 18 | M通道 | closed窗口边界播种修复(幻影行族根因) | 幻影三形态全史+标本链见git 26eaf24 #18行(BTW隙5幻影/镜像行/ROBO整60m例) | n/a | **修复部署@08-15**(open_key唯一索引+entry去重入f4848f8)→预期归零;滤行纪律观察2-3轮(当轮幻影1=ROBO 08-15 09:17旧例);归零撤销 |
...
| BICO资金费磁铁长侧 | **n3/−2.94@08-16**(04:02+0.57/07:57−1.90/13:32−1.61;三入全为funding−1.1%级→'资金费率<−0.0003:+0.20'bonus推过0.70长门;#49终裁确认=段唯一净亏源;15:32后零新笔) | 08-16 18:2x | 判据:累计≥6笔或净≤−6U→候选化(选项=funding bonus降权/该币CB提前);n3轶事级只记账;归因注记:08-15T18:17 BICO−0.91按池归属应归main(trend feed无BICO)但S24已闭链留trend账,两侧verdict双稳(#49含/不含同结论,S24链n32/+0.93仍keep),不重开 |
...
| 08-16 03:11-04:0xZ | 例行轮(max) | 24h−9.77(36) | FGI34 | 0原子包;**ROUTE:BULLA晋升fade**(nS3/+1.73,03:56收官后rotate+种子5币一气呵成)+#54登§5;#49段n13/−5.33续飞;trend分数墙破案(ACE 0.650×9h顶门0.70→#55候);刹线全绿〔全文git 2aa822b〕 | 费覆24h🔴;钱包≈218 |
| 08-16 00:13-00:3xZ | 例行轮(max) | 24h−7.58(39) | FGI34 | 0原子包;**幽灵brk发现**(23:11Z STAR开仓实证→源码定案§3+检疫rotate main−3+#53登记+TG请重启);#49段n7/−4.37续飞;刹线全绿〔全文git 2aa822b〕 | 幽灵24h n3/−1.64单列 |
|---|---|---|---|---|---|

> 瘦身注 08-16 15:5x：08-15 21:13/19:05/18:12三行随轮裁剪(canary轮+机制发现轮,要点存§3/§4#52)〔前注 12:5x：15:12/16:06两行裁剪(#49上线轮+VELVET晋升轮,要点存§1.5/_exp)〔另 08-15 21:4x：12:18/14:3x/15:2x/15:1x四行裁剪〕(质疑轮结论=era对比部分证实部分证伪+owner择A打#49,全文git 7a6729c前后;其余要点存§1.5/§3/§4/_exp),全史见 git 历史。