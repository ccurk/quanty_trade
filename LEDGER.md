...
| main 通才(平台名 Meme_合约信号计算引擎_1) | 8eb182b6 | 通才(S4..S23+S30+S31+S33;S32关guard;tpl998) | manual 7 币 G/BULLA/MAGMA/UAI/HEI/DRIFT/ARB(owner 06:5x 直令 8 币, POWER 隔离未入; feed7 ∩bl42=∅) | running | **09-19 09:2xZ 现值: pid 55085 START 07:21:21Z 注入 min_conf0.35/cd180/atr 2.0/2.5/warmup50/max_price1e12; pct0.125(DS #7 07:08 砍, owner 值 0.25, 不硬抢) lev10 mcp6(owner 令 10) sides双向 hunger 1m/tp0.30/sl0.04(owner 09-18 17:59 ROI 4%) tp,sl pct0 trailing/BE 关 max_hold45 bl42; 新段(07:21 起) n5 毛 +4.71 wr40% 刀 3/3 亏单 +HEI 多在飞 09:11; _exp_cc=OWNER-DIRECTIVE 多策略化(eval 18:00Z 或 n≥30; rollback=filter 300 池); 史 08:4x/07:3x/05:5x 全文=git 2d9c837 版行** |
| majors(平台名 Majors_BTC_ETH_BNB_SOL) | e725e31a | main fork → **tpl1056 = tpl998 + S35 bar聚合 15m**(CC apply 09-19 08:39:38Z, hash 766b576a, 基线 3e311e8b, config diff=NONE) | manual BTC/ETH/BNB/SOL/XRP(XRP=owner UI 加, 无 audit) | **running@08:01:47Z(owner UI start, 无 audit)** | 09:2x 现值: lev10 pct0.125 mcp5 cd900 max_hold720 hunger off(0.30/0.30 键在) atr 2.0/2.5 min_atr 0.03 symbol_reentry 15m bar_agg_minutes 15 auto_optimize dry_run bl0; 1m 段(08:03-08:20) 3/3 空 SL 毛 −0.78(SL 距 0.08-0.22%=费尺度); **S35 段: 平仓 n0, 在飞 SOL 多 08:46:31(conf0.44 名义 156U SL 距 0.88%)/BNB 多 09:01:31(conf0.44 名义 138U SL 距 0.67%; 信号价 766.40→成交 767.38 滑点 +0.128%=0.47ATR); 信号时刻=15m 边界后 ≈91s(§4 H-0919e)**; _exp_cc=EXP S35(CC-28: eval 09-20 08:40Z 或 n≥15; worsen 段净≤−4U ∨ n≥10∧wr<35% ∨ SL 距中位<0.2%); 回滚=POST rollback→998 或 bar_agg_minutes=1+重启; 归档 confident-fermi 92327c4 strategies/quicktrade-e725e31a/; DS 目标 id=main 不碰本壳; 史 08:4x=git 2d9c837 |
...
### 双执行体(09-17 起)
- **[新增 09-19 07:3x] DS 改动簿 #8 + 熔断器副本漂移 + 优化器禁改缺口**: 07:08:41Z admin {order_amount_pct 0.25→0.125} 单条 PATCH, 无 _exp 锁(#1-#6 均双写 动作+互锁); 仓库 ops/qt_breaker.py 087a6dd@05:14Z: WINDOW 6h/NET −4U/WIN 45%/PCT_FLOOR 0.25("owner order 2026-09-19")/TRIP_COOLDOWN 6h/LOCK 24h→按此 07:08 不应砍(floor 0.25; 距 03:22 仅 3h46m)⇒宿主跑的是另一副本(旧 floor 0.05 且锁写失败, 或 owner 手改), 定案待 owner(CC-24⑦). optimizer FORBIDDEN_EXACT(仓库 087a6dd)只禁币池/sides/_exp/_last_optim ⇒ symbol_select_mode/max_price/min_volatility/_exp_cc/_ai_task_cc/_standby_cc/hunger_*/min_confidence 均可被其 LLM 改(MIN_TRADES 30/窗 6h/deepseek-v4-pro)→CC-24⑧. **max_price=0 语义**: code:1383 Config.MAX_PRICE=max(0,cfg)→code:1008 price>MAX 全拒("币价超上限")=07:13:27→07:21:21 池死 8 分钟(live 会话自纠 1e12+重启; 池切换写 max_price 时必须 1e12 非 0).
...
| CC-11 | 巡检 | 全文=git 6b44db7版§5(要点不变) | 09-18 13:1x | open(读数史 git 2d9c837版; **最新 @09:2x: 钱包≈161.2(avail 119.1+保证金 41.3+浮盈 0.7); income 6h 净 −37.0(≈−19%)报警/24h 净 −99.1(REALIZED −42.2 费 −56.9; 入金 +142 另列)🆘; 最大单仓名义 majors SOL 156U; 最大单亏 DRIFT −0.55(饥饿 0.4% 刀)**) |
...
| CC-28 | 评判(在飞) | **EXP S35 bar聚合 15m on majors**(tpl1056 @09-19 08:39:38Z; 预注册在 majors 壳 _exp_cc; metric=段 n/费后均净/wr/tpsl 日志 SL 距中位/笔日/首单时刻; expect n≥15 费后均净≥0∧SL 距中位≥0.3%∧wr≥45%; worsen 段净≤−4U ∨ n≥10∧wr<35% ∨ SL 距中位<0.2%→ROLLBACK(rollback→998); 24h 零信号无异常→只报) | 09-19 08:4x | open(**@09:2x 平仓 n0; 在飞 SOL 08:46 多/BNB 09:01 多, SL 距 0.88/0.67% 中位 0.77%≥0.3 ✓聚合生效; worsen 未触; 滑点 watch=§4 H-0919e**; eval 09-20 08:40Z 或 n≥15) |
...
| 计数项 | 读数 | 更新轮 | 备注 |
| **09-19 09:2x 7 币池新段(07:21 起)读数** | n5 毛 +4.71 wr40% 均 +0.94: DRIFT +2.48(交易所 TP 7.7m)/HEI +3.55(饥饿 TP 6.8m)/G −0.46(饥饿 SL roi −6.2% 过冲, 1.1m)/G −0.30(饥饿 SL 触发 −4.3% 实 −1.8%, 1.1m, 陈旧价亚型)/DRIFT −0.55(饥饿 SL −4.2%, 5.1m); **亏单 3/3=0.4% 刀**; ATR% 反推 0.52-1.50→ATR SL 距 1.0-3.0% 从未轮到; 成交 conf 0.36/0.48/0.40/0.45/0.44/0.45(HEI 在飞); 速率 5/115min≈63/日 ‖ majors S35 段 平仓 0 在飞 2(SL 距 0.88/0.67%) | 09-19 09:2x | 复读线不变: n≥8∧刀占比≥60%∧段净≤−4U→TG 再荐 B(hunger_sl 0.30); majors 见 CC-28 |
...
## 7. 运行日志（每轮一行，新行追加在表首）
| 2026-09-19 09:1x-09:3x | 定时轮: 管道活(REST 200; 429×3 08:56/09:10/09:13 两壳同秒); 钱包≈161.2(avail 119.1+3 仓保证金 41.3+浮盈 0.7); income 1h −2.2 / 3h −16.3 / 6h −37.0(≈−19%)报警 / 12h −56.6 / 24h 净 −99.1(REALIZED −42.2 费 −56.9; 入金 +142 另列)🆘; main 7 币段(07:21 起) n5 毛 +4.71 wr40% 亏单 3/3=0.4% 刀(G 08:39 触发价偏差亚型), conf 0.36-0.48 门 0.35 在位, ≈63 笔/日, HEI 多在飞 09:11; majors S35 段 平仓 0, 在飞 SOL 08:46/BNB 09:01 多 SL 距 0.88/0.67%(聚合生效), BNB 滑点 +0.128%=0.47ATR→§4 H-0919e(S36 候选, watch); DS: 07:08 后 0 PATCH, _exp closed-owner-unlock, _ai_task_ds null; **0 交易键改动**(两在飞段未到期: main 18:00Z/n≥30, majors 09-20 08:40Z/n≥15); 回测确定性探针 #59/#60 vs #56 同请求 −12.3/+3.6/+7.6 ⇒ 非确定性(§3; #51/#53 0 笔=缺 max_price 已解释), CC-26 晋升暂停, CC-29 根因子代理定位; 留言板 09:25Z(v88, 632 字); 宏观 FGI71 BTC +4.0% ETH +5.4% SOL +5.7% 市值 +1.0% trending∩池 ARB(+SOL∈majors); 下轮=DS 10:0x 节拍对账(pct 再砍→只 TG)+majors 首批平仓读数+CC-29 根因→M 通道 |
| 2026-09-19 08:1x-08:5x / 08:2x(检查轮) / 07:1x-07:3x / 06:1x-06:4x / 05:3x-05:5x / 05:1x-05:5x / 03:3x-03:5x / 00:1x-00:4x / 09-18 20:1x-20:3x | 全文=git 2d9c837(08:1x-08:5x/08:2x/07:1x-07:3x 三行)/6b44db7 版§7(逐行 git d19a237/4c56565/4c56565/f48d043/c06ab72/c06ab72) |
