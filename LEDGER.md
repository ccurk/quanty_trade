...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·**feed89@08-23 18:3x(#29热清11/11;⚠️TUT在押[trend仓]仍放行移除=15:1x"账户级拒"说法反例,has_open_position判定条件降级未定→§6观察)**(#28清10/12+#27清9史git f171d49/f63a060) | running | pct0.08 sides=[buy,sell] **long_conf_premium=0.35(#61c终裁rollback@08-19 15:3x,门0.90=多头事实关闸,#61族基线)** tpl567;**trailing(act1.0/cb1.2%)+BE(1.0)=基线几何(#49KEEP)**;**_exp=closed rollback(#61c;史§4#61/#63+git 0940c62)**;RECOVER刹线6h空≤−8U继承;#11降级观察(§4) |
...
| qt-fade-short-v2 | 7583727a | 冲高回落空(tpl576/S25继承) | HANA/COLLECT/MELANIA(feed3=种子3✓重启重建正确;MELANIA晋升@08-22 15:2x;#57-ROUTE病理活测第3例看护=隔离线/出池线/保险线) | running | 建壳@08-21 16:5x(git f43756c);FLEET评期结案=管道PASS;**低波适配三值包EXP终裁=ROLLBACK@08-23 18:2x**(n16达门:段毛−0.62净≈−1.00 wr38%[6W/10L];预注册二元[段净>0→keep]未达;产出域PASS=16笔/41h vs 解锁前11.5h仅1笔=地板关门机制证实,盈利域FAIL=60m超时慢磨簇≈8/16即低波无行情税;带级护栏−3U/劣化线−4U/6h保险均未触;三值已回滚minatr0.5/adt1.0/scp0.05,stop[poll1]-PATCH-start✓running✓feed3✓;判决全文config._exp+逐笔git);**低波解锁在本regime不付费=组级知识(main 0.5地板维持关门有据)**;_exp=closed空位;保险=6h净≤−6U停(08-09拍板继承);下一评估=S28衰竭签名入场重写(08-24前后,走新_exp) |
...
| 计数项 | 读数 | 更新轮 | 备注 |
|---|---|---|---|
| main断流观测(三闸交集关门) | **首登@08-23 18:1x: 23h零笔**(最后BTR 08-22 19:20平);机制=min_atr0.5地板×多门0.90(#61c)×空门0.60三闸交集,统计行发信号0/0+择优批0+各veto计数0=候选未形成非veto拦(与v2解锁前"11.5h仅1笔"同型,机制落源码);v2 EXP终裁证低波解锁不付费→断流=设计性保资本非故障 | 08-23 18:1x | 判据:池ATR中位回≥0.5后仍6h零笔→查管道;或owner令解锁走EXP(v2学费已交,不建议重复);每轮记main笔数 |
...
| 08-23 15:1x-15:4xZ | 例行轮(max) | 1h0/3h毛−0.72(1)/6h−0.78(2)/12h−0.84(8,wr50/be63)/24h毛−2.75净−2.88(21,wr48/be63=−15pp🔴) | FGI66/BTC+0.4%/市值−2.7%无降压 | **HOLD 0原子包**(两_exp未到门:trend#69段n1·v2段n13/16毛−0.885净≈−1.19 wr31偏回滚[COLLECT±0实结−0.72;带4笔−1.05;终裁08-24 12Z或n16,在飞2仓];**ROUTE=#28热清10/12 feed100→90,COLLECT/MELANIA持仓拒下轮重试**;**crash loop法医学升级=33h15次重启加速,最近2h4次,§3+TG报owner**;刹车全绿载具保险绿;费覆毛均−0.131🔴;充值不发) | 死法24h:超时L7/−2.05(v2×4+trend×3)=最大死法,SL2/−2.24,饥饿L2/−1.51,快胜7/+2.09,超时W3/+0.96;载具:main3/−0.68,trend10/−0.27(COTI磨损),v2 8/−1.80wr25🔴最大失血=载具内超时簇(非币错池,三币aging未触出池线);重启后≤2min开仓n=2→§6;audit零无主;幻影0 |
...
|---|---|---|---|---|---|
> 瘦身注(合并@08-23 18:3x): 08-22 18:1x/15:1x行裁(git cb2fc25/f71d825);§6 fade墙/S23/追跌空/长侧快SL四行压缩+08-22 21:1x行裁(git 8a797ec系);08-22 12:1x/09:1x行裁(git 492779a);08-22 06:1x行裁(git 6283811);08-22 04:1x行裁(owner优化直令轮,git 6283811系);08-22 03:1x行裁(git 6283811系);08-21 16:4x交互轮行裁(FLEET fade-v2建壳,git 9e896ed); 08-21 12:2x行裁(git f623b98); 08-19 21:13行裁(git 7e2b925);08-20 15:16转stub(git bf6c431);08-19 15:15裁(#61c全文§4+git 9d0dc94);08-19 18:14裁(git 82e6cf6);§3超长条压缩史git 0980231;旧注链在git历史。
