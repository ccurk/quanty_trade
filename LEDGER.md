...
| 09-02 15:1x-15:4xZ | 例行轮(max) | −0.65(n2)/+2.79(n5 wr80.0)/+1.58(n7 wr71.4)/−0.28(n11 wr63.6 be65.0 −1.4pp)/−2.99(n22 wr59.1 be66.1 −7.0pp)(毛) | FGI63/BTC76835−1.2%/mcap−4.1%/trend∩池{LIT,MARSCOIN,PYTH,UNI} | **HOLD原子包0;ROUTE v1.5零差分九连(plan空,bl14=期望态,TUT aging第12日,UAI −3.79/n4距隔离线0.21无新亏)** | 钱包≈159.3U(avail141.74+AGT保证金18.0−浮0.46);**#80第4活体实例结局=BTR12:24多+2.36盈**(hold11.8m,48h最大单笔)→预注册反证分支生效:反证n=2合+3.74,升门未触(死法n=3/−3.89)→S32维持候选,设计改注有条件化;T12:34多+0.85=S30深档案良性收束;S31 verdict后多头3笔+1.89;新平仓5:BTR L+2.36/T L+0.85/BTR S+0.22/ZKC L−1.32(SL18m)/牛来 S+0.67;费覆24h🔴七连(avg−0.136 gap−0.238;22笔/日)**但3h/6h段双绿(+0.558/+0.226>0.102)=近段修复迹象n薄慎读**;#79 n31(+双行第6/7案);在飞AGT空36U@15:05(mult1.4,空sid#58族);audit零无主(1792/1790持平);feed90/1零漂移;刹车全距线(6h正/24h−1.9%);充值线未触 |
