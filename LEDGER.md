...
| BICO资金费磁铁长侧 | **n3/−2.94@08-16**(04:02+0.57/07:57−1.90/13:32−1.61;三入全为funding−1.1%级→'资金费率<−0.0003:+0.20'bonus推过0.70长门;#49终裁确认=段唯一净亏源;**08-17 00:2x复核:13:32后10.8h零新笔=自止血**;income直证磁铁结构=BICO 24h收funding+0.292但价亏−2.94=吃小费亏大价) | 08-17 00:2x | 判据:累计≥6笔或净≤−6U→候选化(选项=funding bonus降权/该币CB提前);n3轶事级只记账;归因注记:08-15T18:17 BICO−0.91按池归属应归main(trend feed无BICO)但S24已闭链留trend账,两侧verdict双稳(#49含/不含同结论,S24链n32/+0.93仍keep),不重开 |
...
| 08-17 00:18-00:4xZ | 例行轮(max) | @00:18: 1h+0.24(1)/3h+0.24(1)/6h+0.56(2)/12h+2.34(9,wr78 be67=+10.6pp)/24h−0.50(28,wr68 be69;ex-ghost−0.82) | FGI31/BTC−0.33%/市值−0.31%无降压;trending∩main池=PORTAL/CAP;BTW上榜隔离bl在防 | ①**0原子包HOLD**(无刹车/双_exp空闲/待落0/费覆24h🔴锁#55#47/BICO n3未达门/ROUTE plan={}bl12逐项一致零隔离候选,aging COTI·TUT advisory不变) ②**信号荒诊断=市场性**:22:59后仅TAKE+0.24一笔;00:22实时评估LIGHT conf0.36/MAGMA 0.48<0.55门,低波动折扣=True(ATR%0.10-0.33)周日低波=过滤器拒低赔率环境非故障;feed89/89收K线序号连续 ③幽灵零新笔(19:25 STAR后~5h;fa93736仍候部署) ④**12h费覆首🟢+0.260 vs 0.135(n9)**;24h组−0.018 vs 0.116🔴 ⑤刹线全绿(6h+0.56/24h−0.50 vs −17.8/−44.5;trend6h 0>−5;main空6h+0.24>−8;Σ0.55✓);audit零无主改动;交易所零脱管仓 | 死法24h:WIN19/+10.28;fastSL6/−8.60主刀(main4=BEAT−1.72+BICO−1.61−1.90+SPFN−1.68;fade遗留2/−1.70);hunger1(COTI−0.85);timeout2/−1.33。载具拆分=**main n23/+1.71(wr74;空20/+4.65 wr80;多3全BICO−2.94;最佳SPFN n8/+1.82)**/trend n2/−0.82(09:30后~15h零新开,池3币安静)/fade遗留−1.70/ghost+0.32;钱包222.32空仓;充值信号12h双达标但24h未正=未触发;⏭ROBO幻影10:17出窗核归0/BICO门/24h费覆转正议#55/fa93736部署观察(部署重启→查feed重播种+stopped复活) |
