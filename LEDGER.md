...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=10/24h@12:3x;12h仅3笔(全TAC)=实时分0.36-0.56<门0.55-0.60门内静默;史(23.0h断流定性)git a2e845f | 08-25 12:3x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
