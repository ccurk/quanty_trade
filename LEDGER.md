...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=24/24h@09-05 06:2x(判据未触) | 09-05 06:2x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| 09-05 06:1x-06:3xZ | 例行轮(max) | +1.10(n1)/+0.12(n3)/−0.66(n9 wr56)/−0.66(n9 wr56 be61 −5pp)/−0.90(n30 wr60 be62 −2pp)(毛) | FGI73 BTC79634−1.8% MCAP−3.9% trending∩池∅ | **FREQ终裁KEEP@06:23钟后复核→#83同轮落地=CAP晋升trend(细§5维护注/§1.5)**;ROUTE差分=对账器恰#83零其他(churn1);S33 vision404四币→自查点08:10Z排定;刹车全距线(6h−0.66/24h−0.90 vs 线12.0/30.1);死法24h SL穿刺10/−10.84(多头8/−8.87=S33靶);费覆main24h n24均毛−0.08🔴红23连/trend n6均毛+0.18🟢绿5连;want.fade=BULLA(48h S+1.70 n6,无running壳仅登记) | avail150.2全程空仓窗;充值信号未达(12h/24h双负) |
