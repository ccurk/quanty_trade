...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=15/24h@09-07 00:1x(末笔20:33后3.7h零笔;管道直证活=feed138/138recv+eval流+触发0;低波折扣99%=死盘加深;判据未触[6h未达];ATR中位史git 18ebd9a) | 09-07 00:1x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| 09-07 03:1x-03:4xZ | 例行轮(max) | 0/+0.06(n1)/+0.06(n1)/−1.23(n5 wr60 be88)/−2.99(n13 wr54 be81)(毛) | FGI71 BTC79793−0.16% 市值−2.5% trending∩池=∅ | **HOLD 0原子包11连;ROUTE零差分8连(plan空;bl desired=actual=17)** | 窗新1笔=DOOD空+0.06(10m;空决胜第22例0.72含资费0.20减后0.56<0.60门→镜像n22/+0.74;00:57空0.600恰门被拒=#65短侧保护实证);死盘98%折扣(489/499)延续;S31宽0.413(57/138)=ON→neutral七摆(3h 0.826→0.413);死法24h:穿刺1/−0.77(BULLA trend段5m)饥饿2/−1.61超时3/−1.69赢7/+1.08无聚簇;归因main11/−1.41·壳1/−0.81(COLLECT既案)·trend1/−0.77;48h空n34/−5.98滚出改善(前−7.10,#11门−2.20远离);BULLA段4/6零新;KOMA3/−2.68零新;AKE滚出改善n5/−1.28;S33死例11/15零新(窗无main多死);#79 n46零新;audit零无主;feed138/4∩∅;钱包114.46全avail空仓;费覆组🔴−0.230(main−0.128/trend−0.77);保证金0.55✓;待落0 |
| 09-07 00:1x stub: HOLD10连;ROUTE零差分7连;3.7h零新平仓管道直证活;宽0.826深ON六摆;48h空−7.10;死盘99%;费覆全🔴;全文git e770261版行 |
| 09-06 21:1x stub: HOLD9连;24h−3.51(n22);#85穿刺法医学落账(16/19深gap-through,加宽SL证伪,无可行动修复族);宽0.601五摆;COLLECT CB240m≈21:21到期;全文git 8917d4e版行 |
| 09-06 18:1x stub: HOLD8连;24h−2.82浅回撤;S30镜像n19多cohort7/10;宽0.623;#79 n46;PORTAL出watch;全文git 18ebd9a版行 |
> 瘦身注(指针集@09-07 00:1x归并): 09-05..09-06各轮stub指针集(933abbd/610475d/14eca0b/ff561cc/2af6466/6a3383a/ad3c8d4/e6f5b0f/838122c/044689a内含;09-06 12:1x[MARSCOIN promo_hold/充值首触]+09:1x[S33精测不发货]并入)=git 8917d4e版§7原文。
|---|---|---|---|---|---|
