...
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·**feed140@09-04 09:1x复核∩∅(08-29史链git 13edbef版行)** | running | **pct0.08@09-03 21:2x(E9劣化线ROLLBACK;史0.10@03:46owner直令,段n21/−9.42)** sides=[buy,sell] **bl15@09-03(#81:隔离13+TUT+USELESS,重启免疫闭合;史git)** **select_limit150@09-03 06:2x(FREQ扩面rider)** feed140@09-03 21:2x(E9回滚重启重播种150→热清10[隔离8+trend2]残留0;前史feed139@18:3x) **scp=0.05@08-28 09:33(EXP提频终裁rollback)** **lcp0.15门0.70@08-29(提频直令+S30;史#61c 0.90系git)** tpl990(S32关guard)@09-03 18:2x;**trailing(act1.0/cb1.2%)+BE(1.0)=基线几何(#49KEEP)**;**_exp=open·仅FREQ扩面rider在飞@09-03 06:23注册(新面cohort≤−4U或feed不稳→回100;读数@09-04 12:2x n15/−1.25距线2.75[+MARSCOIN12:07 A多穿刺−1.07;史链−3.52→−0.26→−0.18→−1.25;CAP+3.26大赢仍为回血主体];proxy=CAP,COLLECT,HEMI,MARSCOIN,PORTAL[牛来=老面非cohort];feed稳140/140;评判计划=48h钟09-05 06:23到点cohort>线∧feed稳→KEEP转常规监控)**;**E9=ROLLBACK@09-03 21:2x**(双条件同触;段n21/−9.42;pct回0.08;verdict=config._exp.e9_verdict);**S32=ROLLBACK@09-03 18:3x**(劣化线踩线−3.0044;误杀1/3未触审计线;段损100%在W-bar放行域;tpl990关guard保码;verdict=config._exp.s32_verdict+git e97b10c;残余→§4#80);S31=基线常规监控(KEEP verdict全文移档ops/exp_archive/s31_verdict_20260902.json,原config._exp已被S32覆写);前_exp S30 KEEP@09-01(史git 0940c62);RECOVER 6h空≤−8U继承;#11观察(§4) |
| qt-trend-long | 827ffe8c | 趋势动量多 | **TUT+USELESS双币**(USELESS晋升@09-02 21:2x规则B[trending∩池∧L净+0.81/nL3/wr100%全多,main段36U名义];种子PATCH同窗落库=重启免疫;出池按头注滚动nL≥6∧L净<0;COTI出池@08-24;ACE隔离@08-22;史git f43756c) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on **lcp0.149@09-03(#65 epsilon边界修复;裁决KEEP@09-04 06:3x=段n5/−0.314劣化线−2U未触∧6h保险未触∧06:10 USELESS入场conf=0.7000恰边界=修复因果直证[旧lcp0.15下该信号被浮点等值静默丢弃];混杂注=段活性主体来自USELESS新晋池,边界直证1例;_exp写入落库@09-04 07:3x自查点[stop poll1沉降-PATCH-start全绿];史0.15)**;**_exp=closed·FIX连开解锁 verdict=PASS-KEEP@09-01(段TUT n1=08-29 13:16 L+0.329 hold5m;零连开拦截行;6h保险未触;mces=0维持;评期尾撞49h宕机窗样本稀;verdict全文audit+git史[config._exp已被#65覆写@09-03,再被#65 verdict覆写@09-04])**;mces史git b12d7d9;低波解锁线维持关闭,重开须新regime证据;**常驻保险=滚动6h净≤−5U→stop(继承)**;aging_watch[TUT,USELESS]advisory按对账器头注线(滚动nL≥6∧L净<0)独立看护(USELESS解压@09-04 09:1x:08:34多赢+0.900,滚6 L净+0.42>0出池条远离;仍trending∩池);三值包全史git 8a1d995/f71d825/5df52d2/492779a |
...
- 隔离区(规则≤−4U∧n≥4)【13】: 4/CYS/TST/龙虾/BMT/BTW/H/APR/AIO/BICO/BEAT/XNY/ACE(逐条血统/日期全文git bb3b883/8a797ec/bb2e系)。**池列值=快照,权威=每轮对账器输出**。**对账器v1.5权威副本=quanty-ledger分支ops/route_pools.py@08-29**(v1.5=roster增补breakout复活壳3b646bf4,阈值零改动;谱系v1.4←v1.3←61b1bb4;v1.0默认分支禁跑)。**arg4隔离表必须X/USDT形态**(08-15实证:裸名norm不match feed键→漏移)。出池只认头注规则或隔离,失格=aging_watch advisory;brk/lowvol出池阈值未注册(#42)前无自动出口。**MAGMA网:解除@09-04 03:1x(残n1/+0.09;复挂判据=磁铁型死法再现;史git bf52ca3/ed40296);MARSCOIN watch:n7/−2.87距线1.13@09-04 12:2x(12:07 A多穿刺−1.07新失血;再一笔≈−1.1即机械触线,隔离逼近;仍trending榜);牛来watch:n7/−1.60距线2.40@09-04 12:2x(今3赢+1.07回血解压向,过线即隔离不变)**;对账史压缩@09-01: **09-01泄漏清扫7币feed93零残留(bl14=期望态,隔离13无新增,aging=TUT续,MAGMA网解除)**;08-30 00:1x零差分/08-29斜杠二发史与更早链=git b12d7d9版行;#51-#58史git 9957041/1ae847c/91b3276/830a46c/188af33/66048a9
- 保证金: Σ_running=main0.08×5+trend0.05×3=**0.55≤0.75✓**(09-03 21:2x E9回滚;前史0.65@E9扩仓03:46-21:20)
- 互斥不变式: feed层@09-03 21:2x复核=main140/trend2(TUT,USELESS)**∩∅**(bl15期望态)(v2退役壳+老壳双RETIRED占位=交易/feed层收养封闭,**记账归属层仍漏@09-01(#79双行升级,末代持仓币绑定绕RETIRED闸,详§6)**;重播种漏9热清9/9;隔离13币零在feed✓);种子层bl=18(desired达成@#70);**退役壳自bl5=收养向量封闭**;重播种法医学详§3(签名=top回落~202;bl闸零违例);#20=bl币可直漏feed(交易闸级非feed级);#24/#23及#8-#19史git;引擎互斥闸✓live;**fade壳seed5与main auto理论重叠=停机态无违例**(不变式限定running载具;若owner UI复活fade须先重划池,互斥闸+TG示警兜底);隔离币零成交✓(复核@08-21 09:2x,48h窗隔离12币零平仓行)
...
| # | 类型 | 内容 | 依据 | 复现计数 | 状态 |
| 80 | 代码候选(main多头;S32) | **已兑现@09-03=S32接刀冷却上线(tpl989)**:升门@09-03(ZKC09-02 14:14第4例全链日志实锤:14:11 veto→14:13绿bar重置+RSI门拦→14:14 RSI落68下A-bar入场→SL−1.32;宽口径n=4/累净−5.21双达);条件化按反证约束落地=只拦不稳定窗A-bar,W-bar放行;评判让渡main _exp | 4死2赢6例全链日志(见§2 S32行) | n=4/−5.21 | **已裁=S32 ROLLBACK@09-03(verdict在main _exp;拦截侧2/3正确但放行侧流血)**;残余观察=W-bar冲顶回落型**n3/−4.89@09-03 21:1x复核零新增**(PORTAL18:33超时−0.43非同型,BULLA新3笔全空侧)(SKR09-02 00:07−1.29+HEMI09-03 06:43−2.02[180m+15.5%拉升史]+MARSCOIN09-03 16:10−1.58候审[bar向=W日志实锤,+9.6%/4.5h拉升史,冲顶特征弱:RSI峰61无>70];判据 同型n≥4∧累净≤−4U→新候选S33:净已过线差1例;**S32已回滚@09-03 18:3x**=该型正是S32域外流血主体,S33设计应打拉升史+W-bar二段下杀而非不稳定窗;09-04 03:1x复核零新增第3轮[PORTAL01:09 hold53m慢磨非同型],CAP多02:52候审在飞[W-bar日志实锤+入场前10m拉升4.7% RSI峰78.8→入场67.8,SL0.04662≈−1.16U;SL穿刺即n4/−6.05双门达→S33启动]);**候审证伪@09-04 06:2x=CAP 03:13平+3.26(21m mv+9.8%=48h窗最大单赢)→W-bar放行域反例首登记;09-04 09:1x零新增第5轮(VELVET08:01空SL非同型)n3/−4.89维持;S33若启动设计须以拉升史+RSI峰分离敌我(W-bar本身非死亡签名);**12:2x轮改判新证=MARSCOIN09-04 11:48 A多−1.07穿刺(bar=A日志实锤,拉升史+72%/100m[10:09 0.1095→11:49 0.1885]RSI峰79.7→入场74.3落70.9回落段=ZKC同构)→bar向判别子亦被破[W-bar有CAP大赢反例,A-bar有本案亏例],W-bar型n3/−4.89零新增第6轮维持;S33判别子候选收敛=拉升幅度(亏侧MARS+72%/100m,HEMI+15.5%/180m vs 赢侧CAP仅+4.7%/10m);执行窗=FREQ评后(main _exp槽占用,≤1 in-flight)** |
...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=22/24h@09-04 12:2x(判据未触) | 09-04 12:2x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| #79·closed行sid按symbol旧绑定继承(#77族新亚型) | 两形态:①**双行**(main行+末代壳行同笔PnL双写,壳行tp/sl null裸奔,出场治理权=两行落库序竞态,08-30 03:34壳饥饿档45m真接管收割−0.61实锤;判别特征=末代持仓币BTR/NIL/COLLECT类,泛池币牛来/USELESS零双行)②**空sid**=binance_only视图伪影(全量视图sid=main齐);binance_only对双行币dedup保壳行=池归因陷阱 | 09-01 12:5x | 归因纪律:sid冲突以载具日志开仓链为准,逐笔归因用全量视图+日志链;机制修复并入#77 ownership单一化(候owner部署),部署后复验消失;n32-34案8-10细目git ed40296/e97b10c/a317555版行(案10=首例开管平闭环实证@03:1x);史读链n=26..31细目git ed1ba85/1417e31/558c235版行;**n=35@09-04 06:2x(+BTR05:49案11=−0.326壳行sid=3b646bf4,BTR在main feed逐分钟评估∧brk壳stopped=排除法main开仓,末代持仓币判别再命中)**;**n=36@09-04 07:3x(+VELVET07:24案12=active行sid=7583727a,main开仓链日志实锤conf0.8000空W-bar mult1.4;close行验证命中@09-04 09:1x:08:01平−1.235 sid=7583727a壳行=预测成立,案12开管平闭环第二例)** |
...
| funding磁铁·他币再现watch(重开@08-26;BICO条引用) | era史n=2/累毛−2.83(ONG双案22:56/19:04同构,bonus幅度盲+围栏实证全文git 9b9c39d/86e771d);史BICO n8/−4.05、ACE n4/−4.40〔git 8a797ec/bb3b883〕;**S30深档减半live实证@09-02 12:34(T多资费−0.0073→+0.10按设计;平+0.85@12:42=首例良性收束)** | 08-27 00:2x | **S30已上线@08-29(owner提频直令跳磁铁门,设计按定稿字面实现)**;watch转为疫苗效果验证=main _exp磁铁型死法计数口径;era史n2/−2.83留档;**疫苗期计数@08-29 15:2x: 磁铁型n1=NIL多14:48(资费−0.00074温和档=S30设计内全额+0.20;入场14:48<apply14:52未接种;conf0.75过新门0.70;闪跌SL滑穿0.8%毛−1.40)——非疫苗失效证据,但温和档产磁铁死法首例,累计n≥3或温和档净≤−3U→S30分段下修议案**;**+n2@09-04 12:2x=SIGN深档首死(11:26 W多conf0.70,资费−0.00355深档减半+0.10仍推门[评分行'S30资费<=-0.003磁铁减半'实锤],SL穿刺−1.20@12:09;判据2/3差1例)** |
| short双窗负 | 0维持(逐笔配对为主口径)〔git 6a93e93〕 | 08-06 | 新增空头亏损事件逼近4.6c门→评估 |

## 7. 运行日志（每轮一行，新行追加在表首）
<!-- §7瘦身@09-04 03:1x: 09-03 03:1x stub删(指针8c39ae5不变),21:1x行stub化=git 13edbef版行;前注: 09-03 09:1x/12:2x stub化=8ddf77f,15:3x两stub删=558543d/a3dbdcc -->
| 时间(UTC) | 档位 | 五窗净额 1h/3h/6h/12h/24h | 世界 | 决策 | 备注 |
| 09-04 12:2x-13:0xZ | 例行轮(max) | −2.25(n3)/−0.36(n6)/−0.50(n10 wr70)/+2.24(n18 wr67 be58 +9pp)/−1.61(n31 wr58 be61 −3pp)(毛) | FGI74/BTC81266+4.1%/市值+1.2%/trending∩池=MARSCOIN(main)+USELESS(trend) | **HOLD原子包0;ROUTE零差分23连**(plan={};bl15期望态;隔离13零feed);FREQ rider n15/−1.25距线2.75续飞(feed稳140/140;评判钟09-05 06:23);**#80关键改判=MARSCOIN12:07非W同型(bar=A实锤)→拉升追高型不限bar向,S33判别子收敛拉升幅度(详§4)**;SIGN=S30磁铁深档首死疫苗n2(§6);ZEST在飞=#52案6(n6) | 钱包151.73(bal134.65+ZEST押16.9+浮0.2)vs上轮151.66持平=E9回滚后失血止确认;死法24h=穿刺11/−11.67+WIN18/+11.17+超时1/−0.43+慢磨1/−0.68;费覆:main🔴17连(24h均笔−0.135)/trend🟢全窗(24h+0.151,6h+0.419);载具拆分24h=main n22/−2.97 wr50 vs trend n9/+1.36 wr78;#11空侧−1.99大解压;MARSCOIN隔离逼近距1.13;牛来解压−1.60;audit零无主;无刹车无保险触发;充值线未触(24h负);组合经理注=main双侧微亏均为追高/磁铁单体死法,非池错配,S33窗待FREQ评后 |
| 09-04 09:1x-09:4xZ | 例行轮(max) | +0.97(n2)/−0.14(n4)/+3.66(n9 wr67)/+2.30(n14 wr64 be52 +13pp)/−2.27(n28 wr54 be59 −5pp)(毛) | FGI74/BTC81125+4.1%/市值+2.1%/trending∩池=USELESS(trend)+MARSCOIN(main feed) | **HOLD原子包0;ROUTE零差分22连**(bl15=期望态;plan={});FREQ rider n14/−0.18距线3.82续飞(feed稳140/140评估活跃;评判计划=48h钟09-05 06:23到点cohort>线∧feed稳→KEEP转常规监控);USELESS aging解压(08:34多+0.900,滚6L净+0.42>0);#79案12闭环(VELVET08:01平−1.235 sid=壳行预测命中);#80零新增第5轮;#11空侧24h−4.18距门3.82(VELVET空SL−1.24新失血+窗滚) | 钱包151.66全空仓(00:1x 150.25→+1.4);死法24h=穿刺11/−10.94+WIN15/+9.78+超时1/−0.43+慢磨1/−0.68;日线昨−10.13今+1.94;费覆24h🔴16连(均毛−0.081 vs 0.095)但6h🟢+0.407/12h🟢+0.164;audit零无主;充值线未触(24h负);无刹车无保险触发;组合经理注=24h失血主体为昨日BTC反弹日空穿刺(市况型非池错配,#11看门) |
| 09-04 06:2x-06:5xZ | 例行轮stub: HOLD原子包0;trend #65裁决KEEP(边界修复因果直证,_exp落地07:3x #82结案);FREQ n13/−0.26大回血(CAP+3.26反转);#80候审证伪=CAP同笔入§4反例;牛来退压;#79案11+案12(n36);钱包≈151.9;全文git 7aca6a4版行 |
| 09-04 03:1x-03:4xZ | 例行轮stub: HOLD原子包0;三线逼近全未过(FREQ n12/−3.52距0.48/CAP候审在飞/牛来n4距1.33);MAGMA网解除;#79案10验证命中+#52案5;钱包≈148.1;全文git a317555版行 |
| 09-04 00:1x-00:4xZ | 例行轮stub: HOLD原子包0;ROUTE十九连;#79案10=COLLECT23:31壳行登记+#52案3/4;FREQ n10/−3.05;钱包150.25对账平=E9回滚后失血止;全文git a317555版行 |
| 09-03 21:1x-21:4xZ | 例行轮stub: E9扩仓rider=ROLLBACK pct0.10→0.08(双条件同触;空仓窗stop-PATCH-start全绿;ΣM0.55);FREQ rider n9/−3.08续飞;费覆🔴12连;全文git 13edbef版行 |
| 09-03 18:1x-18:5xZ | 例行轮stub: 原子包1=ROLLBACK S32→tpl990(劣化线1段多头n3/−3.0044精确踩线;stop-PATCH-apply-start三验全绿);MARSCOIN隔离watch起n5/−3.07;#11空侧−3.97;全文git e97b10c版行 |
| 09-03 15:1x-15:4xZ | 例行轮stub: HOLD;CAP#52案2;#11空侧−4.60;全文git f477a04版行 |
| 09-03 12:2x-12:5xZ | 例行轮stub: HOLD;#79案9 COLLECT跨壳泛化n33;全文git 8ddf77f版行 |
> 瘦身注(压缩@09-04 06:4x): 09-03 03:5x/06:2x两owner直令轮+09:1x(S32首日双样本)+06:2x例行轮共4 stub删(全文git 8ddf77f/8c39ae5版行,E9/S32 verdict存main _exp);同轮09-04 00:1x/03:1x行stub化=git a317555版行。
> 瘦身注(压缩@09-03 12:4x): 09-03 03:1x行(S32上线轮)与06:2x例行轮行stub化=git 8c39ae5版行。
> 瘦身注(压缩@09-03 09:3x): 09-02 09:1x行(UAI SL穿越+#80累净−3.89)与09-02 12:2x/15:1x行(BTR#80第4活体在飞及其+2.36结局反证轮)三裁=git 46bd2fc版行(各自全文指针ed1ba85/c69176a保留于该版)。
> 瘦身注(压缩@09-03 00:2x): 09-01 18:1x行裁(#79升#77级实锤轮)=git 558543d版行。
> 瘦身注(压缩@09-02 06:4x): 08-29 21:1x(brk复活评判FAIL退役)=git 3954cea; 08-29 18:1x(brk种子写回+#76验证)=git b12d7d9。
> 瘦身注(压缩@09-02 12:4x): 08-30 00:1x行裁(brk退役后首轮HOLD)=git 497cdf2版行;09-02 06:2x行stub化;§5 #68/#70/#74维护注裁至git指针;§6磁铁watch/EXP0.600档/DB挂死行压缩。
...
|---|---|---|---|---|---|
> 瘦身注(史注归并@09-04 03:1x): 08-24..08-29各轮行裁/合并注全文=git 13edbef版§7尾注(指针集)。
