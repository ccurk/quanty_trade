...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·feed87@21:2x(**bl16v2落地@21:2x(−BICO+AIO)重启免疫**;heatclean-v6:重播种#11 100→87残留0;当日11次重播种全自愈;bl16@19:1x/#50结案史存git) | running | pct0.08 sides=[buy,sell] long_premium=0.35 tpl567;_exp=**FIX-GEO(#49)@15:32:13Z**: trailing(act1.0/cb1.2%)+BE(1.0),TP4.5/SL2.5/premium不动;基线=72h赔率0.88/SL率40%/均净−0.73;**段@21:1x=n6/−5.15/赔率0.31/SL率33%**(+AIO trail锁盈+0.30@20:19;AIO隔离@21:2x=段内2SL源摘除;17:04 VELVET空=main所开日志实证存git)→n<30且回滚线(赔率<1**∧**净≤−10)未触=continue;keep=n≥30或48h先到时赔率≥1.2∧段均净>−0.73;eval 08-16 15:30Z;RECOVER刹线6h空≤−8U继承(现+1.38✓);#11空侧gate=下一槽 |
...
- 互斥不变式: feed层@21:2x=main87/trend3/fade4,**overlap0全绿**(heatclean-v6)>种子层=main bl16v2(−BICO+AIO@21:2x)✓/trend3币✓/fade4币✓>引擎互斥闸✓live;aging=trend2(TUT/COTI)/fade2(1000CAT/ARC) advisory;重播种#8-#10史存git,#11(21:2x主动种子窗)当轮自愈;隔离币15:32后零成交✓bl信号层在防
