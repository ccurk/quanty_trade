...
| 收养错归属亚型(#57族;§4#72) | **n=1维持**(post-fix新增0,最新复核08-26 03:2x✓) | 08-24 21:2x | 判据:自bl后再现sid错归属行→#72升部署主诉求;每轮扫closed行sid=21519f1b计数 |
| main行零归属(空sid;§3 closed回填缺口) | **19/19@08-26 03:2x**(+3新行WTML×2/STAR全空;48h窗main池行全空sid持续;始08-23 18:24;v2三行/trend行sid全正常) | 08-25 21:2x | 无P&L实害(income/守护/池互斥归因全旁路);判据:crash loop根因修复后仍空sid→升M通道close-sync候修;每轮扫main池closed行空sid计数 |
