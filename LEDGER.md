...
| main 通才(平台名 Meme_合约信号计算引擎_1) | 8eb182b6 | 通才(S4..S23+S30+S31+S33;S32关guard) | auto·feed184@09-18 10:2x(隔离∩feed=∅) | running | **09-18 12:5xZ owner重启后: sides=[buy,sell] mcp10 lev10 pct0.075 max_init_margin500 tp/sl pct=0(ATR口径 2.5/4.5×ATR) hunger45m 40%/12.5%ROI cs_mult[0.6,1.0] max_hold240(DS watch) trailing1.0/1.2% BE1.0 cd180/min_conf0.35(12:57重启注入✓) select_limit300 max_price1e12 min_volatility1 bl24 feed283(∩=∅@13:0x); leverage留frozen_keys(=DS勿动)** _exp_cc=cc8 pct0.075 in-flight(eval 18:45Z或n≥30;劣化线段净≤−6U或6h≤−8%→0.05) carry p3_lev10 KEEP 4/4@12:4x, prev P1/P2 KEEP 3/3@10:2x; 刹车链史=git e94a8b0版行; 10:2x态=git 56a5311版行 |
...
| CC-10 | owner裁决 | 保证金百分比突破硬边界#8: A pct0.15 / B 0.25 / C 维持0.075(§1 12:5x行);裁定后同PATCH预注册+劣化线(6h钱包净≤−8%→回0.075) | 09-18 13:0x | open |
