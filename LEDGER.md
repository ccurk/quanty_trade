...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=25/24h@09-07 18:1x(高频活跃;判据远离;史git 1965aac/47753ae) | 09-07 15:2x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| #79·closed行sid按symbol旧绑定继承(#77族新亚型) | 两形态:①**双行**(main行+末代壳行同笔PnL双写,壳行tp/sl null裸奔,出场治理权=两行落库序竞态,08-30 03:34壳饥饿档45m真接管收割−0.61实锤;判别特征=末代持仓币BTR/NIL/COLLECT类,泛池币牛来/USELESS零双行)②**空sid**=binance_only视图伪影(全量视图sid=main齐);binance_only对双行币dedup保壳行=池归因陷阱 | 09-01 12:5x | 归因纪律:sid冲突以载具日志开仓链为准,逐笔归因用全量视图+日志链;机制修复并入#77 ownership单一化(候owner部署),部署后复验消失;案8-21细目与计数史(n38→45;案19=COLLECT首例非良性亏)=git链ed40296/e97b10c/a317555/ed1ba85/1417e31/558c235/7565b0e/8729d22/933abbd版行；**n=53@09-07 15:2x(+COLLECT12:52壳行+0.036良性;+形态③首证=USELESS合成行:binance_only把09-05多单−0.747的pnl嫁接到方向反转/横跨41h空仓期的「空」行[open=前笔平仓刻,close=后笔开仓刻],同窗08:37多单+0.521被记+0.298=窗内净额失真−0.97;判伪三矛盾=方向×价差×盈亏符号)**;归因纪律升级:窗口净额疑异常→全量视图对拆;n51史@09-07 12:4x;史git e6f5b0f/47753ae |
| S31·regime动态方向偏置(**结案KEEP@09-02 06:3x**) | v1谱=宽度三档(EMA-up<0.35 OFF多+0.10/0.35-0.60 N/>0.60 ON多−0.05空+0.05)阈值内联+False-guard,上线09-01 10:02=tpl988;评判KEEP@09-02(段n22/15W7L毛−0.11,ON档多n3均+0.73 vs N/OFF n5净−1.99,劣化线双绿);verdict全文ops/exp_archive/s31_verdict_20260902.json+git 1417e31/eea7cb7/558c235系 | 08-29 17:0x | 常规监控;复核判据:多头累计≤−5U或ON档均净转负→议关guard;verdict后多头4笔+1.96@09-02判据远离；+09-05 09:2x宽度首直采=0.65(138币eval行EMA-up90/138)=ON档实证@−3.2%大盘日；门反证=当日多头死亡簇入场分0.75-0.90均非OFF窗产物且ON降门带[0.65,0.70)零死亡入账=S31非本轮失血向量,残差定性(原型固有方差)成立；宽度直采纪律入轮程(eval行EMA趋势聚合)；regime翻转速度=单日内;直采史全链git ff561cc→e770261→47753ae;直采链末3读=0.656@12:4x ON→0.194@15:2x深OFF八摆(翻转速度新纪录史git f4ac185)→**0.328(61/186)@09-07 18:16 OFF回摆九摆**,日内振荡新常态,判据(多头累计≤−5U或ON档均净转负)远离 |
| funding磁铁·他币再现watch(重开@08-26;BICO条引用) | era史n2/−2.83+BICO/ACE史=git 9b9c39d/86e771d/8a797ec/bb3b883;**S30深档减半实证@09-02(+0.85良性收束)** | 08-27 00:2x | **S30已上线@08-29(owner提频直令跳磁铁门,设计按定稿字面实现)**;watch=疫苗效果验证(磁铁死法计数);era史n2/−2.83留档;疫苗期细目+源码定案+排除案git 8729d22/ad3c8d4版行;**下修议案呈owner@09-05(温和+0.20→+0.10,深+0.10→+0.05)+升级门预注册:多头决胜cohort n≥10∧净≤−3U→S33下修_exp自动执行(劣化线=下修后多头段n≥15净劣于前同窗→回滚),owner否决即关闭**;**多头cohort史git ad3c8d4/e6f5b0f**;**空侧镜像(资金费率>0.0003:+0.20;判据=空侧决胜累计n≥6∧净≤−3U→议短侧入S33包)**:逐轮决胜扫描纪律=新入场评分行含资费bonus且减bonus后<门即计入;批史与逐案细目git 933abbd/e6f5b0f/18ebd9a/8917d4e/47753ae;**@09-07 18:1x镜像再+4(哈基米15:52+0.626/PONS+0.688/PIEVERSE+0.046/COLLECT−0.103,均资费>0.0003决胜0.44-0.55<门0.60)→n31/+1.63空门反向=决胜通道当期主赢面;多头cohort零新(15:2x后主载具零多单)→n8/−4.91=S33下修门(n≥10∧净≤−3U)8/10维持,触发即预注册执行(owner否决即关);15:2x读数史git f4ac185** |
...
| 09-07 18:1x-18:2xZ | 例行轮(max) | 3h+2.72/6h+1.72/12h+2.53/24h+3.15(12h n24wr71be60/24h n31wr74be63,双窗wr−be+11pp;费后24h+2.53=毛3.155−佣0.683+资0.057 income对账闭合) | FGI71贪 BTC79179−0.83% 市值−3.14% trending∩池=PONS | **HOLD 0原子包;ROUTE零差分(BULLA promo_hold清窗自消零提案;aging_watch=[CAP,TUT]);充值信号三条件达标(12h/24h双正+wr−be+11pp≥6pp)→TG建议充至250-300U** | **TRANSFER+40U owner充值确认(income 2笔)→钱包157.60全空仓**;FREQ2 cohort n9/+2.20 wr7/9均毛+0.244绿(哈基米空×4+1.62/PLAY+1.03/PONS+0.69 vs HEMI多×2−1.18唯一负腿);S33门8/10零推进(15:2x后零新多单);镜像+4→n31/+1.63空门反向;S31宽0.328 OFF回摆;24h死法TP19/+6.51穿刺3/−2.76(48h穿刺n10/−7.70较上轮19/−17.55解压)饥饿5/−1.59超时4/+1.00;空n21/+3.31wr81多n10/−0.15;audit1806后零无主;feed186/trend3稳;Σ0.55✓刹车全绿;待落1(#86窗=FREQ2结案) |
| 09-07 12:3x stub: ROUTE:BULLA降级出trend(在池段nL6/−1.18触门6/6;热rotate+种子同窗闭环;promo_hold至15:46Z);#79形态③首证USELESS合成行(n53);S30多头决胜门8/10;修正归因main48h−1.15/trend48h+1.10;0原子包;全文git f4ac185版行 |
