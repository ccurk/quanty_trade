...
| qt-trend-long | 827ffe8c | 趋势动量多 | **TUT+USELESS双币**(USELESS晋升@09-02 21:2x规则B[trending∩池∧L净+0.81/nL3/wr100%全多,main段36U名义];种子PATCH同窗落库=重启免疫;出池按头注滚动nL≥6∧L净<0;COTI出池@08-24;ACE隔离@08-22;史git f43756c) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on **lcp0.149@09-03(#65 epsilon边界修复,_exp=open FIX评09-07或段n≥5;史0.15)**;**_exp=closed·FIX连开解锁 verdict=PASS-KEEP@09-01(段TUT n1=08-29 13:16 L+0.329 hold5m;零连开拦截行;6h保险未触;mces=0维持;评期尾撞49h宕机窗样本稀;verdict全文config._exp)**;mces史git b12d7d9;低波解锁线维持关闭,重开须新regime证据;**常驻保险=滚动6h净≤−5U→stop(继承)**;aging_watch[TUT]advisory按对账器头注线(滚动nL≥6∧L净<0)独立看护;三值包全史git 8a1d995/f71d825/5df52d2/492779a |
...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=25/24h@09-03 21:1x(判据未触) | 09-03 21:1x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| 09-04 03:1x-03:4xZ | 例行轮(max) | 0/−1.36(n5 wr60)/−1.36(n5)/−4.95(n15 wr47)/−9.79(n27 wr48 be71 −23pp)(毛) | FGI74/BTC80902+4.1%/市值+1.07%/trending∩池=USELESS(trend)+MARSCOIN(main) | **HOLD原子包0**;三线逼近全未过:FREQ cohort n12/−3.52距线0.48(CAP多02:52在飞conf0.80 W-bar浮−0.21=决定笔,SL≈−1.16即穿线→下轮机械回100);#80零新增第3轮+CAP候审=第4例候(过即S33双门达);#11空侧24h−5.49距门2.51(四连恶化链断=老亏滚窗);牛来watch新挂n4/−2.67距隔离线1.33;MAGMA网解除(残n1/+0.09);#79案10 close行sid=7583727a验证命中(dedup保壳行+跨壳收养全环节闭环);#52案5=CAP active空sid+main链实锤(n5) | 钱包≈148.1(avail131.69+CAP证16.6+浮−0.21)较上轮−2.15;死法24h=穿刺12/−15.71(空9/−11.3主刀)+赢13/+7.04(7/13为<0.31U残赢=BE/trail刮擦)+超时1;费覆24h🔴十四连(均毛−0.362 vs 0.107);ROUTE零差分二十连(bl15期望态,TUT/USELESS aging advisory续);trend #65段n4/−0.21候评(n5或09-07);audit末条1800=我方E9回滚零无主;充值线未触 |
| 09-04 00:1x-00:4xZ | 例行轮(max) | +0.03(n1)/+0.03(n1)/−2.22(n5 wr40)/−3.85(n13 wr54)/−9.22(n26 wr50 be68 −18pp)(毛) | FGI74/BTC81309+5.5%/市值+1.71%/trending∩池=MARSCOIN(main) | **HOLD原子包0**;ROUTE零差分十九连(bl15=期望态,feed140/2∩∅);#79案10=COLLECT23:31壳行(main开仓链全档conf0.70空mult1.4 A-bar+行带TP/SL非裸奔,active仅壳行可见,close行sid预测=7583727a候验);#52案3/4=MARSCOIN+PORTAL active行sid空(MARSCOIN main链conf0.80多+BE→trail 3m收割+0.03=守护覆盖实锤) | 钱包150.25(avail118.26+仓证31.7+浮0.29)对账平=E9回滚后失血止;隔夜20:28→23:31零开仓后频率回暖(4开/1.2h);FREQ rider n10/−3.05距线0.95续飞(在飞COLLECT+0.30/PORTAL−0.31);trend #65段n3/−0.27+USELESS在飞(评n≥5或09-07);#11空侧n17/−6.01距门1.99四连恶化;MARSCOIN watch n5/−1.87;#80零新增n3/−4.89;MAGMA n2/−1.08(首行滚出窗在即);死法24h=穿刺12/−16.04+赢13/+7.25+超时1/−0.43;费覆24h🔴十三连(均毛−0.355 vs 3×费0.068);audit 21:17后零无主;充值线未触 |
...
| 09-03 06:2xZ | owner直令轮2 stub: FREQ扩面(select_limit150+trend lcp0.149 #65)+拒拧三杠杆;全文git 8ddf77f版行 |
| 09-03 03:5x-04:0xZ | owner直令轮 stub: E9扩仓rider pct0.08→0.10(证据答复wr63<be68已送达);全文git 8ddf77f版行 |
