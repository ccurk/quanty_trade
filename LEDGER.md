...
| qt-breakout-follow-v2 | 3b646bf4 | 突破追动量(S26内核+S27复活锚) | **{BTR,LIGHT,MAGMA,我踏马来了}**@08-29自main接走;+**+BAS,NIL挂池完成@17:4x=池6/6** | running | **tpl973** pct0.05 mcp2 lev2 cd180 minconf0.60 sides双向 trailing(1.0/1.2%)+BE1.0;**_exp=open·FLEET复活@08-29 15:02(owner提频直令;评09-01 15Z或段n≥15;自动保险=滚动6h净≤−5U→stop;劣化回滚=stop+RETIRED占位+4币经bl_sync释放回main)**;MAGMA账户级隔离网继承(n5/−3.53,再亏≥0.47→隔离不论在哪池);live实证@14:49=S26核产分被S21/22正常veto;**sizing六键修复✓@17:4x(#76结案§5维护注;21U地板起效;5U缺陷史§3);分界前段n8/−0.56全5U噪声段(_exp内注分界)**;**⚠️双写污染@16:3x定谳(§4#77): brk每仓被main双记账+main守护共管(hunger 5/8 vs 3/3不同→45m+段实验污染;<45m段参数恰同=可用)**;旧壳FAIL翻案史见2111f5f9行 |
