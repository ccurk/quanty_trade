...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=26/24h@09-06 06:2x(main19+壳7;判据未触) | 09-06 06:2x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| #79·closed行sid按symbol旧绑定继承(#77族新亚型) | 两形态:①**双行**(main行+末代壳行同笔PnL双写,壳行tp/sl null裸奔,出场治理权=两行落库序竞态,08-30 03:34壳饥饿档45m真接管收割−0.61实锤;判别特征=末代持仓币BTR/NIL/COLLECT类,泛池币牛来/USELESS零双行)②**空sid**=binance_only视图伪影(全量视图sid=main齐);binance_only对双行币dedup保壳行=池归因陷阱 | 09-01 12:5x | 归因纪律:sid冲突以载具日志开仓链为准,逐笔归因用全量视图+日志链;机制修复并入#77 ownership单一化(候owner部署),部署后复验消失;案8-14细目git链(ed40296/e97b10c/a317555/ed1ba85/1417e31/558c235/7565b0e/8729d22)；**n=38@09-05 09:2x(+COLLECT×2案13-14=09-03 11:56空+0.52/23:31空+0.21壳行sid=7583727a,良性赢无实害,末代持仓币判别再命中;03:1x轮案8-10计数窗后漏计补记)**；**n=39@09-05 12:2x(+踏马0928案15=我踏马来了10:28 hunger行−0.60 sid=3b646bf4壳,main开仓链09:35:33实锤[触发开仓conf0.7200空W],末代持仓币判别再命中;hold52.5m与main饥饿带兼容,治理权未验)**；**n=42@09-05 21:2x(+案18=COLLECT1940空+0.36壳行sid=7583727a,main开仓链19:01实锤conf0.72,末代持仓币判别续命中良性;48h壳行7,泛池币零双行)**；**n=45@09-06 03:1x(+案19=COLLECT2236空−0.737[main链22:36实锤conf0.68,hold55m饥饿带治理权未验=首例非良性亏since08-30壳收割−0.61]+案20=COLLECT0025空−0.065+案21=VELVET0052空+0.183,均sid=7583727a末代持仓币续命中;案19行懒生成@00:2x轮后现身=滤行纪律再证)** |
| S31·regime动态方向偏置(**结案KEEP@09-02 06:3x**) | v1谱=宽度三档(EMA-up<0.35 OFF多+0.10/0.35-0.60 N/>0.60 ON多−0.05空+0.05)阈值内联+False-guard,上线09-01 10:02=tpl988;评判KEEP@09-02(段n22/15W7L毛−0.11,ON档多n3均+0.73 vs N/OFF n5净−1.99,劣化线双绿);verdict全文ops/exp_archive/s31_verdict_20260902.json+git 1417e31/eea7cb7/558c235系 | 08-29 17:0x | 常规监控;复核判据:多头累计≤−5U或ON档均净转负→议关guard;verdict后多头4笔+1.96@09-02判据远离；+09-05 09:2x宽度首直采=0.65(138币eval行EMA-up90/138)=ON档实证@−3.2%大盘日；门反证=当日多头死亡簇入场分0.75-0.90均非OFF窗产物且ON降门带[0.65,0.70)零死亡入账=S31非本轮失血向量,残差定性(原型固有方差)成立；宽度直采纪律入轮程(eval行EMA趋势聚合)；regime翻转速度=单日内(09-05 0.65ON→0.399N首记录);N档五连09-05 12:2x..09-06 00:2x(0.399/0.478/0.400/0.562/0.572,逐读git ff561cc链);**+09-06 03:1x直采0.333(46/138)=OFF首翻**(N五连后翻档,MCAP−2.4%宽度塌缩;OFF=lcp+0.10→多门0.80生效,弱宽度自动收多闸=设计行为首次全档层实证[ON/N/OFF三态均已直采命中]);+09-06 06:1x直采0.413(57/138)=N回翻,OFF仅单tick(振荡日) |
| funding磁铁·他币再现watch(重开@08-26;BICO条引用) | era史n2/−2.83+BICO/ACE史=git 9b9c39d/86e771d/8a797ec/bb3b883;**S30深档减半实证@09-02(+0.85良性收束)** | 08-27 00:2x | **S30已上线@08-29(owner提频直令跳磁铁门,设计按定稿字面实现)**;watch=疫苗效果验证(磁铁死法计数);era史n2/−2.83留档;疫苗期n1-n6细目+源码定案(L820/823)+排除案全文git 8729d22/ad3c8d4版行;判据n≥3达成@09-05 09:2x→**下修议案呈owner(温和+0.20→+0.10,深+0.10→+0.05,极深−0.10不动)+升级门预注册:决胜cohort累计n≥10∧净≤−3U→S33下修_exp自动执行(劣化线=下修后多头段n≥15且净劣于下修前同长窗→回滚),owner否决即关闭**;**多头cohort n6/−4.37@09-05 12:2x(死4/−5.34+赢2/+0.97;升级门6/10轨迹−3.11→−4.37;成员史git ad3c8d4)**;**空侧镜像(≥等值同口径,资金费率>0.0003:+0.20;独立观测不入多头cohort;判据=空侧决胜累计n≥6∧净≤−3U→议短侧入S33包)**:方向不对称结构化=空侧+0.20在赚不动(史n11/+0.84细目git ff561cc链);**+09-06 03:1x空侧+5决胜闭仓(COLLECT2236−0.74/XAN2348−0.25/COLLECT0025−0.07/MARSCOIN0110+0.21/MARSCOIN0241+0.74,批净−0.10)→镜像累计n16/+0.74**,判据(n≥6∧净≤−3U)仍反向远离;多头cohort零新增(BR0058多0.70无资费bonus非决胜)维持6/−4.37=升级门6/10;UAI0007非决胜史00:2x;逐轮决胜扫描纪律=新入场评分行含资费bonus且减bonus后<门即计入;**+09-06 06:2x XAN0317空决胜闭+0.117(资费+0.20:0.72−0.20=0.52<0.60门)→镜像n17/+0.86,多头零新增维持6/10** |
...
| 09-06 08:4x-08:5xZ | 自查点(P通道;06:5x排定) | — 分析动作0交易0config | — | **S33精测11案兑现**:vision retry#1到档→表11死9赢入档push;扫描64%@0误杀/73%@≤1误杀<80%线=几何族枯竭再证,不发货;#80队列清空,死例T+1追加继续 | RSI口径=Cutler SMA14考订(双旧案exact+KOMA22.8三角验证);距15死差4 |
| 09-06 06:1x-06:5xZ | 例行轮(max) | 0/+0.12(n1)/+1.31(n8 wr75 be37)/−0.24(n16 wr62 be65)/−1.85(n36 wr56 be59)(毛) | FGI73 BTC79937+0.4% trending∩池=MARSCOIN | **HOLD 0原子包4连(3h窗仅XAN1笔;S33精测被vision T+1未发布阻塞[06:2x两试404]→send_later 08:40Z自查点retry#1;S30下修6/10;#11远)** | 空侧镜像+XAN0317决胜(资费+0.20实锤0.72−0.20=0.52<0.60门)闭+0.117→**n17/+0.86**vs多头6/−4.37不对称加深;S31宽0.413=N回翻(OFF单tick振荡);ROUTE零差分3连(bl17达成;BULLA保资格48hL净+2.55;aging=CAP/TUT/USELESS);死法24h:SL穿刺10/−10.49 vs WIN20/+10.77 饥饿1/−0.47 超时5/−1.67;归因main n19/−3.41(6h+1.00 wr80回暖)·trend n10/+2.47·壳n7/−0.90;#79 n45零新增;KOMA/BULLA段零新笔;钱包117.85全avail(+0.09闭合);费覆main24h🔴31连(6h🟢均+0.163)/trend🟢+0.247;保证金0.55;待落0 |
