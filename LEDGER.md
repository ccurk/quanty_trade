...
| # | 类型 | 内容 | 依据 | 复现计数 | 状态 |
| 80 | 代码候选(main多头;S33) | **S32已兑现→已裁ROLLBACK@09-03**(拦截侧2/3正确但W-bar放行侧流血;tpl990关guard保码;verdict=config._exp.s32_verdict+git e97b10c;升门/条件化/裁决全史=git 6d82e95及前链版行) | 4死2赢6例全链日志(§2 S32行) | n=4/−5.21 | **S33启动判据达成@09-04 21:2x: 同型n=4/−6.15双过线**(SKR09-02 00:07−1.29/HEMI09-03 06:43−2.02[+15.5%/180m]/MARSCOIN09-03 16:10−1.58[+9.6%/4.5h]/**案4=SKR09-04 18:11多conf0.75 W-bar −1.26 hold9.6m SL穿刺:17:51低0.022333→20m拉升+5.1%→RSI峰74.2@18:06→18:11入场0.023483=当分钟创新高[距顶0m/回调0%/入场RSI67.6<峰=顶背离]**;案4按v2签名计,幅度口径注记=+5.1%仅略高于CAP赢例4.7%=幅度单判别子再证伪);**v2判别子定稿=双子签名**:(a)新鲜顶=距顶≤6-10m∧回调<1.5%(死:SKR 0m/0%+PORTAL 6m/1.4% vs 赢:MARS14:01顶后114m/−5.2%)(b)高位再触=入场距滚动6h高≤1%(死:MARSCOIN16:34日高−0.8%再触);RSI峰(15m回看)≥70+拉升史=辅助确认;**CAP赢例(RSI峰78.8→入场67.8回落段/+4.7%/10m/未创新高)=(a)回调阈校准关键**→设计轮须vision 1m K(09-04日档T+1)量CAP02:40-03:15/SKR17:45-18:25/PORTAL16:40-17:20/MARSCOIN16:20-17:10四案距顶-回调精确值定阈;内联阈值+S33_ENABLED False-guard+_exp预注册标配;**执行序=09-05 06:2x轮FREQ评判→槽空→S33设计apply(vision日档未出则顺延09:1x轮)[00:2x预查=NoSuchKey未出,09-03档在=路径通]**;收敛过程3轮全文git ab10f1d/2680d89/6d82e95版行 |
...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=25/24h@09-04 15:2x(判据未触) | 09-04 15:2x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
## 7. 运行日志（每轮一行，新行追加在表首）
<!-- §7瘦身@09-04 15:2x: 09-03 12:2x/15:1x两stub删(全文各自git版行),09-04 09:1x行stub化=git 7565b0e版行,12:2x行stub化=git 6d82e95版行;前注@09-04 03:1x: 09-03 03:1x stub删(指针8c39ae5不变),21:1x行stub化=git 13edbef版行;前注: 09-03 09:1x/12:2x stub化=8ddf77f,15:3x两stub删=558543d/a3dbdcc -->
| 时间(UTC) | 档位 | 五窗净额 1h/3h/6h/12h/24h | 世界 | 决策 | 备注 |
| 09-05 00:1x-00:3xZ | 例行轮(max) | 0(n0)/0(n0)/−1.26(n1)/+0.26(n11 wr55 be53 +1.2pp)/+2.20(n31 wr61 be57 +4.5pp)(毛) | FGI73/BTC79712−1.8%/市值−4.2%/trending∩池=MARSCOIN+USELESS | **HOLD原子包0;ROUTE零差分27连**(plan={};bl15/feed140+2∩∅);FREQ n18/−2.37零新增3轮距线1.63续飞(钟今06:23,现读数=KEEP轨);**S33预取vision 09-04日档=NoSuchKey未出(09-03档在=路径通),按§4#80预案06:2x评后再试,仍未出顺延09:1x** | 钱包≈150.8(avail135.41+MARS空保证金~15.6);00:05 MARSCOIN空160@0.1953在飞(sid=""#52型,守护待验,watch币平仓后更新n9/−2.88);牛来−2.27零新增;#79壳行零新增(最新=08:01 VELVET);audit零无主(1800/1801无新);死法24h=SL穿刺9/−9.0+饥饿2/−1.5+超时2微赢+TP赢17/+12.9;费覆24h组🔴+0.072/0.087(main🔴21连+0.052;trend🟢3连+0.128/0.063);trend24h n8/+1.03 wr75% |
| 09-04 21:1x-21:4xZ | 例行轮(max) | 0(n0)/−1.26(n1)/−0.03(n6 wr50)/−0.10(n17 wr59)/+2.20(n31 wr61 be57 **+4.5pp首正**)(毛) | FGI74/BTC79797−2.2%/市值−4.3%/trending∩池=MARSCOIN+USELESS | **HOLD原子包0;ROUTE零差分26连**(plan={};bl15/feed140+2∩∅零漂移);**#80案4=SKR18:11 W多−1.26距顶0m入场即新高→S33启动判据达成n4/−6.15,v2双子签名定稿,执行窗=明06:2x FREQ评后接棒(§4)**;FREQ n18/−2.37零新增距1.63续飞(钟09-05 06:23) | 钱包≈151.2全空仓;24h+2.20=E9回滚后首正;空侧24h+1.71转正#11大解压;费覆24h组🔴均净+0.071/3×费0.087[口径=逐笔名义×0.1%RT](main🔴20连+0.051;trend🟢2连+0.129);死法24h=SL穿刺10/−9.3主导+饥饿域2/−1.5+超时2平+TP赢17/+13.0;MARSCOIN−2.88距1.12/牛来−2.27距1.73零新增;#79 n36零新增;audit零无主;S32 guard=False在场 |
| 09-04 18:1x-18:4xZ | 例行轮stub: HOLD原子包0;ROUTE零差分25连;S33第3/4一致点入§4#80;SKR多34U在飞watch(→案4);FREQ n18/−2.37;#52系统化42/58停逐案计;钱包152.5;全文git ab10f1d版行 | | | | |
| 09-04 15:1x-15:3xZ | 例行轮stub: HOLD原子包0;ROUTE零差分24连;#80判别子第2一致点=MARSCOIN14:01回调赢vs11:48追高死同币对照;FREQ n16/−0.01;钱包151.38;全文git 2680d89版行 | | | | |
| 09-04 12:2x-13:0xZ | 例行轮stub: HOLD原子包0;ROUTE零差分23连;**#80改判=MARSCOIN12:07 A多穿刺破bar向判别子,S33判别子收敛拉升幅度(§4)**;SIGN=S30磁铁深档首死n2;ZEST=#52案6;FREQ n15/−1.25续飞;MARSCOIN隔离逼近距1.13;钱包151.73;全文git 6d82e95版行 | | | | |
| 09-04 09:1x-09:4xZ | 例行轮stub: HOLD原子包0;ROUTE零差分22连;FREQ n14/−0.18续飞;USELESS aging解压;#79案12闭环(VELVET壳行预测命中);#80零新增第5轮;#11读−4.18;全文git 7565b0e版行 | | | | |
