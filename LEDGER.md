...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·feed91(H隔离@08-14 21:26热移除✓;overlap0) | running | pct0.08 sides=[buy,sell] **long_premium=0.35(FIX@08-14 18:47Z)** tpl567;_exp=**FIX长溢价0.15→0.35**(long_thr0.70→0.90;证据=48h长侧n20 wr30/−11.79过20笔门,病根=逆势栈0.70恰等长门,S12先例;keep=08-15 19:00Z长侧24h净≥−2U∧组均净较−0.216改善;劣化=长侧≤−6U或组净恶化→回0.15再议[sell]latch;全文config._exp)+**继承RECOVER刹线**(6h空侧≤−8U→重latch[buy];21:4x读−3.48未触);**FIX段早读@T+5.6h(00:2x轮)**:长侧n2/−1.44(AKE −1.82快SL+AKE +0.38快TP;流量2笔/5.6h≈节流生效),空侧n6/−7.36wr0(ALICE=S20边界+AIO/DOLO=#30型+LAB/H/VELVET三负超时)=**未触路径(空侧)是段主刀**;长侧劣化线−6U未触不提前动,滚窗伪影纪律照旧;19:00Z评判提示:keep门'组均净较−0.216改善'臂受空侧拖累,判读须按侧拆臂说理;bl期望态=换CAP入H(13)候重启窗;sid伪影纪律照旧(§3) |
| qt-trend-long | 827ffe8c | 趋势动量多 | ACE/TUT/BICO/COTI(feed4;**CAP出池@08-15 00:19**热执行✓;种子config.symbols仍5含CAP候重启窗刷;aging_watch=TUT/BICO advisory) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;_exp v3常驻:**累计n23/−1.02**(+CAP timeout+0.14@08-14 23:30);keep门净>0✗∧费覆滑🔴24h+0.060 vs 0.074=0.81×;劣化−5U/canary−5U(现6h−0.64)未触;**终裁08-16 06:35Z当值净>0=keep**;ACE 48h+3.44/COTI+3.56双扛旗∧ACE trending;全史git+config._exp |
| qt-fade-short | 21519f1b | 冲高回落空 | 1000CAT/ARC(种子✓;aging_watch全2币) | running@08-13 12:45Z | **tpl576(S25)** pct0.04 mcp2 sell;_exp v2续:累计n8/−2.63零增(现池零成交**第9轮**,want.fade=[]连续;非载具故障[引擎统计行00:1x在读0/0]);评期=累计n≥15或**08-16 12:50Z**(明日到点n8<15将再触证据不足格→届时议池补灌或停驶取舍);自动保险6h≤−6U(0✓) |
...
- 互斥不变式: feed层✓(overlap=0三running:main91/trend4/fade2,08-15 00:2x CAP出池后复核;CAP孤儿态安全)>种子层bl实13(含CAP缺H),desired13=**换CAP入H**候重启窗PATCH(feed层已防:H不可交易,CAP无人交易)>⚠️引擎互斥闸未部署;aging=trend2/fade2 advisory
...
| 08-14 14:38-15:1xZ | 例行轮(max) | 12h+3.87(29)/24h−4.68(44,wr48) | FGI29无降压 | ①ROUTE:CAP晋trend(churn1) ②trend累计首次转正n20/+0.72 ③#46落地@15:03(竞态教训立规一窗一执行器,详§5维护注) ④0原子包 | 全文见git a3804f3 |
| 08-14 09:28-09:5xZ | 例行轮(max) | 24h−6.30(37,wr46) | FGI29无降压 | ①S24评期v2裁决=keep未达∧劣化未触→转v3常驻+COTI种子同步 ②ROUTE plan={} ③#46三连试失败回队 ④sid伪影定案§3 ⑤1原子包 | 全文见git a3804f3 |

> 瘦身注 08-15：更老运行日志行随轮裁剪(08-14 06:41轮brk评判FAIL要点存brk _exp+§1.5+#47;08-14 00:32轮v1.3对账器要点存§1.5对账器行),全史见 git 历史。