...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·**feed92@08-24 06:3x(05:58Z restart重播种100→ROUTE#33 purge8→92,18 bl币零残留✓;#29热清史18:50-51两步100→94→89 git f171d49/f63a060)** | running | pct0.08 sides=[buy,sell] **long_conf_premium=0.35(#61c终裁rollback@08-19 15:3x,门0.90=多头事实关闸,#61族基线)** tpl567;**trailing(act1.0/cb1.2%)+BE(1.0)=基线几何(#49KEEP)**;**_exp=closed rollback(#61c;史§4#61/#63+git 0940c62)**;RECOVER刹线6h空≤−8U继承;#11降级观察(§4) |
| qt-trend-long | 827ffe8c | 趋势动量多 | **COTI/TUT**(种子2=feed2✓#26重启后重建正确;ACE隔离@08-22 12:22;aging=COTI(TUT脱watch@08-24;COTI 24h−1.40/6笔48h+1.32未触出池线);破荒史git f43756c) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;**_exp=open·#69三值包重申请@08-23 09:18Z**(adt0.5+lcp0.149+mces off;终裁二元=新段净>0→keep否则回滚[adt1.0/lcp0.15/mces3];eval=n≥16或08-25 09:18Z;劣化线n≥8∧≤−4U;**进度@08-24 06:3x段n3净−0.90**(COTI−0.06/TUT+0.08/COTI−0.76超时45m;劣化线n≥8∧≤−4U未触;新开TUT多现浮盈+0.65骑赢家trailing on;COTI 24h−1.62=最大失血仍aging_watch未触出池/隔离线;feed2在流);否决窗空置+程序史git 492779a);原三值段终裁rollback(n18净−0.40)+ex-ACE归因(n14净+4.11 wr86%)全文git 5df52d2+config史;**常驻保险=滚动6h净≤−5U→stop(继承)**;三值包全史git 8a1d995/f71d825;S24 keep史git f43756c |
| qt-fade-short-v2 | 7583727a | 冲高回落空(**tpl823/S28**;谱系tpl576/S25) | HANA/COLLECT/MELANIA(feed3=种子3✓;MELANIA晋升@08-22;#57-ROUTE病理活测第3例看护) | running | **S28衰竭签名直入上线@08-23 21:24Z**(#66修复:short∧RSI>75∧价≥布林上轨∧末bar涨<0.3×ATR%仅旁路EMA方向+趋稳一门,S19/S20/RSI<32/量能/ATR带/追空ext全保留;附随#65 epsilon永久化[ss≥thr−1e-9;0.60精确组合RSI0.30+BB0.15+MACD0.15=S28主通道解锁];apply字节复检✓零config泄漏✓feed3✓烟雾MELANIA18h task30;载具级重启实证→§6);**_exp=open·EXP:S28**(二元:段净[Σpnl−名义×0.1%]>0→keep否则rollback回tpl576;劣化线段n≥8∧≤−4U即回;评期段n≥16或08-25 21Z;崩溃立即回滚;**进度@08-24 06:3x段n0**@9h(自21:24Z apply零发单;ss顶0.560<0.60门=衰竭签名邻近未现·0Traceback管道健康;FGI73greedy市顶稀少;若eval 08-25 21Z仍n0则段净=0非>0→届时rollback tpl576,但零发单=市况非代码,rollback前查ss分布));低波三值包终裁ROLLBACK@08-23 18:2x(低波解锁不付费=组级知识;全文git a2e845f+config史);保险=6h净≤−6U停(继承) |
