...
- 隔离区(规则≤−4U∧n≥4)【13】: 4/CYS/TST/龙虾/BMT/BTW/H/APR/AIO/BICO/BEAT/XNY/ACE(逐条血统/日期全文git bb3b883/8a797ec/bb2e系)。**池列值=快照,权威=每轮对账器输出**。**对账器v1.5权威副本=quanty-ledger分支ops/route_pools.py@08-29**(v1.5=roster增补breakout复活壳3b646bf4,阈值零改动;谱系v1.4←v1.3←61b1bb4;v1.0默认分支禁跑)。**arg4隔离表必须X/USDT形态**(08-15实证:裸名norm不match feed键→漏移)。出池只认头注规则或隔离,失格=aging_watch advisory;brk/lowvol出池阈值未注册(#42)前无自动出口。**MAGMA网:解除@09-04 03:1x(复挂判据=磁铁型死法再现;史git bf52ca3);MARSCOIN promo_hold失效@09-06留main(S面最强留发现漏斗;再提名=规则A重达标∧空侧衰减;v1.6空侧否决阈值候ROUTE;全条款git 838122c/e6f5b0f);KOMA解压出watch@09-07 21:1x(48h n0,大亏行滚出;复挂=再现≤−2U/48h);PORTAL解压出watch@09-06 18:1x(48h n0滚出);AKE watch:48h n5/−1.90@09-07 21:1x(20:50多穿刺−1.296新增[conf0.80无资费bonus,3bar累跌2.40%距S18门2.74%漏放接刀];距隔离门−4U差2.10;n≥4已足,净线未触)**;对账史(09-01清扫/08-30/08-29链)=git b12d7d9版行;#51-#58史git 9957041/1ae847c/91b3276/830a46c/188af33/66048a9
- 保证金: Σ_running=main0.08×5+trend0.05×3=**0.55≤0.75✓**(09-03 21:2x E9回滚;前史0.65@E9扩仓03:46-21:20)
- 互斥不变式@09-07 21:1x复核: feed层=main186/trend3(TUT,USELESS,CAP)∩∅∧隔离13∩feed∅;bl现值随main行(17,#86候−BULLA);退役三壳RETIRED占位=交易/feed层收养封闭,记账归属层仍漏(#79详§6);fade壳seed5与main auto理论重叠=停机态无违例(不变式限running载具,owner UI复活须先重划池);#20=bl闸交易级非feed级;隔离币零成交✓;重播种法医学+违例史git 93637cd前链(§3签名条不动)
...
| 09-07 21:1x-21:3xZ | 例行轮(max) | 1h−1.30/3h−1.30/6h+1.42/12h+0.21/24h+2.45(12h n19wr63be62仅+1.0pp/24h n30wr73be65+8.1pp;充值信号12h线失标不重发;费后24h+1.85=毛2.452−佣0.660+资0.057闭合) | FGI71贪 BTC79202−0.98% trending∩池=PONS | **HOLD 0原子包;ROUTE零差分2连(aging_watch=[CAP,TUT]);FREQ2续飞未达评点(n9<15,09-09未到,劣化线+2.20>−4U远离);#86维持候FREQ2结案窗** | 3h唯一新平仓=AKE多20:50穿刺−1.296(2m,conf0.80无资费=非决胜,决胜门8/10维持镜像零新;3bar累跌2.40%距S18门2.74%漏放接刀);**#80 T+1队列4死例登记→明日batch3精测预期15死达门**;24h死法TP22/+7.68穿刺2/−2.17饥饿1/−1.15慢亏5/−1.91;main多头腿n5/−3.30 wr1/5=当期最大失血道vs空腿n19/+3.90wr84%;AKE watch n5/−1.90距隔离门2.10;载具费覆main+0.025🔴/trend+0.309绿/组24h+0.082贴线绿/cohort+0.244绿;feed186/trend3零漂移;audit1806后零无主;Σ0.55✓刹车全绿;钱包156.28全空仓;待落1(#86) |
| 09-07 18:1x stub: HOLD;TRANSFER+40U owner充值钱包157.6;充值信号三条件达标建至250-300U;FREQ2 n9/+2.20费覆绿;镜像+4→n31/+1.63;S33决胜门8/10;穿刺解压48h10/−7.70;ROUTE零差分promo_hold自消;全文git 93637cd版行 |
...
> 瘦身注(指针集@09-07 21:1x归并): 09-07 00:1x/03:1x stub并入(e770261/1965aac); 09-05..09-06各轮stub指针集(933abbd/610475d/14eca0b/ff561cc/2af6466/6a3383a/ad3c8d4/e6f5b0f/838122c/044689a内含;09-06 12:1x[MARSCOIN promo_hold/充值首触]+09:1x[S33精测不发货]并入)=git 8917d4e版§7原文;09-06 18:1x/21:1x stub并入(18ebd9a/8917d4e)。
|---|---|---|---|---|---|
