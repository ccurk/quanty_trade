...
| # | 类型 | 内容（含完整意图） | 登记轮 | 状态 |
|---|---|---|---|---|
| 83 | ROUTE(CAP晋升trend) | 对账器v1.5规则A达标@09-05 03:1x(CAP 48h L净+2.43≥1.5/nL3/wrL67%):计划=trend add CAP/USDT+main remove CAP/USDT+bl种子候重启窗同步。**顺延因=main FREQ rider评判钟09-05 06:23在飞,feed稳=预注册评判标准∧CAP=cohort正腿,评期尾移池污染评判面**;执行窗=06:2x轮FREQ评判后:先复核规则A仍达标(48h滚动,CAP+3.26大赢09-06 03:13滚出前有效)+CAP无持仓,失格即自撤 | 09-05 03:1x | open |
...
| 09-05 03:1x-03:2xZ | 例行轮(max) | −0.07(n2)/−0.35(n4)/−0.35(n4 wr50)/−0.38(n10 wr50 be52)/−0.04(n29 wr59 be59) | FGI73 BTC−1.7% MCAP−3.9% MARSCOIN仍trending∩池 | HOLD 0原子包;ROUTE:对账器首现差分=CAP晋升trend规则A达标,顺延06:2x评后执行(§5#83) | FREQ n20/−2.85距线1.15钟明06:23;24h转平因CAP+3.26旧赢03:13滚出窗;main24h n22/−1.01(wr55<be57);trend24h n7/+0.97 wr71%费覆🟢4连;死法24h=SL穿刺11/−9.79主血管(S33靶)+TP赢17/+13.84;S33 vision 09-04日档404×4未出候06:2x再查;隔离违例0;audit清洁;active=AKE多02:58+FLOCK空02:16(sid=""#52系统化知);钱包~151U avail118.9 |
...
> 瘦身注(指针归并@09-05 03:1x): 09-02..09-04六条压缩注+09-04 09:1x/12:2x两stub行全文=git 1195a37版§7(指针6d82e95/8c39ae5/f3c6469/558543d/3954cea/497cdf2在内)。
|---|---|---|---|---|---|
