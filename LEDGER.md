...
| 计数项 | 读数 | 更新轮 | 备注 |
| **09-19 20:2x 读数(income 口径; DB 只作下界)** | 1h −0.01(毛 +0.57 费 −0.58) / 3h −5.24(毛 −3.65 费 −1.60) / 6h −9.08(毛 −5.29 费 −3.79 ≈−6.0% 钱包≈152=avail 106.6+保证金≈45; 未触 8%) / 12h −9.54(毛 −3.24 费 −6.30) / 24h −59.85(毛 −28.90 费 −30.95 ≈−39%)🆘只报(owner 令不缩表); 费占 24h 52%/12h 66%; DB main 24h n195 毛 −27.74 wr43% 多 124/+0.30 空 71/−28.04, 死法 SL<2m 27/−41.1·SL2-5m 31/−38.2·SL5-44m 39/−38.9·超时 15/−8.3·赢 83/+98.7, 失血榜 CROSS −9.01/AKE −7.47/XTZ −7.44/AR −6.82(全隔离币)/OP −5.36, 赢家 ROBO +9.06/HEI +7.63/ZEREBRO +5.91; DB 6h n54 −5.67 wr43%(多 41/−6.87 wr37% 空 13/+1.20 wr62%; SL5-44m 18/−10.15 最大桶, SL<2m 仅 2/−1.37=ATR 括号已治噪声穿刺); 1h n10 +0.82 wr50%; **笔/日 195 vs 基线 38.7 但均净 −0.142(24h)/−0.105(6h)<0=无效频率; 3×来回费(现制 30U 名义)≈0.09 vs 均净 −0.105 🔴; 北极星≈−23U/日(6h 折算)**; 有效门槛≤0.52(信号行最低 conf 0.517 BB 20:20; 成交 conf 行自 log_level=info 起不出) | 09-19 20:2x | 判据不变 |
...
## 7. 运行日志（每轮一行，新行追加在表首）
| 2026-09-19 20:1x-20:3x | 定时轮: 管道活(REST 200; Rate limited 1=20:17 守护跳过, -1003 0, tpsl_setup_failed 0); 钱包≈avail 106.6+保证金≈45≈152(仓 ROBO 多/SUI 多/ONDO 空, 30U/仓=lev2 新制); income 1h −0.01/3h −5.2/6h −9.1(≈−6.0%, 未触 8%)/12h −9.5/24h −59.9(≈−39%)🆘 只报(owner 令不缩表); **DS: 19:55 optimizer lev 4→2 自锁 6h(lock-1789847726-ds, 首次写 changed✓, 无 metric, 自述节拍 15min)→watch_ds.leverage_1955; 越界 0; _ai_task_ds null**; 止损完整性: main 腿 10/10 锚到成交价, guard_sl 2(INJ 腿消失 H-0919h #10 / 0G 腿在), majors 0 仓, max_hold 45/720 ⇒ 两实例非裸奔; 隔离: feed 267∩bl=∅ ∩majors=∅ 无跨实例同仓 runtime 未变; 逐笔: **seg2 n16 −0.67 wr38% → worsen 线触(n≥10∧wr<45%), 预注册 rollback tpl998 未执行(阻塞四证据 §3 20:2x: 带仓强平=硬边界#4/lev 污染/目标更差/wr 子句弱)→呈 owner A/B + 硬线 段净≤−4U 即回滚**; 病根: 费占 24h 52%/12h 66%=毛边际≈0×高频 195 笔/日, 降 lev 不改符号; 死法 6h SL5-44m 18/−10.15 主桶, SL<2m 仅 2; 改动: rotate remove VVV(CC-35 closed, feed 267) + _exp_cc(TRIPPED 登记+watch lev2, 19:2x 归档 ops/exp_archive/exp_cc_20260919T2020Z.json) + _ai_task_cc 880 字(复读✓); 0 交易键; 新 CC-36(带仓重启常备授权)/CC-37(maker 入场); 宏观 FGI71 BTC +0.2% ETH −0.2% 市值 −2.4% trending∩feed=ENA/PENGU/PONS/PRL/SUI/TAO/TRUMP/ZAMA/ZEC; 下轮=21:1x: owner A/B 或 CC-36 授权回音; seg2 段净硬线; lev2 post 段 n≥10 读; DS 15min 节拍观察; 留言板压回 ≤600 字 |
...
|---|---|---|---|
| 2026-09-19 22:1x-22:4x(v6.0 首轮) | 上轮(20:27, v5 防守体系)= 勿动 mcp/atr/max_hold/template; evaluate 改动先写 _exp; 回 _ai_task_ds | **DS 20:53:53 反向改 mcp 3→2 + conf_sizing_max_mult 1→0.8**(lock-1789851233-ds 自锁至 09-20 02:53Z; 21:52 breaker pct 0.125→0.125 no-op); _ai_task_ds 仍无; 另 **21:12:00 无 audit backend 自恢复重启**载入 tpl1057 新版(hash 6c087f2c≠14:3x deb8795a; 含 S35 bar 聚合默认 15m; main config 无 bar_agg_minutes 键 ⇒ 每 15 分钟评估一次; 归属候 owner) | **max_mult 0.8=空改**(Go strategy_execution.go:47 钳 maxM<1→1; 20:53 后 10 条置信度动态仓位 9 条 mult=1.00); **北极星 前**(19:55-20:53, mcp3 lev2 1m) n15 均净 +0.011×346笔/日=+3.9U/日 → **后**(20:53-21:12, mcp2) n3 −0.26/笔(GOAT +0.105/BANK −0.922/PTB +0.038) → **15m 段**(21:12+) n2 −0.65/笔×≈60/日, 2/2 超时(VANA +0.23/BANK −1.53 SL 距 7.4%); mcp2 副作用: 80min 3 次 2/2 跳过 + VANA 0.01 枚灰尘仓(22:01:05)占 1 槽 ⇒ 实际 1 槽. 逐笔病根(1m 段 14:11-21:12 n71 费后 −11.08 wr45% 均净 −0.156×218/日=−34U/日): 多 54/−11.23 wr41% vs 空 17/+0.15; SL 出场 34 笔均 −0.542 vs TP 27 笔 +0.360(payoff 0.66, SL 滑点 +0.09pp; SL 距≥1% 10 笔 −6.34 wr20%); **conf≥0.95 n30 −7.21 wr40%(27 多) vs conf 0.6-0.8 n24 +0.97 wr58%**. **本轮建议(留言板 22:35:16Z, 5 条 7645B)**: [攻-1] mcp 2→4(→6; +owner 清 VANA 灰尘) 验 笔/日≥60·2/2 跳过=0·杀线 15m 段 n≥15∧均净<−0.15; [攻-2] max_hold 45→90(owner 拍板, 冲突 03:3x 直令) 验 超时占比<50%·TP:SL≥0.8; 候选[攻-3] 代码方向 conf≥0.95 多头拥挤反指(大户偏多 改逆向/conf 封顶 0.9). 其它读数: avail 131.3; 24h 净 −62.0(费 26.6/毛 −35.4); majors n10 −2.30 wr30% 17:31 后 0 信号(BTC/ETH 15m); 429=0 自 20:17; FGI 71 市值 −2.95% BTC −0.27% SOL −2.86%; trending∩池 ENA/PENGU/PONS/SUI/ZEC/ZAMA/TRUMP. 0 交易键写入(唯一 PATCH=_ai_task_cc, 其余键 diff 一致) |
