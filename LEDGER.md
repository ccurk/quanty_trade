...
| qt-breakout-follow-v2 | 3b646bf4 | 突破追动量(S26内核+S27复活锚) | **{BTR,LIGHT,MAGMA,我踏马来了,BAS,NIL}6/6**@08-29(4币自main接走+BAS,NIL@17:4x);**config种子6/6固化@18:2x** | running | **tpl973** pct0.05 mcp2 lev2 cd180 minconf0.60 sides双向 trailing(1.0/1.2%)+BE1.0;**_exp=open·FLEET复活@08-29 15:02(owner提频直令;评09-01 15Z或段n≥15;自动保险=滚动6h净≤−5U→stop;劣化回滚=stop+RETIRED占位+4币经bl_sync释放回main)**;MAGMA账户级隔离网继承(现值见隔离区bullet,不论在哪池);live实证@14:49=S26核产分被S21/22正常veto;**sizing六键修复✓@17:4x(#76结案§5维护注;5U缺陷史§3);实盘验证@18:06=首实名义单NIL 22.9U✓(conf-mult~1.38路径,快SL−0.217);分界前段n8/−0.56全5U噪声段(_exp内注分界)**;**种子写回@18:2x空仓窗(stop poll1-PATCH symbols6-start✓feed6复核✓六键+_exp完好=重启免疫闭合)**;**⚠️双写污染@16:3x定谳(§4#77): brk每仓被main双记账+main守护共管(hunger 5/8 vs 3/3不同→45m+段实验污染;<45m段参数恰同=可用)**;旧壳FAIL翻案史见2111f5f9行 |
...
| 08-29 14:3x-15:1xZ(owner live) | 交互轮(max) | 24h n18毛−3.97(费覆🔴红线降级=owner直令) | FGI68/BTC77585−2.4% | **owner提频直令→2原子包:①EXP多头闸重开+S30疫苗@main(tpl972) ②FLEET复活brk载具(tpl973);机制细节已入§1.5两行;保证金0.65✓;S31候选登记** | 漏斗切片依据+烟雾37/38全文git bf52ca3 |
