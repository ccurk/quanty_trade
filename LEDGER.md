...
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·**feed140@09-04 09:1x复核∩∅(08-29史链git 13edbef版行)** | running | **pct0.08@09-03 21:2x(E9劣化线ROLLBACK;史0.10@03:46owner直令,段n21/−9.42)** sides=[buy,sell] **bl17@09-05 21:1x(#84:+BULLA;隔离13+TUT/USELESS/CAP/BULLA,重启免疫闭合;史git)** **select_limit150=常规config@09-05(FREQ评判KEEP转正)** feed137@09-06 00:2x漂移−1(前138@09-05 21:2x;#84重启重播种150→rotate热清12;⚠️start异步播种可后至盖掉先发rotate→须二次rotate补清;IDLE行symbols数=WS通道残留非评估集,复核硬判据=被移除币零评估行[TUT/USELESS/BULLA零行实证];三交集∅✓;史git) **scp=0.05@08-28 09:33(EXP提频终裁rollback)** **lcp0.15门0.70@08-29(提频直令+S30;史#61c 0.90系git)** tpl990(S32关guard)@09-03 18:2x;**trailing(act1.0/cb1.2%)+BE(1.0)=基线几何(#49KEEP)**;**_exp=closed·FREQ扩面rider评判KEEP@09-05 06:23钟到点(cohort n20/−2.85>−4U线[正腿CAP+2.43/COLLECT+0.73 vs 负腿PORTAL−2.21/MARSCOIN−1.94/HEMI−1.86;末笔09-05 00:52后零新增]∧feed稳140/140双绿;select_limit150转常规,劣化条款终止,再扩面(→200)须新_exp;verdict全文config._exp.freq_verdict;原注册+读数史链git adeb6fa版行;槽空让S33)**;**E9=ROLLBACK@09-03**(段n21/−9.42;verdict=config._exp.e9_verdict);**S32=ROLLBACK@09-03**(tpl990关guard保码;verdict=config._exp.s32_verdict+git e97b10c;残余→§4#80);S31=基线常规监控(KEEP verdict全文移档ops/exp_archive/s31_verdict_20260902.json,原config._exp已被S32覆写);前_exp S30 KEEP@09-01(史git 0940c62);RECOVER 6h空≤−8U继承;#11观察(§4) |
| qt-trend-long | 827ffe8c | 趋势动量多 | **TUT+USELESS+CAP+BULLA四币**(BULLA晋升@09-05 18:2x规则A[48h L净+3.05/nL5/wrL80%,热rotate;bl17@#84+种子4币写回@09-06 00:2x空仓窗(stop poll1-PATCH全diff仅symbols-start running feed4)=重启免疫双层闭合;降级=池内滚nL≥6∧L净<0回main;BULLA空侧n8+0.46near平=损失微弱;trend段BULLA n4/−1.28@09-06 12:2x(+09:19穿刺−0.77;降级门nL≥6∧L净<0=4/6 watch)];CAP晋升@09-05 06:2x规则A[48h L净+2.43/nL3/wrL67%,#83种子3币同窗落库=重启免疫,FREQ评后执行=评判面保洁];USELESS晋升@09-02 21:2x规则B[trending∩池∧L净+0.81/nL3/wr100%全多,main段36U名义];种子PATCH同窗落库=重启免疫;出池按头注滚动nL≥6∧L净<0;COTI出池@08-24;ACE隔离@08-22;史git f43756c) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on **lcp0.149@09-03(#65 epsilon修复;裁决KEEP@09-04段n5/−0.314未触线+conf=0.7000边界直证1例;verdict=config._exp;史0.15)**;**_exp=closed(现值=#65 verdict KEEP@09-04;前史连开解锁PASS-KEEP@09-01 verdict=audit+git)**;mces史git b12d7d9;低波解锁线维持关闭,重开须新regime证据;**常驻保险=滚动6h净≤−5U→stop(继承)**;aging_watch[TUT,USELESS]advisory按对账器头注线(滚动nL≥6∧L净<0)独立看护(USELESS解压@09-04 09:1x:08:34多赢+0.900,滚6 L净+0.42>0出池条远离;仍trending∩池);三值包全史git 8a1d995/f71d825/5df52d2/492779a |
...
- 隔离区(规则≤−4U∧n≥4)【13】: 4/CYS/TST/龙虾/BMT/BTW/H/APR/AIO/BICO/BEAT/XNY/ACE(逐条血统/日期全文git bb3b883/8a797ec/bb2e系)。**池列值=快照,权威=每轮对账器输出**。**对账器v1.5权威副本=quanty-ledger分支ops/route_pools.py@08-29**(v1.5=roster增补breakout复活壳3b646bf4,阈值零改动;谱系v1.4←v1.3←61b1bb4;v1.0默认分支禁跑)。**arg4隔离表必须X/USDT形态**(08-15实证:裸名norm不match feed键→漏移)。出池只认头注规则或隔离,失格=aging_watch advisory;brk/lowvol出池阈值未注册(#42)前无自动出口。**MAGMA网:解除@09-04 03:1x(复挂判据=磁铁型死法再现;史git bf52ca3);MARSCOIN promo_hold自然失效@09-06 15:2x(12:2x首提名trend晋升被#57族暂缓→本轮L失格:48h L n2/+0.67<规则A nL≥3;S n7/+1.73 wr86%仍最强面;对账器改提名want.fade=壳退役无动作)→留main;再提名=规则A重新达标∧空侧衰减(S净<+1.0或nS<4);双向皆盈持续再现→v1.6空侧否决阈值走ROUTE _exp固化(校准锚:BULLA空+0.46放行/MARSCOIN空+1.73 hold案);全条款史git 838122c版行;隔离线远离(48h+2.40);KOMA watch维持:48h n3/−2.68零新笔(再1亏≤−1.32触隔离n≥4∧≤−4);PORTAL watch:48h n1/−1.10(窗滚解压中);AKE watch新挂:48h n5/−2.14(隔离门n≥4已过半,净距−4差1.86)**;对账史(09-01清扫/08-30/08-29链)=git b12d7d9版行;#51-#58史git 9957041/1ae847c/91b3276/830a46c/188af33/66048a9
...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=18/24h@09-06 15:2x(12:31-15:06四新笔+BROCCOLIF3B在飞=活性直证;池ATR%中位0.21/86%<0.5=死盘延续;判据未触) | 09-06 09:1x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| #79·closed行sid按symbol旧绑定继承(#77族新亚型) | 两形态:①**双行**(main行+末代壳行同笔PnL双写,壳行tp/sl null裸奔,出场治理权=两行落库序竞态,08-30 03:34壳饥饿档45m真接管收割−0.61实锤;判别特征=末代持仓币BTR/NIL/COLLECT类,泛池币牛来/USELESS零双行)②**空sid**=binance_only视图伪影(全量视图sid=main齐);binance_only对双行币dedup保壳行=池归因陷阱 | 09-01 12:5x | 归因纪律:sid冲突以载具日志开仓链为准,逐笔归因用全量视图+日志链;机制修复并入#77 ownership单一化(候owner部署),部署后复验消失;案8-14细目git链(ed40296/e97b10c/a317555/ed1ba85/1417e31/558c235/7565b0e/8729d22)；案13-21计数史(n38→39→42→45逐案细目;案19=COLLECT2236−0.737首例非良性亏since08-30壳收割)=git 933abbd版行；**n=45@09-06 03:1x**,均sid=末代持仓币判别续命中;n45零新增复核@09-06 09:1x(48h壳行7全known,懒生成滤行纪律照旧) |
| S31·regime动态方向偏置(**结案KEEP@09-02 06:3x**) | v1谱=宽度三档(EMA-up<0.35 OFF多+0.10/0.35-0.60 N/>0.60 ON多−0.05空+0.05)阈值内联+False-guard,上线09-01 10:02=tpl988;评判KEEP@09-02(段n22/15W7L毛−0.11,ON档多n3均+0.73 vs N/OFF n5净−1.99,劣化线双绿);verdict全文ops/exp_archive/s31_verdict_20260902.json+git 1417e31/eea7cb7/558c235系 | 08-29 17:0x | 常规监控;复核判据:多头累计≤−5U或ON档均净转负→议关guard;verdict后多头4笔+1.96@09-02判据远离；+09-05 09:2x宽度首直采=0.65(138币eval行EMA-up90/138)=ON档实证@−3.2%大盘日；门反证=当日多头死亡簇入场分0.75-0.90均非OFF窗产物且ON降门带[0.65,0.70)零死亡入账=S31非本轮失血向量,残差定性(原型固有方差)成立；宽度直采纪律入轮程(eval行EMA趋势聚合)；regime翻转速度=单日内;直采史(N五连+OFF首翻0.333+N回翻0.413+ON回翻0.652)=git ff561cc/933abbd/044689a版行;**+09-06 15:1x直采0.196(27/138)=OFF史最深**(日内ON0.652→N0.493→OFF0.196双摆;OFF档门0.80护航下24h多腿净+2.19 vs 空腿−1.76=判据反向远离;三态直采全命中维持;12:2x 0.493 N史并入) |
| funding磁铁·他币再现watch(重开@08-26;BICO条引用) | era史n2/−2.83+BICO/ACE史=git 9b9c39d/86e771d/8a797ec/bb3b883;**S30深档减半实证@09-02(+0.85良性收束)** | 08-27 00:2x | **S30已上线@08-29(owner提频直令跳磁铁门,设计按定稿字面实现)**;watch=疫苗效果验证(磁铁死法计数);era史n2/−2.83留档;疫苗期n1-n6细目+源码定案(L820/823)+排除案全文git 8729d22/ad3c8d4版行;判据n≥3达成@09-05 09:2x→**下修议案呈owner(温和+0.20→+0.10,深+0.10→+0.05,极深−0.10不动)+升级门预注册:决胜cohort累计n≥10∧净≤−3U→S33下修_exp自动执行(劣化线=下修后多头段n≥15且净劣于下修前同长窗→回滚),owner否决即关闭**;**多头cohort n6/−4.37@09-05 12:2x(死4/−5.34+赢2/+0.97;升级门6/10轨迹−3.11→−4.37;成员史git ad3c8d4)**;**空侧镜像(≥等值同口径,资金费率>0.0003:+0.20;独立观测不入多头cohort;判据=空侧决胜累计n≥6∧净≤−3U→议短侧入S33包)**:方向不对称结构化=空侧+0.20在赚不动(史n11/+0.84细目git ff561cc链);空侧批史(03:1x五决胜批净−0.10→n16/+0.74;06:2x XAN0317+0.117→n17/+0.86;逐笔细目)=git 933abbd版行;逐轮决胜扫描纪律=新入场评分行含资费bonus且减bonus后<门即计入;**+09-06 15:1x AKE0605多决胜闭−0.019(资费−0.00174温和档+0.20;0.75−0.20=0.55<门0.70)→多头cohort n7/−4.39=升级门7/10**(净−4.39≤−3已达,差n3);镜像n18/+1.15维持零新(MARSCOIN0640空bonus无资费项非决胜);**BROCCOLIF3B决胜空in-flight@09-06 14:35(0.72−0.20=0.52<0.55;sid=""#52签名,TP/SL 14:35:35双挂守护覆盖✓)平仓后计镜像**;09:1x MARSCOIN0831空+0.290史并入n18 |
...
| 09-06 15:1x-15:4xZ | 例行轮(max) | +0.12(n1)/−1.64(n4)/−2.42(n5 wr20)/−1.77(n8 wr50)/+1.86(n28 wr61 be57)(毛;税后24h+1.12) | FGI73 BTC79515−0.3% 市值−3.45% trending∩池=ARB,PENGU,UNI,JUP,SUI | **HOLD 0原子包7连;ROUTE零差分(plan空)+MARSCOIN promo_hold自然失效(L失格nL2<3留main,条款§1.5);无达门候选(S33死例11/15;S30门7/10;#11远;sl200缓行)+6h wr20%∧OFF宽0.196∧死盘=非提频窗** | **费覆里程碑:main24h首🟢(avg+0.147≥3×费0.076,33连🔴断)**/6h🔴(n4avg−0.41)/trend24h🔴(−0.012);死法24h:SL穿刺5/−4.10(XAN/UAI/DOOD+BULLA×2) WIN17/+7.52 超时2/−0.32 中段饥饿4/−1.24;归因main18/+2.65(wr72;多腿+2.19空腿−1.76)·trend5/−0.06(wr40;BULLA watch4/6零新)·壳5/−0.73(#79 n45零新);S30 cohort n7/−4.39(AKE0605温和档决胜)·镜像n18·BROCCOLIF3B决胜空在飞(#52空sid,守护覆盖✓);S31宽0.196 OFF史最深;KOMA3/4·PORTAL·AKE(n5/−2.14新挂)watch;audit零无主;feed138/4∩∅;钱包≈116.06(avail102.99+仓12.97+upnl0.10);充值信号未续触(12h−1.77);保证金0.55;待落0;瘦身3行 |
| 09-06 12:1x-12:4xZ | 例行轮(max) | 0(n0)/−0.77(n1)/−0.24(n3 wr67)/+1.07(n11 wr73 be57)/+0.85(n32 wr59 be57)(毛) | FGI73 BTC79872+0.3% trending∩池=MARSCOIN,ARB,JUP,PENGU,PUMP,HYPE | **HOLD 0原子包6连;ROUTE差分非零首现→执行层promo_hold**(MARSCOIN晋升提名:L n3/+1.92达标 vs 空侧n6/+1.61 wr83%更强面,#57同族暂缓,条款§1.5;churn0) | **充值信号首触发**(12h+1.07/24h+0.85双正∧12h wr−be+15pp≥6pp∧E9/S32回滚后main24h转正→TG建议250-300U;注记:12h仅n11/48h−2.02样本薄);死法24h:SL穿刺8/−6.94 WIN19/+9.31 超时2/−0.32 中段2/−0.75 饥饿1/−0.47;归因main19/+1.47(wr68,含晋升前BULLA3行+3.00)·trend7/−0.32(wr43;BULLA段watch4/6)·壳6/−0.30(#79 n45零新增);静默=池ATR中位0.18死盘引擎正确拒单(§6断流条直证);S31宽0.493 N回落;镜像n18/+1.15维持;KOMA 3/4隔离watch零新笔;audit零无主;feed138/4∩∅;钱包117.54全avail;费覆main24h🔴33连(avg+0.077vs3×费0.078贴线;6h🟢+0.27)/trend🔴−0.046绿转红;保证金0.55;待落0;⚠️台账~81.6KB贴80KB线下轮瘦身 |
| 09-06 09:1x stub: 24h转正+0.79五窗全非负;HOLD5连;S31宽0.652 ON;费覆红32连;全文git 838122c版行 |
| 09-06 08:4x-08:5xZ | 自查点stub: S33精测11案兑现,扫描64/73%<80%线不发货,距15死差4,RSI口径Cutler SMA14;全文git 044689a版行 |
> 瘦身注(指针集@09-06 15:2x归并): 09-06 06:1x stub=git 933abbd;03:1x stub=git 610475d(两行删于15:2x轮);00:1x stub(trend种子写回)=git 14eca0b;09-05 21:1x stub(#84落地bl17)=git ff561cc;06:1x stub=git 2af6466;09-05五stub(15:1x/18:1x/08:1x/09:1x/12:1x)=git ff561cc+6a3383a/ad3c8d4版§7;09-04..09-05三stub+09-02..09-04六条压缩注=git 6a3383a/1195a37版§7(内含指针6d82e95/8c39ae5/f3c6469/558543d/3954cea/497cdf2)。
|---|---|---|---|---|---|
> 瘦身注(史注归并@09-04 03:1x): 08-24..08-29各轮行裁/合并注全文与30+指针集=git 13edbef版§7尾注(指针集inline压缩@09-05 09:2x)。
