...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·feed83@06:3x(**bl17种子落库=#54结案@06:23**;heatclean-v7热清17币[bl在册14+僵尸STAR/AKE/EDEN3]→残留0;zombie检疫重固化;heatclean史git 26eaf24) | running | pct0.08 sides=[buy,sell] long_conf_premium=0.35 tpl567;_exp=**FIX-GEO(#49)@15:32:13Z**: trailing(act1.0/cb1.2%)+BE(1.0),TP4.5/SL2.5/premium不动;基线=72h赔率0.88/SL率40%/均净−0.73;**段@06:20=n18/−2.88/赔率0.33/wr67%/均净−0.16/SL率17%**(03:11后新5笔全胜+2.45[BICO+0.49/XNY+0.30/+0.39/SPORTFUN+0.10/+1.17];病理更新=均净−0.41→−0.16修复由wr67%驱动,赔率仍0.33[trail锁小赢aw0.46 vs 亏满SL al1.41]=keep条的赔率≥1.2腿仍远;trail健康巡检@06:27 PASS)→回滚线(赔率<1**∧**净≤−10)未触=continue;keep=n≥30或48h先到时赔率≥1.2∧段均净>−0.73(**注:eval_after=15:30Z[24h]与expect'48h先到'并存,当值轮按预注册原文裁,禁事后换标**);eval 08-16 15:30Z(现n18);RECOVER刹线6h空≤−8U继承(现+1.00✓);#11空侧gate=下一槽 |
| qt-trend-long | 827ffe8c | 趋势动量多 | ACE/TUT/COTI(feed3=种子3✓复核@06:36;aging_watch=COTI/TUT advisory[对账器@06:30],ACE凭24h 4W+1.73脱离aging) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;**_exp=closed@06:35:12Z: S24终裁keep结案**(预注册当值格'净>0=keep':链n33/+0.024>0;末笔08-15 18:17 BICO−0.91,终裁前36h零新笔=03:11后零笔复核@06:35;程序=真空仓窗stop[poll1沉降]-PATCH-start,种子3币完好);**常驻保险(继承canary)=滚动6h净≤−5U→stop本载具**;实验槽空闲;候选EXP降prem=§4#55(费覆红线内只登记) |
| qt-fade-short | 21519f1b | 冲高回落空 | 1000CAT/ARC/BEAT/VELVET/BULLA(live=种子=5✓@06:3x;aging_watch=1000CAT/ARC/BEAT/BULLA advisory[对账器@06:30],VELVET持续合格) | running | **tpl576(S25)** pct0.04 mcp2 sell;_exp v2续:**累计n10/−3.74零新笔@06:20**(24h内唯一笔BEAT−1.28@23:20已在链);**0.60墙在案**:BEAT空头分0.600整×20次顶死门(min0.55+short_prem0.05需**>**0.60)系统性拒发,处置候选=EXP:short_prem 0.05→0(评期时预注册执行,不中途改污染段;BULLA入池后墙对其同样适用=天然对照);评期=累计n≥15或**08-16 12:50Z**,到点n<15按证据不足格裁;自动保险6h≤−6U(6h 0✓) |
| ~~qt-breakout-follow~~ | 2111f5f9 | **owner删除@08-15 15:5x**(UI删,承15:36复活事件后清理;评判FAIL史+S26谱系+tpl577存git可重建;#47 S27复活=建新载具走FLEET流程,同lowvol先例;**⚠️幽灵运行时@08-16 00:1x发现**:删除未斩进程,曾在册交易STAR/AKE/EDEN[23:11Z开仓实证],机制§3,候修#53,已检疫+TG请重启;**休眠36h+@06:20复核**(00:11后零新笔),检疫由heatclean-v7重固化,候owner重启根治) | — | deleted | — |

- 隔离区(规则≤−4U∧n≥4): 4/CYS/TST/龙虾/BMT/BTW/H/APR/**AIO**(+AIO@08-15 21:2x,48h n4/−6.53全空单,bl16v2种子同步=重启免疫当轮闭环;APR@12:2x n5/−7.54;H隔离史存git)。**池列值=快照,权威=每轮对账器输出**。**对账器现版v1.3权威副本=quanty-ledger分支ops/route_pools.py@08-14(=334dae1内容;谱系61b1bb4←377c567←f970704;默认分支工作树只有v1.0初版——禁直接跑,实证2例错误plan)**:出池只认头注规则或隔离(失格币aging_watch);隔离表arg4;add互斥只排他专家池(v1.2误把main feed入排除集=晋升封死,COTI案实证修复);晋升币同轮移出main(封v1.1单轮重叠窗,执行序=先main remove后专家add);brk/lowvol出池阈值未注册前无自动出口(#42)。**arg4输入纪律(08-15 12:2x实证):隔离表必须传X/USDT形态——裸名norm后不match feed键,5隔离币漏出remove计划,当轮补刀rotate清除;代码零改动,属输入格式纪律**。最近跑@08-16 03:17: plan=BULLA晋升fade(唯一动作,churn1,已执行);零新隔离候选
- 保证金: Σ_running=main0.08×5+trend0.05×3+fade0.04×2=**0.63≤0.75✓**(08-14 14:4x复核,rotate不动pct/mcp)
- 互斥不变式: feed层@06:3x=main83/trend3/fade5,**overlap0全绿**(heatclean-v7后python实核:∩fade/∩trend/∩隔离/∩僵尸全空)>种子层**首次三层全同步闭环**=main bl17(含BULLA)与对账器desired 17项逐项一致✓/fade5✓/trend3✓——全部载具+黑名单重启免疫;引擎互斥闸✓live;重播种#8-#11史git(**#12=06:23 bl17重启重播种100→heatclean-v7→83**,再证:种子黑名单不滤feed构建,免疫在信号层,heatclean属卫生);隔离币15:32后零成交✓(AIO末笔20:19=隔离前,复核@06:20)
...
| 53 | 引擎候修(M通道) | **DeleteStrategy斩草除根**:RemoveStrategy去Status==running守卫改无条件Kill+drain start队列+requestRestart重启前查DB行仍存在;与#52同族(生命周期竞态) | §3 08-16幽灵条(manager.go L1496守卫+行为实证23:11Z);zombie 48h n15/−1.56 | n=1(brk) | 候选;与#52同包走dev分支;临时缓解=检疫rotate已执行+owner重启根治 |
...
| 08-16 06:15-06:5xZ | 例行轮(max) | @06:20: 1h+1.56(2)/3h+1.78(6)/6h+1.48(11)/12h−0.08(16,wr69 be69)/24h−5.85(44,wr50 be57) | FGI34/mcap−0.16%无降压;trending∩池=ACE(trend)+COW(main) | ①**#54落地结案**(真空窗程序v2+heatclean-v7重播种100→83残留0;BULLA种子免疫+三层互斥全同步闭环) ②**S24终裁@06:35=keep结案**(链n33/+0.024>0当值格;36h零新笔;canary转常驻6h≤−5U;#55降prem登§4候费覆解禁;trend实验槽空闲) ③#49段n18/−2.88赔率0.33 wr67 均净−0.16(03:11后5笔全胜+2.45;trail巡检PASS;回滚线未触) ④ROUTE对账器plan空,aging=trend COTI+TUT/fade4币 advisory,零隔离候选 ⑤fade链n10/−3.74零新笔,评期12:50Z ⑥幽灵休眠36h候owner重启 ⑦刹线全绿(6h+1.48/24h−5.85 vs −17.98/−44.95;fade 6h 0;main空6h+1.00) | 死法24h:SL穿刺9/−15.33主刀(main7/−12.76),硬超时7/−4.57,饥饿4/−3.58,慢亏2/−1.48,WIN22/+19.10;费覆24h🔴组均净−0.133 vs 0.104(main−0.105/trend+0.051/fade−1.28)禁提频,6h口径✓+0.135;钱包224.73空仓;幻影12/48h=拼接行形态(open=上笔close,BICO5/BEAT3,#18观察续,滤行在防);0原子包;⏭12:50 fade评→15:30 #49评 |
| 08-16 03:11-04:0xZ | 例行轮(max) | @03:11: 1h+0.32(1)/3h−0.48(6)/6h−0.97(8)/12h+0.65(19,wr47 be46)/24h−9.77(36,wr42 be54) | FGI34/BTC−0.01%/mcap−0.04%无降压;trending∩池=PLUME/COW(main)+VELVET(fade) | ①0原子包(三评点皆今日:trend终裁06:35/fade评12:50/#49评15:30) ②**ROUTE:BULLA晋升fade**(进池条nS3/+1.73;后台看守等仓窗,03:56 BULLA硬超时收官−0.67→main rotate−1[feed83]+fade程序v2种子5币一气呵成,live=种子✓互斥四方实核overlap0)+**#54(bl17)登§5** ③#49段n13/−5.33赔率0.32均净−0.41(改善基线−0.73,病理=trail锁小赢亏满SL),回滚线未触续飞 ④**trend分数墙破案**:ACE多头0.650×9h顶门0.70零笔,终裁后候选EXP降prem ⑤幽灵brk:00:11后零新交易,检疫在防候重启 ⑥刹线全绿(24h−9.77 vs 20%线44.5;fade保险6h−1.28;main空6h+0.48) | 死法24h:SL穿刺10/−17.53主刀(main9/−16.25),饥饿4/−3.58,硬超时5/−2.54,慢亏2/−2.00,WIN15/+15.88;费覆24h🔴组均净−0.27 vs 0.12(main−0.26/trend−0.22/fade−0.56全🔴)禁提频;钱包≈218(avail202.7+XNY空仓@03:26);幻影行4(观察期);⏭06:35 trend终裁→12:50 fade评→15:30 #49评 |
| 08-16 00:13-00:3xZ | 例行轮(max) | @00:13: 1h−1.46(2)/3h−0.68(3)/6h−2.30(7)/12h+0.07(22,wr45 be45)/24h−7.58(39,wr44 be51) | FGI34/BTC+0.08%/mcap−0.01%无降压;trending∩池=COW/PLUME(main)+BEAT(fade) | ①0原子包(三评点皆今日:trend终裁06:35→08:09轮/fade评12:50/#49评15:30) ②**幽灵载具发现**:已删brk运行时在册交易(23:11Z STAR空)→源码定案(§3新条)+检疫rotate main−3(feed87→84)+TG请owner重启+#53登记 ③ROUTE对账器plan空(aging advisory=trend2/fade3,bl16v2同步✓) ④#49段n7/−4.37赔率0.38回滚线未触续飞 ⑤fade链n10/−3.74(BEAT−1.28@23:20,6h−1.28保险线绿) ⑥刹线全绿(24h−7.58 vs 20%线40.2) | 幽灵24h n3/−1.64单列;死法24h:SL族17/−25.63主刀(快5/−9.65),硬超时5/−2.54,赢17/+20.59;费覆24h🔴−0.194 vs 0.120禁提频;钱包200.92持仓1(BULLA main空);⏭08:09轮=trend终裁 |
| 08-15 21:13-21:4xZ | 例行轮(max) | @21:13: 1h+0.30(1)/3h−1.62(4)/6h+1.63(11,wr36 be32)/12h−1.91(25,wr44 be47)/24h−7.43(39,wr46 be54) | FGI34/BTC+0.31%/mcap+0.26%无降压;trending∩池=NIL(main) | ①0原子包(三评点皆明日);ROUTE双出池:**AIO隔离**(48h n4/−6.53全空)+**BICO出trend**(out-rule nL8/L−0.58)——趁真空仓窗程序v2×2(trend seed=ACE/TUT/COTI一气呵成✓;main bl16v2落库=AIO重启免疫✓)+heatclean-v6(重播种#11:100→87残留0);BICO按生命周期回main漏斗(重播种即含✓) ②#49段n6/−5.15赔率0.31 SL33%(新增AIO trail锁盈+0.30);回滚线(赔率<1∧净≤−10)未触,继续 ③fade链n9/−2.46:新池首单BEAT+0.17=0.60墙非全封实证 ④trend链n33/+0.02不变(18:17 BICO已在链) ⑤刹线全绿(24h−7.43 vs 钱包224.35的20%=44.9;main空6h+3.24) | 幻影行1(ROBO旧例老化中);费覆24h🔴−0.19 vs 0.121/6h口径✓+0.148≥0.104;⏭明06:35 trend终裁→12:50 fade评→15:30 #49评 |
| 08-15 19:05-19:2xZ | 金丝雀唤醒(trig_014KQE) | @19:07: 1h−1.92(3)/3h−6.84(6)/6h+0.32(16) | 互动会话静默>3h,18:12轮已收轮=无执行器冲突 | ①**#49健康复核T+3.5h=PASS**(main logs百条零trailing/撤单异常,16:06全链先证维持) ②**#50落地结案**(真空仓窗+程序v2:stop→紧循环PATCH try1中→start;bl16/VELVET在bl/_exp#49完好/running全验)+heatclean-v5(重播种#10:100→87残留0) ③#49段初读n5/−5.45 wr20 赔率0.42:1=轶事级(n<10,评期n≥30或明15:30Z,记录不行动) ④刹线全绿(组6h+0.32;main空侧6h+0.20;trend+0.14;**fade新池首单+0.17**) ⑤brk=owner已删(roster=3)复核到位 | 无TG(无回滚/刹车,夜间免噪);⏭明06:35 trend终裁(n33/+0.02)→12:50 fade评→15:30 #49评 |
...
| 08-15 16:06-16:3xZ | 例行轮(max,v3.1首点火) | 24h−12.20(49,wr43 be52) | 无降压 | 交互窗新规首执行(0原子包);ROUTE:VELVET晋升fade(nS5/+7.03)+heatclean-v3(feed100→86);#49金丝雀PASS(VELVET空BE→trail×8锁盈+0.65);刹线全绿〔全文git ffebcb4〕 | 钱包≈232;SL穿刺15/−29.33主刀 |
| 08-15 15:12-15:4xZ | 例行轮(max) | @15:12: 6h−3.53(14)/12h−8.70(21)/24h−20.37(45,wr42 be61);15:30 VELVET空+8.39改观→24h≈−12.9 | FGI34无降压 | ①0原子包(#49交互轮中段上线占main槽;#11定稿转下一槽§4) ②ROUTE:BICO镜像+竞态v2(我方stop撞交互执行窗,main暗~5min补start)→重播种#6热清feed87;**规则升级=交互活跃期(commit±40min)cron只读+rotate** ③trend累n32/+0.93转正 ④19:05唤醒重定向#49金丝雀 | 死法:中段SL9/−18.51+快SL6/−10.83=main空侧;费覆🔴−0.453;audit零无主〔全文git 7a6729c〕
|---|---|---|---|---|---|

> 瘦身注 08-15(21:4x例行轮)：12:18/14:3x/15:2x执行轮/15:1x质疑对质轮四行随轮裁剪(质疑轮结论=era对比部分证实部分证伪+owner择A打#49,全文git 7a6729c前后;其余要点存§1.5/§3/§4/_exp),全史见 git 历史。