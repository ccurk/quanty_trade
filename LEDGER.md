...
- 隔离区(规则≤−4U∧n≥4)【13】: 4/CYS/TST/龙虾/BMT/BTW/H/APR/AIO/BICO/BEAT/XNY/ACE(逐条血统/日期全文git bb3b883/8a797ec/bb2e系)。**池列值=快照,权威=每轮对账器输出**。**对账器v1.5权威副本=quanty-ledger分支ops/route_pools.py@08-29**(v1.5=roster增补breakout复活壳3b646bf4,阈值零改动;谱系v1.4←v1.3←61b1bb4;v1.0默认分支禁跑)。**arg4隔离表必须X/USDT形态**(08-15实证:裸名norm不match feed键→漏移)。出池只认头注规则或隔离,失格=aging_watch advisory;brk/lowvol出池阈值未注册(#42)前无自动出口。**MAGMA网:解除@09-04 03:1x(残n1/+0.09;复挂判据=磁铁型死法再现;史git bf52ca3/ed40296);MARSCOIN watch:解除@09-05 12:2x(史git 8729d22)→+15:2x复挂观察:解除3h后空死1457−0.90(24h仍+0.72;规则线n≥4∧≤−4常备);KOMA watch:新增@09-05 15:2x(新币首2笔47m多空双杀−2.88[多13:31 mv−5.34%/13m+空14:18 mv−3.8%/14m]=震荡双面收割签名;距隔离线=再2笔∧−1.12U;CB连败2已挂)；PORTAL watch:n3/−2.21零新增维持@09-05 12:2x(再亏1笔≥−1.79即触隔离线n≥4∧≤−4);牛来watch:n5/−1.18维持@09-05 12:2x(零新增,窗滚续解压)**;对账史(09-01清扫/08-30/08-29链)=git b12d7d9版行;#51-#58史git 9957041/1ae847c/91b3276/830a46c/188af33/66048a9
- 保证金: Σ_running=main0.08×5+trend0.05×3=**0.55≤0.75✓**(09-03 21:2x E9回滚;前史0.65@E9扩仓03:46-21:20)
- 互斥不变式: feed层@09-05 06:2x复核=main138/trend3(TUT,USELESS,CAP)**∩∅**(bl16期望态)(v2退役壳+老壳双RETIRED占位=交易/feed层收养封闭,**记账归属层仍漏@09-01(#79双行升级,末代持仓币绑定绕RETIRED闸,详§6)**;重播种漏9热清9/9;隔离13币零在feed✓);种子层bl=18(desired达成@#70);**退役壳自bl5=收养向量封闭**;重播种法医学详§3(签名=top回落~202;bl闸零违例);#20=bl币可直漏feed(交易闸级非feed级);#24/#23及#8-#19史git;引擎互斥闸✓live;**fade壳seed5与main auto理论重叠=停机态无违例**(不变式限定running载具;若owner UI复活fade须先重划池,互斥闸+TG示警兜底);隔离币零成交✓(复核@08-21 09:2x,48h窗隔离12币零平仓行)
...
| # | 类型 | 内容 | 依据 | 复现计数 | 状态 |
| 80 | 代码候选(main多头;S33) | **设计轮证伪@09-05 08:2x——双子签名不apply,S33编号未消耗**:vision精测9案(6死3赢,SKR0902跨日拼接)判别子全域重叠(回调死0.54-7.19%vs赢1.83-7.80%;RSI最近邻死赢对67.6/67.8差0.2分;台账4估3错:PORTAL回调估1.4%实3.32%/MARS0904估'日高−0.8%再触'实距日高8.69%[16:33插针+3.5%拒回后接刀]/CAP赢估距顶10m实3m);签名(a)距顶≤8m∧回调<1.5%仅逮1/6死且距误杀+3.26赢例0.33pp,(b)距6h高≤1%仅逮1/6放宽到2%即误杀;9点7特征任何布尔组合=定义级过拟合,证据标准禁发货 | 全表+定义+残差定性+重启判据=ops/exp_archive/s33_calibration_20260905.json;启动判据史+收敛史git ab10f1d/2680d89/6d82e95/8cbc094版行 | n=4启动判据史达成;精测后死赢不可分 | **退回假设库攒证据**:重启线=新特征族在≥15死+≥8赢精测表上分离≥80%∧不误杀top2赢例;逐例精测纪律=新增多头SL穿刺T+1日vision量表追加archive文件;残差定性候选=均值回归原型在下跌regime固有方差(6死中5例=暴力顶回调2.6-9.8%后W-bar反弹接刀,与S32验尸同构,但赢例同为W-bar反弹),出路候选=regime级/sizing级/特征族更换(orderflow/资金费截面),非再一层入场veto；**精测队列@09-05 15:2x:5死(BULLA0407/CAP0042/AKE0741/AKE0923/KOMA1331−1.76[RSI22.8下轨接刀,无资费bonus])+6赢(SKR0848/FLOCK0336/BULLA0541/BULLA0650/AKE0258/MARSCOIN0926)候09-06 vision→表将至11死9赢(距重启线15死差4);队列史git 8729d22/ad3c8d4** |
...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=27/24h@09-05 12:2x(判据未触) | 09-05 06:2x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| 09-05 15:1x-15:4xZ | 例行轮(max) | −0.41(n2)/−1.91(n7)/−2.74(n12 wr42)/−4.26(n19 wr47 be60 −13.2pp)/−5.06(n31 wr48 be57 −8.7pp)(毛;24h佣金实测−0.94 income直证) | FGI73 BTC79727+0.7% MCAP−1.25% trending∩池=MARSCOIN,PENGU,LIT | **HOLD 0原子包;ROUTE零差分3连(plan={};want.trend仅CAP达标,TUT/USELESS aging留池)**;**空侧镜像cohort闭仓n5净+0.33(3W2L)与多头cohort n6/−4.37方向不对称首确认(详§6)**;踏马1512决胜空在飞(0.72−0.20=0.52<门0.60);多头磁铁无新增6/10;#80队列+1=KOMA1331→5死6赢候0906vision;#79 n41(案16/17踏马壳行,详§6);S31宽度直采0.478(66/138)=N档续;KOMA新币watch登记(47m多空双杀−2.88);死法=SL穿刺14/−15.49 vs TP15/+11.51;24h长−4.32/空−0.75 | 钱包≈145.1(avail134.84快照@踏马1512开仓前+USELESS margin10.2;上轮147.5−1.92实现−0.5佣金=对账闭合);费覆main🔴26连(均毛−0.196vs0.095)trend🟢n2(+0.31vs0.076);充值未达(12h/24h双负);audit清洁(1802尾零新增);trend 6h+0.49保险远离;CB连败≥2=AKE/BULLA/KOMA;待落0项 |
| 09-05 12:1x-12:4xZ | 例行轮stub: HOLD;ROUTE零差分2连;磁铁+n4→n6/−4.37;S31宽0.399N;#80 4死6赢;#79 n39;MARSCOIN watch解除;24h−2.87 wr−be−5.5pp;费覆main🔴25连;全文git ad3c8d4版行 |
| 09-05 09:1x-09:4xZ | 例行轮stub: HOLD;S30 cohort n5/−3.11定稿呈owner+升级门预注册;S31宽度0.65 ON;#80登记3死5赢;#79 n38;24h−2.39 wr−be−4pp;费覆main🔴24连;全文git 8729d22版行 |
| 09-05 08:1x-08:3xZ | 自查点stub: S33设计轮证伪不apply,#80退回假设库;归档ops/exp_archive/s33_calibration_20260905.json;全文git 8729d22版行 |
| 09-05 06:1x-06:3xZ | 例行轮stub: FREQ终裁KEEP+#83同轮落地=CAP晋升trend;24h−0.90 wr−be−2pp;费覆main红23连/trend绿5连;全文git 2af6466版行 |
| 09-05 03:1x-03:2xZ | 例行轮stub: HOLD;ROUTE首现差分CAP晋升顺延06:2x评后;24h−0.04;S33 vision404候查;全文git 2af6466版行 |
| 09-05 00:1x-00:3xZ | 例行轮stub: HOLD;ROUTE零差分27连;FREQ n18/−2.37零新增;24h+2.20 wr−be+4.5pp;全文git 1195a37版行 |
| 09-04 21:1x-21:4xZ | 例行轮stub: HOLD;#80案4=SKR18:11达启动判据n4→S33设计窗排定;24h+2.20首正;空侧+1.71 #11大解压;费覆读数史;全文git 2af6466版行 |
