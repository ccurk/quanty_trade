...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·feed95(#46重启重播种100→rotate−5自愈@15:0x;**bl13=#46闭环,CAP种子✓**) | **running@08-14 15:03Z(#46窗重启,有主)** | pct0.08 sides=[buy,sell] tpl567;_exp=**RECOVER刹线常驻**(6h空侧净≤−8U→重latch[buy];本轮读−2.10✓(HEI为多单不入空侧口径;15:1x自纠更正);首评08-14 19:00Z);24h n24/−4.14 wr33:短侧+0.78 vs H空3败−3.89(48h差1笔到隔离线,观察)+HEI多SL−1.99;载具主死法=SL穿刺;⚠️sid伪影纪律照旧(§3) |
