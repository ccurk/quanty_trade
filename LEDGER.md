...
| 2026-09-03 | **扩仓直令(live会话)**: "增加一下开仓数量。目前盈利太少，亏损单太多。这不合理。"——执行=E9 rider(main pct0.08→0.10;#58自设门被直令覆盖);一步一档,回滚线=24h组净≤−8U或费覆连🔴48h∧rider段净<0→回0.08 |
...
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·**feed83@08-29 15:2x(ROUTE v1.5摘BAS,NIL→孤儿态待挂brk;前史feed85@14:5x=apply重播种热清15/15,HANA回池,4币→breakout池)** | running | **pct0.10@09-03(E9扩仓rider,owner直令;史0.08)** sides=[buy,sell] **bl15@09-03 01:1x(#81窗落地:隔离13+TUT+USELESS=desired15,重启免疫闭合;史bl20→14@08-29系git)** feed89@09-03 03:4x(E9 rider重启重播种100→热清11残留0;S32 apply窗03:3x同型热清12) **scp=0.05@08-28 09:33(EXP提频终裁rollback)** **long_conf_premium=0.15门0.70@08-29(owner提频直令+S30疫苗伴随;劣化回0.35;史#61c关闸0.90)** tpl989(+S32)@09-03;**trailing(act1.0/cb1.2%)+BE(1.0)=基线几何(#49KEEP)**;**_exp=open·EXP S32接刀冷却+E9扩仓rider@09-03(不稳定窗[10m内S18veto或RSI>70]+A-bar拒多,W-bar放行;#80升门n=4/−5.21;劣化线=段多头≤−3U或拦截>25/72h或误杀审计≥50%@n≥4;eval 09-06T04Z或段多头n≥15)**;S31=基线常规监控(KEEP verdict全文移档ops/exp_archive/s31_verdict_20260902.json,原config._exp已被S32覆写);前_exp多头闸+S30 verdict=未劣化KEEP@09-01(多头段n3≈−1.2>−3U线,磁铁<3,lcp0.15+S30维持;expect毛净>0未达=非成功宣称;史git 0940c62);RECOVER刹线6h空≤−8U继承;#11降级观察(§4) |
| qt-trend-long | 827ffe8c | 趋势动量多 | **TUT+USELESS双币**(USELESS晋升@09-02 21:2x规则B[trending∩池∧L净+0.81/nL3/wr100%全多,main段36U名义];种子PATCH同窗落库=重启免疫;出池按头注滚动nL≥6∧L净<0;COTI出池@08-24;ACE隔离@08-22;史git f43756c) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;**_exp=closed·FIX连开解锁 verdict=PASS-KEEP@09-01(段TUT n1=08-29 13:16 L+0.329 hold5m;零连开拦截行;6h保险未触;mces=0维持;评期尾撞49h宕机窗样本稀;verdict全文config._exp)**;mces史=#69三值包双回滚+重开条款行使(已由FIX PASS结案)详git b12d7d9版行;低波解锁线维持关闭,重开须新regime证据;**常驻保险=滚动6h净≤−5U→stop(继承)**;aging_watch[TUT]advisory按对账器头注线(滚动nL≥6∧L净<0)独立看护;三值包全史git 8a1d995/f71d825/5df52d2/492779a |
...
| 09-02 03:1x-03:4xZ | 例行轮stub: HOLD;ROUTE零差分六连;S31段n19差1笔到门,ON档多头首证+0.73vs−1.99;MAGMA网复挂n1;#79 n23 MAGMA第2币种双行;费覆🔴三连TG明示;全文git 910d5dc版行 |
