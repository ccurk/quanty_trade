...
|---|---|---|---|
| 后端DB层挂死watch(平台事故→已升§3@08-27 04:4x) | **连续挂死中@08-27 10:39,自04:31复发起≥6h08m(n=5观测段)**: 03:14首发→03:5x重启→04:01复活~30min→04:31复发;观测段06:28四层+06:30-07:12×16探+09:14-09:20四层+10:38自调度回访=签名恒定(鉴权401/0.9s+路由404秒回=进程活;login 3×25s+30s永挂=DB端点死);#73未部署双证维持(health/db 404+ed0c160未并main);main头09f76cf=08-25 16:47Z预事故提交,03:5x重启后owner无新repo/TG响应;mm线已排除 | 08-27 09:2x | 判据不变:部署#73后再现→health/db秒判+readTimeout日志定位卡死query;owner待办=重启前SHOW FULL PROCESSLIST/INNODB STATUS/df -h;恢复后首轮必做=active核对+closed since04:00盲窗重建+feed漂移复核 |
...
|---|---|---|---|---|---|
> 瘦身注(压缩@08-27 09:2x): 行裁全文git指针: 08-26 12:4x=8e7b8fd(充值线形式触发判未熟)/09:0x=b8ab4bf/66048a9链(旧壳FIX终裁+#72push); 08-26 00:1x=4fc0468/03:1x=1ae847c/06:3x=e00be39(sid纠偏BOOK行滚出@08-27); 08-25 21:1x=5da0604/06:2x=12699f5; 08-24 18:1x=17251a9/15:1x=eaf1bcd/09:1x=040d80d^链+12699f5/06:2x=b505652/00:1x=02d3fb5+c1f6f24; 08-23前压缩史见git(a2e845f/cb2fc25等)。
