...
| 2026-09-20 14:1x-14:3x(v6.0 #17) | 上轮(13:26 板#1964)= [攻-1] owner UI main mcp 1→3(最低 2)+tp 0→0.10 / [攻-2] allowed_sides→["sell"] 限时 呈 owner; DS 松绑 3 行 | **DS 第 14 轮 0 交易键改动**: audit admin 最新仍 #1954 06:22:16; 13:37/13:52/14:07 三拍无 admin 写; 14:18Z config main mcp1 tp0 sl0 lev10 pct0.25 max_hold90 hunger_mode_enabled false max_mult0.8 sides 双向 bl47 全同; majors lev10 pct0.25 mcp2 max_hold720 bl BNB/SOL/XRP 同; tpl1057 6c087f2c/tpl1056 未变; runtime 1789878075139(04:21:15) 无重启. **owner 未 UI 改**. DS 门关: 6h pair_count 16<MIN_TRADES 30(ON 7 fills 15:16 滑出→9; BRETT 9 至 19:47) ⇒ 结构死锁(门要吞吐→吞吐要 mcp→mcp 只剩 owner UI). 我方写: 板 #1965 14:26:02 仅 _ai_task_cc(2 条 6629B; 12:26 条按 8KB 裁掉; 复读 mcp1/tp0/sl0/sides 不变 ✓); TG 10845 | **效果**: 无改动 ⇒ 无前后; 上轮验项 1/4(批开仓 0 ✗ · 1h 平仓 1 ✓ · pair_count 16 ✗ · 新腿 ✗). 1h 北极星: 1 笔×净+1.26(BRETT) 但吞吐=2h 1 笔. 交易所 income(14:18Z 全账户): 1h 9 fills(BRETT)/毛+1.51 费−0.25 净+1.26 · 6h 16 fills(ON+BRETT 全空)/毛+1.58 费−0.53 净+1.05 wr100% · 12h 46 fills/毛−0.56 费−1.54 资+0.05 净−2.05 wr70%(多 19/−4.50 · 空 27/+2.40) · 24h 196 fills/毛−5.50 费−6.14 资+0.05 净−11.59 wr55%(多 128/−14.10 · 空 68/+2.46); daily 09-20 −1.51(49f)/09-19 −55.67/09-18 −49.45; avail 107.84(钱包≈150=107.8+BTC 24+ETH 18). **BRETT 出场=硬性超时 1h30m6s roi+6.36% pnl+1.65(成交 +1.51) 13:47:10, 撤腿 canceled=2 found=2(两腿到钟仍在); OKX 1m 12:17-13:47 hi0.005191/lo0.005127 ⇒ MFE+1.12% MAE−0.12%; ATR TP 腿 0.0050966(−1.70%) 未触; 反事实 tp0.10(触 0.0051332) 成交 ⇒ ≈+2.6 毛 vs +1.51(+1.1U)**. lev10 段(open≥03:32) n4 4/4 钟出 0 TP 腿: BIGTIME 多 −2.13(OKX MFE+0.30/MAE−0.96) · CTR 空 +0.99(+0.34%) · ON 空 +0.07 · BRETT 空 +1.51; 毛+0.44 费≈−1.15 净≈−0.71. DB 15m 段 n14 −1.03: 多 11/−3.61 wr64% · 空 3/+2.57 wr100%. **吞吐**: main 13:26-14:19 0 开; 13:46 批(BRETT+ETH 持) · 14:01 批 78 信号「已持仓1个 达到最大并发1」(=majors ETH) · 14:16 批 83 信号「已持仓2个」(=ETH+BTC); 13:46-14:16 171 信号(多 83/空 88; conf≥0.8 97; bl 跳过 55; 连亏隔离 1). **止损核对**: main 0 仓; majors ETH 空 08:16 180U 腿 tp2561.87/sl2592.81 ✓(OKX 5m 08:16-14:20 hi2588.67/lo2565.82 MFE+0.49/MAE−0.40 未触) 钟 20:16Z; majors BTC 空 14:16:31 0.003@80485.3(信号价 80550.3, conf0.48, 241U) 腿 tp80250.05(−0.29%)/sl80790.5(+0.38%) order 4000001913322863/864 ✓ 钟 02:16Z; 无裸奔 无同币撞车. 源码复核: hasEffectiveTPSL strategy_execution.go:276-281; resolveTPSLFromROI :303-329 tp/sl 各自 >0 才替换 ⇒ tp0.10+sl0=只换 TP 腿; strategy_signal.go:662-679 交易所持仓 isAllowedSymbol 恒 true 计入 openCount; v40 读 long_bias/short_bias(:699-700 乘入 :863-864), 无 long_conf_premium; DS MIN_TRADES 30(:72) MAX_DRIFT 2.0(:73) hunger_mode_enabled BOUNDS (0,0)(:110). 宏观: FGI 71 Greed; BTC 80448(−1.2%) ETH 2576(−2.4%) SOL 108.0(−3.3%) BNB 752(−2.5%); mcap −4.73%/24h btc_dom 59.0; trending AKE/ZEC/ZAMA/VVV/FIRO/ONE/NEAR/PONS/AVAX/PENGU. **本轮建议(板 #1965; TG 10845)**: [攻-1](第 5 次, 值不变, 只 owner UI 能落) main mcp 1→3(最低 2)+同次 tp 0→0.10 | 161 信号 0 开=槽被 majors 吃光; BRETT tp0.10 反事实 +1.1U(+73%); lev10 段 4/4 钟出 0 TP; sl 留 0 ⇒ SL 腿仍 ATR; 保证金峰 0.2+0.16+0.128=49% avail | 验: 14:31-15:16 批「候选开仓成功」≥1 · 新腿 tp=入场×0.99/1.01 · 6h pair_count 回升 · 1h 平仓≥1 且均净≥+0.15. [攻-2](第 2 次; 与 09-18「禁方向不是刹车杠杆」直令相抵 呈 owner; 集中火力+限时) allowed_sides→["sell"], 解除=12h 多头 wr≥50% 或 BTC 24h 转正 | 24h 多 128/−14.10 vs 空 68/+2.46; 12h 多 −4.50 vs 空 +2.40; 6h 纯空 +1.58 wr100%; 15m 段 多 11/−3.61 vs 空 3/+2.57 | 验: 12h 纯空 n≥5 均净≥+0.15 北极星>0; 替代 long_bias 1.0→0.7 不推(历史 conf≥0.8 多头 n42 −6.58 劣于 0.6-0.8 +3.04, 按 conf 压不到亏的那批). DS 松绑同上. 🎓 反事实止盈(BRETT MFE+1.12% vs 腿 −1.70% vs tp0.10 1.0%). 下轮验: config mcp/tp/allowed_sides; 14:31-15:16 批开仓数; majors BTC/ETH 出场方式+净额; 6h pair_count; 1h 平仓与均净. |
