...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·feed86(CAP晋出@14:4x;bl15=#46未落,**CAP种子缺位**) | running | pct0.08 sides=[buy,sell] tpl567;_exp=**RECOVER刹线常驻**(6h空侧净≤−8U→重latch[buy];本轮读−2.10✓;首评08-14 19:00Z);24h n23/−2.15 wr35:短侧+0.78(unlatch后持续正,BEAT+3.25/AVAAI+2.77)vs H空3笔全败−3.89(48h差1笔到隔离线≤−4∧n≥4,观察);载具主死法=SL穿刺6笔/−10.27;⚠️sid伪影纪律照旧(§3) |
| qt-trend-long | 827ffe8c | 趋势动量多 | TUT/BICO/ACE/COTI/**CAP(晋升@08-14 14:4x rotate;种子仍4币,+CAP候trend空仓窗)** | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;_exp v3常驻监护:**累计首次转正 n20/+0.72**(台账n16/−1.85+段n4/+2.57;逐笔=COTI+0.51/ACE+1.51/ACE+1.72/ACE−1.17);keep门=累计净>0✓∧费覆✗(均净0.036<3×费0.12)→续观;劣化(累计≤−5U→rollback tpl567)与canary(6h≤−5U→stop)均远(6h+2.73);**终裁08-16 06:35Z**;ACE 24h n7/+3.44组最佳币∧trending榜;aging_watch=TUT/BICO;v1/v2全史git+config._exp |
...
- 互斥不变式: feed层✓(overlap=0三running:main86/trend5/fade2,08-14 14:4x CAP晋升后复核)>种子层blacklist15(期望12=隔离6+trend4+fade2;#46候main空仓窗(释COOKIE/DYM/BTR+增CAP);AKE/EDEN不在种子,main重启自回feed=无冲突[brk已停])>⚠️引擎互斥闸未部署;COTI晋trend=v1.3 plan首个跨态再路由;aging=trend3/fade2 advisory
...
| #46 | 种子同步 | main blacklist 15→**13**=对账器desired_bl(释COOKIE/DYM/BTR+**增CAP**[14:4x晋升trend的互斥种子];执行时以当轮对账器输出重算);main symbols保持auto""不写死 | 08-14 07:0x | open;14:4x轮被HEI仓阻(14:36开);程序=stop→轮询90s→PATCH→start单试;**CAP种子缺位=main重启窗撞池风险→优先级↑**(过渡看护=下轮对账器feed自愈+无apply计划) |
...
|---|---|---|---|---|---|
| 08-14 14:38-15:1xZ | 例行轮(max) | close: 1h0(0)/3h−1.97(3)/6h+1.02(11,wr55 be50=+5pp)/12h**+3.87**(29,wr59=+8pp)/24h−4.68(44,wr48 be54=−6pp;真净−6.26=佣−1.78资费+0.20) | FGI29/BTC−1.89%/mcap−1.60%无降压;trending∩池=**ACE+CAP双热(trend)**+ETHFI(main),AKE孤儿在榜 | ①ROUTE v1.3:**CAP晋trend执行**(48h L n3/+1.52 wrL67达门;先main remove后trend add,main86/trend5/overlap0/churn1;无新隔离,H n3/−3.89差1笔到线观察)②**trend累计首次转正n20/+0.72**(keep门费覆未达0.036<0.12,v3续观) ③#46目标改bl13(+CAP种子)候main空仓窗 ④0原子包(RECOVER首评今19:00Z;trend终裁/fade评期08-16) | 钱包≈247.2(avail219.97+HEI多仓保证金27.2,14:36开sid空=收养行归main);组24h死法=SL穿刺12/−18.74 vs TP+8.02·超时+4.97·饥饿+1.07(其余机制全正);main 24h n23/−2.15;brk段账closed;fade零成交第5轮;费覆组🔴−0.106/笔vs线0.121禁提频(trend🟢0.219=5.2×);四保险全未触;audit零无主改动 |
