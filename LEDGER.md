...
| 55 | E7类(trend) | **EXP:trend long_conf_premium 0.15→0.10**(gate 0.70→0.65;config-only;回滚=回0.15) | 分数墙源码级:ACE多头0.650×9h顶门0.70反复拒发;S24链n33/+0.024空转。**08-20 06:2x双向更新:分带上移(ACE 05:46-47多头0.680含S24续势+0.10,距门0.02;vs 03:18Z的0.28-0.40)但反事实转负——同例10min后−1.4%必触SL(2.5ATR≈1.4%),且trend影子多累计AL0/1+WL3/8=3W/9L(25%wr<影子be≈36%)⇒门0.70当前保护性**。前史git ba346aa+d19c710 | 机制级(gate) | 候选**已降级@08-20**(影子反事实负=解锁预期亏损);执行门不变=trend费覆解禁+影子多wr回到be上;08-18 12:00Z/08-20 06:2x两审议=续锁 |
...
| 08-20 06:18-06:4xZ | 例行轮(max) | 1h0(0)/3h0(0)/6h+1.22(1)/12h+2.17(3,wr67/be2)/24h+0.85(10,wr40/be36) | FGI62 Greed(昨46)/BTC+8.1%/市值+4.8%强升日无降压;trending∩池=∅(PUMP落榜) | **HOLD 0原子包**(03:1x轮后零新平仓;新知2条:①§3连开限制3破案=03:03 HANA第4连开被拒,影子'胜'实为费后净亏,闸救费拖单 ②§4#55双向翻新降级续锁=ACE 05:46多头0.680距门0.70仅0.02[分带上移]但10min后−1.4%必触SL+trend影子多3W/9L=25%wr<be36⇒门0.70当前保护性;#30候审CLO/ON vision 06:2x<08:00Z发布窗未查=下轮≥08:00Z第3查;#58/#47候部署门锁原样;logs ?q中文子串失效实证[ASCII可用]);ROUTE plan={}(feed89/trend3互斥∅/bl15=desired/隔离零成交✓;**want.fade=CLO/HANA,STAR滚窗跌线**);刹车全绿(6h+1.22/24h+0.85双正);trend保险6h n0✓;audit双零无主;充值信号维持不重发(钱包225.81未入金) | 死法24h(10行):trail/TP4W+5.01/快SL空2−2.99/硬超时2−1.12/BE微损2−0.05;48h组净+1.93(17笔,wr53>be36,**均净+0.114🔴首次48h口径也破线**[赢家滚出窗]);24h均净+0.085🔴禁提频;回滚后段n4/+2.14均净+0.535🟢轶事;trend 48h n1深饿续;幻影0/17(obs22);钱包225.81空仓 |
