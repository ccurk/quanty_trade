...
| main断流观测(三闸交集关门) | 本轮main笔数=8/24h@09-01 15:3x(全今日10:45-15:04,漏斗高活择优正常;判据未触) | 08-30 00:1x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| 09-01 15:1x-15:4xZ | 例行轮(max) | −0.31/+2.91/+3.28/+3.28/+3.28(毛;净≈+3.04;wr87.5%@n8 be67.9% wr−be+19.6pp) | FGI69/BTC77795−0.7%/mcap−3.4%/trend∩池待查 | **HOLD原子包0;ROUTE v1.5零差分(plan空,bl14期望态,TUT aging续,无新隔离;want层MARSCOIN→fade/STAR牛来→breakout均退役壳不生成差分);S31段+6笔→累积表n8/7W1L(§4全链归因:牛来TP+2.09最大单胜/STAR SL穿刺−1.42唯一亏/70分钟N→ON→N二次翻转;判别笔仍仅ONG;劣化线双查全绿);#79空sid+6例(n=14);充值线第8触=首次三条件全达(双正+wr−be+19.6pp+费覆两连绿)→TG正式建议充值250-300U留owner拍板** | 钱包164.14U全可用零持仓;死法:SL穿刺1(STAR)/TP+trailing收7;费覆🟢二连(均毛+0.411 vs 3×费0.092,n8口径);trend TUT n0第4日(EMA down+买单边=结构性闲置,漏斗活conf0.40);audit零无主(main1791/trend1790自书);feed93/1零漂移 |
...
| 08-29 17:0xZ(owner live) | 交互轮(max) | 压缩@09-01瘦身,全文git 0940c62前史版行 |
