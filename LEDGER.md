...
| 计数项 | 读数 | 更新轮 | 备注 |
| backend→Binance REST DNS断连 | **n=1: 09-09 16:12Z起持续,09-12 12:12仍在(≥68.0h;probe史24miss+cron直证十二轮=git fc2c6d4/1e6270a/9e8dc48/01d79a0/adfc233→dc081bf→f4090af链;12:1x直证=main/trend ctx income双载具+active positionRisk同串fapi SERVFAIL+balance伪零;ws活证main评估CRV真价流@12:13+trend评估CAP@12:13;feed183/3无重播种)**;特征=fapi SERVFAIL(resolver 100.100.100.100=Tailscale MagicDNS,修复在宿主机);伪影族: ctx balance=0+income{}伪零/skip文案误导/closed窗过滤失效升级@00:1x(hours=48回2847行最早07-19,末真实close不变=close_time过滤判n0不受扰) | 09-12 12:1x | 12:1x session probe自查点re-arm(+60m,≤3次预算,miss则静默交接15:1x cron);恢复后复核:①income补记完整性②feed有无重播种③若平台重启于断连窗=ws也死须立报;再现→升§3;⚠️断连窗禁stop/start(重订阅可能失败) |
...
| 2026-09-12 09:1x | 断连轮#19(≥65.0h,锚09-09 16:12Z): 双直证同串(active positionRisk+main/trend ctx income@09:11-13 fapi SERVFAIL on 100.100.100.100;balance=0伪零);ws活证(main统计汇总09:12池183影子在途1+评分批09:13 recv183/183;trend IDLE recv3/3@09:12);feed183/3无重播种;audit尾1808零无主;main/trend config全键零漂移(bl16/pct0.08/lcp0.15/scp0.05/floor21/S33 _exp open原封;trend lcp0.149/_exp closed);真窗n0(末close TAC 09-09 14:56维持;窗伪影2847行维持);ROUTE v1.6 plan={}31连零,quarantine19,desired_bl22=#88一致,aging_watch trend三币;S31宽度直采0.372(68/183全池批)N档贴OFF界(振荡链0.541→0.077→0.601→0.809→0.492→0.372);S33冻结KEEP-armed零动;宏观FGI63 Greed/BTC+0.12%@77343/mcap−2.13%未触;刹车未触(零成交);保证金0.55✓;HOLD 0原子包;#88续候;TG催resolver(≥65h) |
<!-- §7瘦身史指针集=git 8729d22版本注(逐hash在内) -->
| 时间(UTC) | 档位 | 五窗净额 1h/3h/6h/12h/24h | 世界 | 决策 | 备注 |
> 瘦身注(指针@09-12 00:1x归并): 断连#11=git fc2c6d4;#12=git 0207b9f;#13(15:1x)=git 1e6270a版行;#14(18:1x)/#15(21:1x)=git 9e8dc48版行;#16(00:1x)=git 01d79a0版行;#17(03:1x)=git dc081bf版行;#18(06:1x)=git f4090af版行。
