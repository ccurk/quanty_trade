...
| # | 类型 | 内容（含完整意图） | 登记轮 | 状态 |
|---|---|---|---|---|
| 76 | FIX | brk(3b646bf4)空仓窗: stop-poll至stopped-PATCH原子写{order_amount_mode:percent_balance,conf_sizing_enabled:true,conf_sizing_min_notional_usdt:21,conf_sizing_min_mult:0.6,conf_sizing_max_mult:1.4,conf_sizing_conf_hi:0.55,_exp尾注FIX伴随sizing修复分界}-start验running;修复确认后rotate add [BAS/USDT,NIL/USDT]斜杠形态,验feed4→6;顺手MAGMA机械网复核 | 08-29 15:2x | open·16:22Z自查点已排(trig_01TMgmzDGc14pZRFu6dTqp7K),brk有BTR仓不可即落 |
