...
| 08-19 18:14-18:3xZ | 例行轮(max) | 1h0(0)/3h−0.03(1)/6h+2.36(3)/12h−1.75(7,wr14/be22)/24h−2.83(11,wr36/be50) | FGI46/BTC+5.4%/市值+4.6%强升日无降压;trending∩池=PUMP(main,48h无笔)+BTW(隔离零成交✓) | **HOLD 0原子包**(#61c回滚后首轮,增量仅1笔STAR−0.03 trail早死;#55续锁[trend当口分ACE0.44/COTI0.36/TUT多头0.00,连拟议0.65门都不及=解锁亦无流量]+#30候审16→19);ROUTE plan={}零动作(desired=actual,feed89/bl15/trend3无漂移,无新隔离候选[最差JCT−2.28/n1]);刹车全绿(6h+2.36);audit零无主(main末条15:30=上轮回滚) | 死法24h(11行):TP/trail4W+3.79/SL穿刺3=−5.27(JCT/CLO/ON快SL空,强升日反弹杀,无时窗聚集=方差+环境)/硬超时3−1.32/trail早死1;48h组净+4.36(wr56>be44)正期望但24h负;trend 48h零笔深饿;幻影0/16(obs18);费覆组24h🔴(均净−0.257<0.134)禁提频[48h+0.273🟢参考];钱包223.78空仓;充值不触发 |
...
> 瘦身注 08-20 00:3x：08-19 09:12/06:18两HOLD stub随轮裁(要点在§4#61与push验非空立规注;全文git 10745a2前史/aefedf6)。
