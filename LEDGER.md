...
| qt-trend-long | 827ffe8c | 趋势动量多 | **COTI/TUT**(种子2=feed2✓#26重启后重建正确;ACE隔离@08-22 12:22;aging=COTI(TUT脱watch@08-24;COTI 24h−1.40/6笔48h+1.32未触出池线);破荒史git f43756c) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;**_exp=open·#69三值包重申请@08-23 09:18Z**(adt0.5+lcp0.149+mces off;终裁二元=新段净>0→keep否则回滚[adt1.0/lcp0.15/mces3];eval=n≥16或08-25 09:18Z;劣化线n≥8∧≤−4U;**进度@08-24 03:2x段n3毛−0.74**(COTI−0.06超时/TUT+0.08/COTI−0.76饥饿45m;劣化线n≥8∧≤−4U未触;feed2在流);否决窗空置+程序史git 492779a);原三值段终裁rollback(n18净−0.40)+ex-ACE归因(n14净+4.11 wr86%)全文git 5df52d2+config史;**常驻保险=滚动6h净≤−5U→stop(继承)**;三值包全史git 8a1d995/f71d825;S24 keep史git f43756c |
| qt-fade-short-v2 | 7583727a | 冲高回落空(**tpl823/S28**;谱系tpl576/S25) | HANA/COLLECT/MELANIA(feed3=种子3✓;MELANIA晋升@08-22;#57-ROUTE病理活测第3例看护) | running | **S28衰竭签名直入上线@08-23 21:24Z**(#66修复:short∧RSI>75∧价≥布林上轨∧末bar涨<0.3×ATR%仅旁路EMA方向+趋稳一门,S19/S20/RSI<32/量能/ATR带/追空ext全保留;附随#65 epsilon永久化[ss≥thr−1e-9;0.60精确组合RSI0.30+BB0.15+MACD0.15=S28主通道解锁];apply字节复检✓零config泄漏✓feed3✓烟雾MELANIA18h task30;载具级重启实证→§6);**_exp=open·EXP:S28**(二元:段净[Σpnl−名义×0.1%]>0→keep否则rollback回tpl576;劣化线段n≥8∧≤−4U即回;评期段n≥16或08-25 21Z;崩溃立即回滚;**进度@08-24 03:2x段n0**=5.9h管道健康[418评估行/2.4h·0Traceback·ss顶0.560<0.60门=签名邻近未现]);低波三值包终裁ROLLBACK@08-23 18:2x(低波解锁不付费=组级知识;全文git a2e845f+config史);保险=6h净≤−6U停(继承) |
...
| 08-24 03:1x-03:4xZ | 例行轮(max) | 1h0/3h毛−0.76(1)/6h毛+0.37净+0.29(2)/12h毛+0.16净−0.02(7)/24h毛−0.68净−0.95(15,wr53/be59=−5pp🔴) | FGI73/BTC+0.3%/市值−2.2%无降压 | **HOLD 0原子包**;ROUTE=#32对账plan={}零差分连3(aging=trend.COTI新增+fade.COLLECT/HANA;TUT脱watch;bl_sync18无漂移);两_exp未到门[trend#69段n3毛−0.74(COTI−0.06/−0.76超时·TUT+0.08;劣化线n≥8∧≤−4U未触)·v2 S28段n0@5.9h管道健康(418评估行/2.4h,0 Traceback,ss顶0.560<0.60门=衰竭签名邻近未现)];刹车全绿(6h+0.37/24h−0.68 vs 13.5/33.7U)载具保险绿;费覆🔴毛均−0.045 | **SCRT幻影行破案**=真实成交零盈亏BE出场(01:43短@0.01744→01:54同价平,佣金−0.0262入账;短窗4h系统性不含该行→§6);24h死法:快SL0/饥饿3笔−2.27/超时4笔−1.18=慢衰亡主导;COTI 24h−1.40(6笔)=最大失血币;main top872连续零重启11h+;钱包168.38;audit零无主;trending∩main=LIT/ENA/PUMP/MORPHO/UNI |
