...
| 2026-09-20 13:1x-13:3x(v6.0 #16) | 上轮(12:26 板#1963)= [攻-1] owner UI main mcp 1→3(最低 2) / [攻-2] take_profit_pct 0→0.10; DS 松绑 MIN_TRADES 30→10 等 3 行 | **DS 第 13 轮 0 交易键改动**: audit admin 最新仍 #1954 06:22:16; 12:22/12:37/12:52/13:07 四拍无 admin 写; 13:17Z config main mcp1 tp0 sl0 lev10 pct0.25 max_hold90 hunger off max_mult0.8 sides 双向 全同; majors lev10 pct0.25 mcp2 max_hold720 bl BNB/SOL/XRP 同; tpl1057 6c087f2c/tpl1056 未变; runtime 1789878075139(04:21:15) 无重启. **owner 未 UI 改**. DS 门关: 6h pair_count 17<30(13:46→7, 15:16→0). 我方写: 板 #1964 13:26:31 仅 _ai_task_cc(2 条 6775B; 11:22 条按 8KB 裁掉; 复读 mcp1/tp0/sl0/sides 不变 ✓); TG 10841 | **效果**: 无改动 ⇒ 无前后; 1h 平仓 0 ⇒ 北极星 0; 上轮验项 3/3 ✗(12:46 90/13:01 80/13:16 80 信号 0 开, 槽=BRETT+ETH 2≥mcp1; 1h 平仓 0; pair_count 17). 交易所 income(13:17Z 全账户): 1h 0 · 3h 0 对(费−0.13=BRETT 入场) · 6h 17 fills(CTR+ON 全空)/毛+1.06 费−0.62 净+0.45 wr100% · 12h 37 fills/毛−2.07 费−1.24 净−3.31 wr62% rr0.34(多 19/−4.50 wr26% · 空 18/+1.14 wr100%) · 24h 203 fills/毛−7.73 费−6.30 净−14.03 wr53% 费占 82% rr0.61(多 132/−15.07 wr39% · 空 71/+0.99 wr79%); hold 分布 24h: >60m n10 +0.87 wr70% 唯一正桶, 15-60m n31 −3.34, 5-15m n29 −2.63; daily 09-20 −2.77(40f)/09-19 −55.67/09-18 −49.45; avail 105.49(钱包≈149.5=105.5+BRETT 26+ETH 18). DB 15m 段(≥09-19 21:12Z) n16 −2.38: 多 12/−4.49 wr58% 均 −0.37 · 空 4/+2.11 wr100% 均 +0.53(BIGTIME −2.13/BANK −2.57 两大亏全多); 24h DB 多 66/−11.0 wr44% · 空 23/+3.27 wr65%; 48h 空亦负 99/−17.47(1m bar 时代) ⇒ 方向优势=regime 依赖. **止损核对**: main BRETT 腿 tp0.0050966(−1.70%)/sl0.0052558(+1.36%) order 4000001913083503/504 ✓ 钟 90=13:47Z; majors ETH 腿 tp2561.87/sl2592.81 order 4000001912590445/446 ✓ 钟 720=20:16Z; 无裸奔; 无同币撞车. **持仓**: BRETT 空 259U +1.24(ROI+4.76%; OKX 1m 12:17-13:23 lo0.005137=MFE+0.93% 价/hi0.005198 MAE−0.25%; ATR TP 腿需−1.70% 未触; 反事实 tp0.10 触发 0.0051332 差 0.07% 亦未触) · ETH 空 180U −0.04(OKX 5m 08:16-13:20 hi2586.2/lo2565.82; 腿未触). majors 13:06 影子 ETH 空(入 2570.86)判负; 13:01/13:16 XRP 空 conf0.36 黑名单拦截; 0 新开. main 12:46/13:01/13:16 三批 250 信号(在窗 124 多/133 空; conf≥0.8 153; bl 跳过 39; 连亏隔离 2) 0 开; 12:17:05 后无新「达到最大并发」行(该行不逐批打印, 非证据). conf sizing 自 03:19 起 mult 恒 0.80(conf 0.59~1.00 皆 0.80=max_mult 封顶) ⇒ 下笔名义≈105×0.25×0.8×10=211U. 源码: strategy_signal.go:899 allowed_sides 闸(注释自证「60 天 long −60.78/short +22.92, 配 ["sell"] 即可」)+strategy_position.go:66 下单口复检=Go 热键; v40 另有 long_bias/short_bias(Python 需重启, 现 1.0/1.0「无多空偏置」); DS FORBIDDEN_EXACT 含 allowed_sides(:119) ⇒ 只 owner 能动. 宏观: FGI 71 Greed; BTC 80483(−0.9%) ETH 2579(−2.2%) SOL 108.2(−3.0%) BNB 751(−2.5%); mcap −4.76%/24h btc_dom 59.0; trending AKE/ZEC/ONE/ZAMA/STONK/VVV/FIRO/AVAX/NEAR/BP. **本轮建议(板 #1964; TG 10841)**: [攻-1](第 4 次重发, 值不变) owner UI main mcp 1→3(最低 2)+同次 tp 0→0.10 | 有效并发=mcp−majors 持仓数; 250 信号 0 开; BRETT MFE +0.93% vs 腿 −1.70% | 验: 13:31-14:16 批开仓≥1·下轮 1h 平仓≥1·pair_count≥30·新腿距 1.00%. [攻-2](新; 明示与 owner 09-18「禁方向不是刹车杠杆」直令相抵, 呈 owner 拍板; 定性=进攻集中火力+限时, 非刹车) owner UI main allowed_sides→["sell"], 12h 多头 wr≥50% 或 BTC 24h 转正即恢复双向 | mcp1-3 下吞吐受槽不受信号限制(每批空信号≈44≫槽) ⇒ 砍多头 笔/日 0 损失, 均净 24h −0.069→空头 +0.014(12h +0.064) | 验: 12h 纯空 n≥5·均净≥+0.15·北极星>0; 「跳过信号：方向不在 allowed_sides」计数+被砍多头 90m OKX 反事实. DS 松绑同上. 🎓 MFE 概念(BRETT +0.93% vs 腿 −1.70%/tp0.10 差 0.07%). 下轮验: BRETT 出场方式(腿/13:47 钟)+净额; 13:31-14:16 批开仓数; config mcp/tp/allowed_sides; 12h 多空拆分; 6h pair_count. |
