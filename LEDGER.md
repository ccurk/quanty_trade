...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·feed89(19:04对账后;bl15种子=期望精确态@19:03[COTI锁+孤儿4释:AIO/BLUAI/DODOX/KAITO回main发现,KAITO当轮trending];重启重播种100→ROUTE−11同窗自愈;自发重播种计数维持2,本次重启有因不计) | **running@08-13 19:03Z(RECOVER unlatch原子窗30s)** | pct0.08 **sides=[buy,sell]双向恢复@19:03(#43第12读达门6h+0.97∧24h+1.06;latch史08-09 18:49→08-13 19:03≈4天)** tpl567;_exp=**RECOVER刹线常驻**(6h main空侧净≤−8U≈钱包3.1%→重latch[buy],brake_20260809键转recovered续用;首评08-14 19:00Z)＋s23_closure归档(#45 main✓);段(自08-12 22:20)n5/+2.96 wr60(CAP+1.82超时TP60m/COTI+3.06饥饿TP45m/US−2.00 SL穿刺27.6m) |
| qt-trend-long | 827ffe8c | 趋势动量多 | TUT/BICO/ACE(种子同步✓;aging_watch=全3币维持@08-13 06:31 v1.2对账[48h窗仅TUT/BICO各n1+ACE 0笔],保留在池) | **running@08-13 06:35Z(评期裁决PATCH原子窗stop→PATCH→start;06:33首次stop后误保护start多一次重启,无害已记)** | **tpl575(S24定制)** pct0.05 mcp3 buy trailing on;**S24评期v1已裁@08-13 06:35Z=证据不足·期满续观测**(48h到点段n7/−2.13 wr43[段1 n5/+1.06@31.4h+复飞段n2/−3.19=TUT闪崩穿刺−2.26+BICO饥饿−0.93],keep门n≥15与劣化线n≥10∧净≤−5U均未触→**S24保留零代码动作**);_exp v2已注册:累计口径承前,keep=累计n≥15∧净>0∧费覆,劣化=累计n≥10∧净≤−5U→rollback tpl567,评期=**累计n≥15或08-16 06:35Z先到**;canary保险滚动6h≤−5U维持(已随本PATCH写入config=#45 trend部分落地;重启清内存,cd由LastEntryAt播种,feed3重建✓);**累计现值n8/−2.34**(+BICO−0.21硬超时60m@08-13 18:07) |
| qt-fade-short | 21519f1b | 冲高回落空 | 1000CAT/ARC(种子同步✓;aging_watch=全2币,48h零成交) | **running@08-13 12:45Z(评期裁决原子窗stop→PATCH→start,13s)** | **tpl576(S25定制)** pct0.04 mcp2 sell;**评期v1已裁@08-13 12:45Z=证据不足·期满续观测**(48h到点段n8/−2.63wr50**全属已移币**BTW5/−1.79+BLUAI3/−0.84=选币责任已由08-10路由处置,S25现池零样本;keep门n≥15/劣化线均未触→S25保留零代码动作;logs实证漏斗健康ARC conf0.24-0.56<0.60门=市况安静非管道故障);_exp v2:累计口径承n8/−2.63,keep=累计n≥15∧净>0∧费覆,劣化=累计n≥10∧净≤−5U→rollback tpl567或stop,评期=**累计n≥15或08-16 12:50Z先到**;自动保险6h≤−6U维持;**累计现值n8/−2.63**(现池零成交维持@08-13 19:0x,ARC conf峰0.44<0.55门);#45 fade部分同窗落地✓;结构注记=main[buy]latch使空侧发现停摆,fade候选漏斗上游饥饿(#43为解锁条件) |
| qt-breakout-follow | 2111f5f9 | 突破追动量(顺bar,S23 W组实盘化) | COOKIE/DYM/BTR/**COTI(晋升@08-13 12:5x,maxmv5.45%≥3.5%入池条,v1.3恢复晋升通道后首例;种子未含COTI候自然窗[明日评判PATCH顺带],意外重启由对账自愈)**;aging_watch=COTI/DYM@19:0x(v1.3口径:BTR/COOKIE以损蚀mv重入want非病愈;COTI因fitT转trend-want被互斥层拦=留池非病) | **running@08-12 22:20Z(全组复飞令;自动保险在力)** | **tpl577(S26新内核)** pct0.04 mcp2 buy hunger30 max_hold45 trail(1.0/0.8);_exp EXP在飞,段真值**n11/−2.75 wr55**=前9/−2.10+BTR−1.02(快SL13.2m@15:19)+COTI+0.38(快TP3.5m@15:41,晋升后首笔即盈);COOKIE段3胜2负+0.14仍组内最佳币;**策略自防护在工作@06:2x日志:BTR策略内隔离中+COOKIE连败2计数+BTR追多被RSI超买硬拦(82.7>68,多头分0.95=blowoff帽实证n=1)**;评期**累计33.73h/72h→≈08-14 12:36Z或段n≥15**;自动保险段滚动6h≤−5U(现−1.05未触);TUT入池提名被v1.2封死(在trend池) |

- 隔离区(规则≤−4U∧n≥4): 4/CYS/TST/龙虾/BMT/BTW; 孤儿4=AIO/BLUAI/DODOX/KAITO(黑名单内待main重启窗释,黑名单18=期望超集安全)。**池列值=快照,权威=每轮对账器输出**。**对账器现版v1.3@08-13(334dae1,yx4euk分支;谱系61b1bb4←377c567←f970704)**:出池只认头注规则或隔离(失格币aging_watch);隔离表arg4;add互斥只排他专家池(v1.2误把main feed入排除集=晋升封死,COTI案实证修复);晋升币同轮移出main(封v1.1单轮重叠窗,执行序=先main remove后专家add);brk/lowvol出池阈值未注册前无自动出口(#42)
- 保证金: Σ_running=main0.08×5+trend0.05×3+fade0.04×2+brk0.04×2=**0.71≤0.75✓**(08-12 22:2x全组态复核)
- 互斥不变式: feed层✓(overlap=0全组,08-13 19:04 main重启+ROUTE−11后复核)>种子层**blacklist15=期望精确态达成@19:03**(COTI含,孤儿4释)>⚠️引擎互斥闸未部署,部署升急;**对账器v1.3本轮19:0x运行(arg4隔离注册表首用):plan={}零动作**;want.trend=[COTI]被池互斥生成层拦截(留brk)=v1.3 enforcement实证第2例;aging=trend3/fade2/brk[COTI,DYM] advisory
...
| #45(缩@08-13 19:0x) | _exp补写(余brk) | brk config._exp补写resume_note(评期重锚累计口径)+symbols种子补COTI——候明日12:36Z评判窗顺带;main部分已落地@08-13 19:03(s23_closure入_exp槽+RECOVER同PATCH)✓;trend 06:35✓;fade 12:45✓ | 08-12 18:2x扩22:4x缩06:3x缩19:0x | open,阻塞=brk running;落地窗=brk评判PATCH(明12:36Z) |

> 维护注 08-13 19:0xZ：#43 **落地结案删行**——RECOVER执行@19:03:25-19:03:55(30s原子窗):第12读达门(6h+0.97∧24h+1.06;第11读18:21 FAIL=US−2.00窗口伪影,19:00:12滚出6h窗后同轮复读,门定义零改动仅读点后移,承22:19轮执行前复核先例);落地=main sides=[buy,sell]+bl18→15(释孤儿4锁COTI)+_exp=RECOVER刹线(6h空侧净≤−8U→重latch同键)+brake_20260809转recovered;重启重播种100→ROUTE−11同窗自愈feed89 overlap0;latch史08-09 18:49→08-13 19:03≈4.0天。
...
| main无端重启重播种观测 | **1@08-13(22:5x-00:18窗feed89→100;rotate源码排除非重启回加路径[strategy_symbols.go:feedSymbols仅rotate/start改写]→必经进程重启;窗内零apply零start API;audit盲区=start/stop不写;领先假设=owner后端重启/部署BOOT RESTORE)** | 08-13 00:2x | 复现→升§3候证平台事实+评估counter清零对评期锚影响;黑名单闸在防=零实仓风险;每轮复核feed数(12:3x复核89无第3次,后经ROUTE晋升COTI变88=有主变更) |
...
|---|---|---|---|---|---|
| 08-13 18:20-19:1xZ | 例行轮(max) | close: 1h+1.62(2)/3h+2.00(3)/6h−1.03(5)@18:20→**+0.97@19:03**/12h+2.04(6,wr50)/24h+1.06(9,wr44) | FGI29/BTC−0.28%/mcap−0.23%无降压;trending∩池=KAITO(孤儿本轮释放回main) | ①**#43 RECOVER落地**:第11读18:21 FAIL(US−2.00拖尾)→19:00:12滚出→第12读19:03达门→main unlatch sides=[buy,sell]+bl18→15+刹线_exp常驻(6h空侧≤−8U重latch)+brake转recovered,30s原子窗;重播种→ROUTE−11自愈feed89 overlap0;#45 main✓②ROUTE v1.3(arg4注册表首用)plan={}零动作,COTI trend-want被互斥层拦=enforcement实证③0原子包(RECOVER/ROUTE不计) | 钱包254.05空仓;24h真净+1.17(毛+1.06佣−0.395资金费+0.51COTI);main段n5/+2.96wr60;brk段n11/−2.75(BTR快SL−1.02+COTI快TP+0.38晋升首笔);trend累n8/−2.34;fade零成交;费覆组🔴0.117/笔vs0.132线,main🟢0.59/笔(3.8×);四保险未触;owner main分支ws修复c717641候部署实证;brk评期明12:36Z |
| 08-13 12:32-13:0xZ | 例行轮(max) | close: 1h+3.06(1)/3h+3.06/6h+3.06/12h+2.08(4,wr50)/24h−1.11(6,wr33) | FGI29/BTC−0.92%/mcap−0.76%无降压;trending∩池=ACU(main)+CYS(隔离≠rehab) | ①**fade评期v1裁决=证据不足·期满续观测**(段n8全属已移币,现池0笔,_exp v2至累计n≥15或08-16 12:50Z,空仓原子窗12:45落地,#45 fade✓)②**对账器v1.3@334dae1**修晋升封死bug(v1.2把main feed误入add排除集;TUT案仍正确拦)+晋升币同轮移出main;本轮plan=**COTI晋升→brk**已执行(main88/brk4/overlap0/churn1)③#43第10读FAIL(6h+3.06✓∧24h−1.11✗,TUT/BICO今15:22前滚出→下轮料达门)④1原子包 | 钱包≈255.6(avail226.9+US保证金28.7);main段n3/+3.13wr67(COTI+3.06饥饿TP45m=段最佳);US多单12:32在飞;费覆组24h🔴−0.185/笔禁提频,main🟢+1.04/笔(n3);四载具保险全未触;brk评期明12:36Z;四漏斗健康信号稀=市况安静(conf中位0.44-0.52) |
