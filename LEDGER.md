...
## 7. 运行日志（每轮一行，新行追加在表首）
| 2026-09-20 21:1x-21:3x | 全文=§8 #24 行(要点: DS 第 21 轮 0 改(样本门已开 6h pair_count 121≥30, 20:37/21:07 两拍仍无 admin 写); 上轮 min_mult0.34/BE0.5 均未改; 1h 20f 0 赢 净−18.09 = ZEN −9.37(20:45 钳 SL 1.5%, OKX 1m MFE +1.2%@20:26)+DOT −7.95(21:10 钳, MFE +0.24%); 18:44 后 lev≥19 引擎自主出场 0 TP/3 SL −25.8(HOT/ZEN/DOT) vs owner 手平 3/3 +55.7(S/SAGA/ENS); 20U 地板×pct_eff0.75 avail 20.6 ⇒ 20:46/21:01/21:16 三批 300 信号 0 开(153 条「低于下限」/批); 3 仓 AVAX/Q/MIRA 80min 占 156U=88% 钱包≈177 浮 −1.58 钟 21:31Z 腿 ✓; majors/sandbox stopped 无撞车 429=0; BE0.5 1m 回放 ZEN +0.6/AVAX +0.3/S 到 TP +102/DOT 不变 = +11.2U 0 误砍; trailing cb0.5/1.0% 回放 19:36 砍 S 于 +0.78/+0.27% ⇒ 不发; conf_leverage_max 20→10: ZEN 21:11 −5.07% 3% 刀也死 ⇒ 不发; 板 #1976 攻-1 BE0.5 第 5 次(owner 项) + 攻-2 max_hold 90→45(DS 可执行 比率 0.5 过漂移 =owner 09-18 值); TG 10866) |
| 2026-09-20 20:1x-20:3x | 全文=§8 #23 行(要点: DS 第 20 轮 0 改但样本门首开(6h pair_count 103≥30); 上轮 pct0.20+max_mult1/BE0.5 未改; 段(18:44→20:20) 开 15/96min 平 11 净+38.4=S +39.5(2384U@20x 19:39:55 手平 +1.76%; TP 腿 +4.29% 20:16 前必触=+102 ⇒ 少赚≈60U)+SAGA +10.6 vs HOT −9.0/ENS −1.6/尘 −0.9, 均净 −1.55→+3.5 中位 −0.14; 11 平全为交易所侧同秒全平(18:58:10/19:39:55/19:57:37, 引擎 0 日志=owner 手平 n=3); 20:01 批 AVAX/Q/MIRA/ZEN 4 仓吃 92% 钱包≈203, S conf1.0 重入 3 次全拒(−2019/地板); avail 16.4; 20:16 批 149 信号 0 开; 429=0; 板 #1975 攻-1 conf_sizing_min_mult 0.6667→0.34(DS 可执行) + 攻-2 BE0.5 第 4 次; TG 10865) |
| 2026-09-20 19:1x-19:3x | 全文=§8 #22 行(要点: #1972 18:33 conf_leverage on 3-20 + #1973 18:44 mcp 1→10 = admin 三笔全越 DS 脚本 MAX_DRIFT/BOUNDS ⇒ 判 owner 直改, DS 第 19 轮 0 改; 上轮 max_mult/BE/SL 未改; 4a1ba66 20U 地板 18:57 重启生效; 18:58:10 SAGA(净+10.59)+5 尘仓交易所侧同秒平; HOT 528U@20x 5.5min 撞钳 −8.49; S/USDT 19:16 2384U@20x=75% 钱包保证金 SL 一刀 −35.8U(22%) 19:27 浮 −14.4; 19:16 批 127 条「保证金<=0」0 开=mcp10 实际 2 槽; 1h 费占 106%(毛+3.99 费−4.22); 板 #1974 攻-1 pct 0.375→0.20+max_mult 2→1.0 + 攻-2 BE0.5 第 3 次; TG 10864) |
| 2026-09-20 18:1x-18:3x | 全文=§8 #21 行(要点: #1970 17:54:23 admin 5 键 pct 0.25→0.375 + conf_sizing_max_mult 0.8→2(lo0.7/hi0.98/min0.6667) 无 _exp·漂移 2.5×>MAX_DRIFT·门关 25<30 ⇒ 非 DS 脚本 候 owner 认领; 上轮 BE0.5/SL0.15 未改; 新带 conf≥0.98(27% 信号)→pct_eff 0.75 顶格 名义 941U(×3.75); 48h n234 分桶 ≥0.98 −0.465%/笔 最差 vs 0.7-0.85 +0.337% 最好; 反事实 旧 −32/新带 −122/max_mult1 −60, 单笔最坏 −63.5U; 1h 9f +16.35(AVAAI 14.06/ENA 2.30 交易所侧平 +0.84% 无引擎日志); IOST 多 17:46 316U 腿 ✓ 钟 19:16Z; 18:01/18:16 269 信号 0 开; majors stopped; 429=0; 板 #1971 攻-1 max_mult 2→1.0 + 攻-2 第 2 次 BE0.5+SL0.15; TG 10863) |
| 2026-09-20 17:1x-17:3x | 全文=§8 #20 行(要点: DS 第 17 轮 0 改 门关 pair_count 16; majors 17:07:30→17:16 owner UI 停(无 audit)=上轮 攻-1 强版落地; 1h 平 2: BILL 钟出 净−4.32 + AVAAI 交易所 TP 腿 +5.06% 净+14.06 ⇒ 净+9.74; 15m 段 16 笔回放: 基线 +7.89 / BE0.5 +10.09 / SL帽1.5%+BE +11.76 / TP1% +1.57 ⇒ 撤回 tp0.10; 五批≈480 信号 开 2(借槽); ENA 多 17:31 在持 腿 ✓; 429=0; 板 #1969 攻-1 breakeven_trigger_atr 0→0.5 + 攻-2 stop_loss_pct 0→0.15; TG 10860) |
| 2026-09-20 16:1x-16:2x | 全文=§8 #19 行(要点: DS 第 16 轮 0 改 门关 pair_count 14; 1h 平 1=majors BTC 空 15m SL 扫 净−1.35(3h 三张 BTC/ETH 空 3/3 SL −3.08; BTC 13:00→16:15 +0.8% 单边上行, SL 距 0.38-0.45%≤单根 15m bar 振幅 0.51%); main 三批 226 信号 0 开(BILL+majors BTC 占槽); main 15m 段 空 3/3 +2.57 vs 多 12/−4.50(BANK −4.19); 板 #1968 攻-1 升为 静音 majors(bl += BTC/ETH) + 攻-2 第 7 次 tp0.10 先 mcp1→3 后; 新机制 logMaxPosSkipOnce 只在计数变化时打 / 429 自伤 n=2; TG 10852) |
| 2026-09-20 15:1x-15:2x | 全文=§8 #18 行(要点: DS 第 15 轮 0 改 门关 pair_count 18(→~11 下 1h 仍关); 1h 平 2 全 majors 低置信空单(conf0.36/0.48) 15:01 同分钟 SL 腿扫 净−2.45; majors 48h 11 笔 −2.47 wr27% 且 ETH 占槽 6h45m; main 24h 空 12/+3.50 wr75% vs 多 42/−7.49; 3 批 249 信号只开 1(BILL 空 295U 腿 ✓ 钟 16:31Z); 板 #1966/1967 攻-1 第 6 次 mcp1→3+tp0.10 + 攻-2 新 静音 majors(bl += BTC/ETH) 呈 owner; TG 10849) |
| 2026-09-20 14:1x-14:3x | 全文=§8 #17 行(要点: DS 第 14 轮 0 改 门关 pair_count 16→15:16 降 9=结构死锁; main 13:26-14:19 0 开(14:01 批 78/14:16 批 83 信号 被 majors ETH+BTC 占槽); BRETT 90m 钟出 净+1.26, OKX MFE +1.12% vs ATR TP 腿 −1.70% ⇒ tp0.10 反事实 +1.1U; lev10 段 4/4 钟出 0 TP 净≈−0.71; majors BTC 空 14:16:31 241U 腿 ✓; 板 #1965 攻-1 第 5 次 mcp1→3+tp0.10 + 攻-2 第 2 次 allowed_sides ["sell"] 限时 呈 owner; TG 10845) |
| 2026-09-20 13:1x-13:3x | 全文=§8 #16 行(要点: DS 第 13 轮 0 改 门关 pair_count 17; main 12:46-13:16 三批 250 信号 0 开(槽=BRETT+ETH); 24h 多 132/−15.07 vs 空 71/+0.99, 15m 段 DB 多 12/−4.49 vs 空 4/+2.11; BRETT MFE +0.93% vs 腿 −1.70%; 板 #1964 攻-1 mcp1→3+tp0.10 第 4 次重发 + 攻-2 新 allowed_sides→["sell"] 限时 呈 owner 拍板; TG 10841) |
| 2026-09-20 12:1x-12:3x | 全文=§8 #15 行(要点: DS 第 12 轮 0 改 门关 pair_count 17; main 181min 零开仓 235 信号; 12:17:04 BRETT 开=交易所拉取失败漏放实证; isAllowedSymbol 不查 bl 定案; 板 #1963 mcp 1→3(最低 2)+tp0.10 第 3 次重发; TG 已发) |
