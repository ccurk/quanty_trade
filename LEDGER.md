...
| 2026-09-20 11:1x-11:3x(v6.0 #14) | 上轮(10:26 板#1961; TG 10837)= [攻-1] owner UI main mcp 1→2 / [攻-2] take_profit_pct 0→0.10; DS 松绑脚本 3 行 | **DS 第 11 轮 0 交易键改动**: audit admin 最新仍 #1954 06:22:16(breaker); 10:22/10:37/10:52/11:07 四拍无 admin 写; 11:17Z config main mcp1 tp0 sl0 lev10 pct0.25 max_hold90 hunger off max_mult0.8 全同; majors mcp2 lev10 pct0.25 max_hold720 bl BNB/SOL/XRP 同; tpl1057 hash 6c087f2c 未变; runtime 1789878075139(=04:21:15 重启, 无新重启). **owner 未 UI 改**. **DS 门已关**: main ctx 6h pair_count 29<30(ROSE 对 10:46 滑出, 上轮预测应验); 6h 成分 BIGTIME 12 fills/CTR 10/ON 7 ⇒ ~11:2x→17, 13:46→7, 15:16Z→0 ⇒ DS main() L439 早 return, 不建 prompt, 读不到板. 我方写: 板 #1962 11:22:46 仅 _ai_task_cc(2 条 6372B; 09:28 条裁掉; 复读 mcp1/tp0/sl0 不变 ✓) | **效果**: 无改动 ⇒ 无前后; **1h 0 笔 ⇒ 北极星=0**(main 09:16:40 ON 平后 0 开仓 121min). 交易所口径(11:17Z 全账户): 1h 0 · 3h 7 fills(ON)/毛+0.07 费−0.15 · 6h 29 对(3 仓)/毛−1.07 费−0.83 净−1.86 wr59% rr0.35 · 12h 42 fills/毛−0.64 费−1.37 资金+0.04 净−1.97(BIGTIME −2.43·BANK −1.87·ON −0.18·NIL −0.03 / CTR +0.70·ETH +0.72·ROSE +0.38·POWR +0.36·SUI +0.24·PUNDIX +0.15) · 24h 44 对/毛+0.77 费−1.20 净−0.43 wr70%(多 35/−2.09 · 空 9/+1.60); daily_pnl_7d: 09-20 −2.64(40 fills)/09-19 −55.67/09-18 −49.45; avail 131.0(钱包≈149). **DB closed 表缺 BIGTIME/BANK/ROSE/SUI/PUNDIX 行**(交易所腿平仓不落库, §3 09-19 15:2x 条再证; 12h DB 5 行 vs income 10 币) ⇒ 逐笔以 income by_symbol 为准. **病根**(证据累加): 10:46/11:01/11:16 三批 271 信号(多 137 空 134; conf≥0.8 151) 0 开; 唯一槽被 majors ETH 占; 源码 HEAD 复核 strategy_signal.go:662-679 FetchPositions 循环计入一切 isAllowedSymbol 仓, otherHeld(:633-642) 仅 :711 同币跳过 ⇒ 一行修=:672 前 `if _,ok:=otherHeld[key]; ok {continue}`; majors 11:16:30 亦发 ETH 空 conf0.44→「已有持仓」跳过=两实例同时空转. 止损核对: main 0 仓(上笔 ON 07:46:36 腿 tp 4000001912525429/sl …431 ✓ 钟 90 ✓); majors ETH 腿 tp2561.87/sl2592.81 ✓ 钟 720(20:16Z); OKX 5m 08:16-11:20 hi2586.2(MAE−0.30%) lo2565.82(MFE+0.49%) vs TP 需−0.64%/SL 需+0.56% 皆未触; 无裸奔; 无同币撞车. resolveTPSLFromROI :303-329 复核: tp>0∧sl=0 ⇒ 只换 TP 腿 ✓. 宏观: FGI 71 Greed; BTC 80329(−1.2%) ETH 2571(−2.5%) SOL 108(−3.3%) BNB 749(−2.0%); trending FIRO/AKE/ONE/BP/STRK/BTC/ZEC/PENGU/NEAR/UNI. **本轮建议(板 #1962; 重发第 2 次; TG 见 tg.json)**: [攻-1] owner UI main mcp 1→2(Σ0.5≤0.75; 保证金 2×26U+18U≈47% 钱包) | 271 信号/0 开, ETH 最坏至 20:16Z | 验: 11:31/11:46 批开仓≥1·下轮 1h n≥1·6h pair_count≥30; 备选=手动平 ETH(+0.6U); 根治=:672 otherHeld 跳过(需部署). [攻-2] 同次 take_profit_pct 0→0.10(1.0% 价@lev10 只换 TP 腿) | 15m 段 13 仓 TP 命中 0, 赢单净 +0.15~+0.70 全钟出 vs 亏 −1.87/−2.43; 1m 回放 7/12 到过 +1% | 验: 腿距 1.00%·5 仓内 TP 成交≥30%·均净≥+0.15. DS 松绑: :327/:329 事实#4#5 改现算或删, :298 加 n<10∨净>−2U 不适用, MIN_TRADES 30→10(:72). 🎓 ETH 括号(−0.64%/+0.56%) 宽于 3h 实际振幅(+0.49%/−0.30%) ⇒ 出场只会是钟不是价. 下轮验: 11:31-12:16 批开仓数; audit/config mcp·tp; ETH tp 触发; pair_count. |
