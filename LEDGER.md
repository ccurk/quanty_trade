...
| 09-07 06:2x-06:4xZ | 例行轮(max) | +0.17/+1.16/+1.21/+0.62/−1.95(逐笔16笔毛) | FGI71 BTC79706−0.22% 市值−2.8% trending∩池=∅ | **HOLD 0原子包12连;ROUTE零差分9连(plan空;bl desired=actual=17)** | 窗新4笔全胜+1.16(COLLECT空+0.515/+0.311·NAORIS空+0.158·BULLA多trend+0.174)=静默解除;12h转正n7/+0.62 wr86 be76(+10pp)费覆绿avg+0.089≥0.069,24h仍🔴avg−0.122;在飞2空@06:0x:COLLECT=S30空决胜第23例入场(conf0.76含资费+0.20减后0.56<0.599门;sid=壳#79既案)+NAORIS(conf0.64无bonus,sid空#52,TP/SL双挂05:59:35验证✓);S31宽0.449(62/138)N驻留(0.413→0.449摆幅缩);ATR中位0.16死盘未全解;死法24h:穿刺5/−4.06赢11无饥饿超时;归因main11/−1.37壳3/+0.01 trend2/−0.60;48h空n36/−5.00滚出续改善;AKE watch n4/−2.19(赢滚出净恶化,距门1.81);KOMA3/−2.68零新;多cohort7/10零新;audit零无主(1804/1805自记);feed138/4∩∅;钱包≈114.1(avail92.45+保证金22−upnl0.42);保证金0.55✓;待落0 |
