...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·**feed91@12:52**(bl12种子=9隔离+trend3,重播种#13+heatclean-v8;5 fade币回池) | running | pct0.08 sides=[buy,sell] long_conf_premium=0.35 tpl567;_exp=**FIX-GEO(#49)@15:32:13Z**: trailing(act1.0/cb1.2%)+BE(1.0),TP4.5/SL2.5/premium不动;基线=72h赔率0.88/SL率40%/均净−0.73;**到点评判@08-16 15:30Z裁决=continue(当值轮按原文裁)**:段n26/−3.27/赔率0.39/均净−0.126/SL率19.2%/wr65(池归属口径,新修正3行:BICO13:32归main[trend feed3无此币+双先例]+VELVET14:03归main[fade停机铁判据]);裁由=eval_after两读法收敛同一结论——①两级结构读法:keep门自带前提'n≥30或48h先到'未达(n26<30,48h=08-17 15:32Z)②单点读法:赔率腿0.39<1.2但回滚线(赔率<1**∧**净≤−10)净腿−3.27远未触=中间区带,而prereg自认n≥30才够裁∧keep另一腿均净−0.126>−0.73显著PASS→顺延至原文终门;**终门=n≥30或08-17 15:32Z先到,禁事后换标**;段病理拆解=空侧n23/−0.32打平,段亏全额=BICO长3笔−2.94(§6计数);右尾直证=EXIT_AUDIT VELVET14:03-10 trailing棘轮11次(roi5.2→10.6%)锁+1.71=旧均赢0.64×2.7,SPORTFUN14:07同型+0.70;**预登记解释框架(非换标)**:BE/trailing把应亏−1.4U单转+0.1~0.7微赢→均赢被结构性压低→赔率腿失真,修复真值在SL率40→19与均净−0.73→−0.13两维,终裁轮若赔率<1.2须正面处置此矛盾;RECOVER刹线6h空≤−8U继承(空6h≈0✓);#11候#49终裁后基线重算(§4);段@12:50读数git |
...
- 互斥不变式: feed层@12:52=main91/trend3(fade停机无live feed),main∩trend=∅✓ main∩bl12=∅✓;种子层=main bl**12**(9隔离+trend3)与对账器desired逐项一致✓重启免疫;5 fade币回main auto(BEAT/BULLA/VELVET自然回百强,1000CAT/ARC rotate补种);重播种**#13=12:50 bl12重启100→heatclean-v8清11[TST已出百强]→91**(#8-#12史git);引擎互斥闸✓live;**fade壳seed5与main auto理论重叠=停机态无违例**(不变式限定running载具;若owner UI复活fade须先重划池,互斥闸+TG示警兜底);隔离币零成交✓(21:30后0,复核@12:1x)
...
| BICO资金费磁铁长侧 | **n3/−2.94@08-16**(04:02+0.57/07:57−1.90/13:32−1.61;三入全为funding−1.1%级→'资金费率<−0.0003:+0.20'bonus推过0.70长门,0.65-0.75分带;#49段唯一净亏源=此3笔) | 08-16 15:3x | 判据:累计≥6笔或净≤−6U→候选化(选项=funding bonus降权/该币CB提前);n3轶事级只记账 |
