...
|---|---|---|---|
| 2026-09-20 08:1x-08:3x(v6.0 #11) | 上轮(07:28)= [攻-1] owner UI hunger 三键 true/0.10/0.20(第 4 次) / [攻-2] owner mcp 1→3(第 7 次; 备选 MIN_TRADES/QT_WINDOW_HOURS) | **DS 0 交易键改动(第 8 轮)**: audit admin 最新仍 06:22:16 #1954; 08:17Z config: main lev10 pct0.25 mcp1 tp/sl pct0 hunger false(sl0.04/tp0.30) max_hold90 max_mult0.8; majors lev10 pct0.25 mcp2 max_hold720 conf_max_mult1. **样本门首次过线**: ctx 6h paired_trades.pair_count=30(08:19Z, fills 口径 CTR10+BIGTIME12+BANK2+…; L439 n<30 假 ⇒ DS 08:39 节拍可动; 08:46 起 BANK fills 滑出 ⇒ 回 ~22 再关). _ai_task_ds 仍 null. 我方写: 板 08:27:03 audit #1959 仅 _ai_task_cc(diff 非板键=none ✓; 2 条 7684B, 06:25 条裁掉). | **效果**: 无改动 ⇒ 无前后. 逐笔 08:17Z(全账户): 1h 1/+0.99 / 3h 2/−1.14 / 6h 6/−2.14 wr67% / 12h 29/−1.79 wr59% / 24h 111/−5.18 wr47%; income 24h 毛 −4.54 佣金 −8.03 净 −12.5(费拖 176%), 6h 毛 −2.14 费 −1.01; avail 100.3(钱包≈148); 持仓 2: main ON 空 07:46:35 298U conf0.788 mult0.8 腿 tp .14625(−3.15%)/sl .15481(+2.52%) 现 −0.39U 钟 09:16:35; majors ETH 空 08:16:31 180U conf0.36 mult0.62 tp −0.64%/sl +0.56% 钟 720m. 北极星: 15m 段(21:12Z 起) n12 26.0/日×−0.218=−5.66U/日; mcp1 段(23:39Z 起) n5 13.9/日×−0.623=−8.66U/日; lev10 段 n2 BIGTIME −2.13(钟; OKX 1m MFE +0.30%@22m 未到 +1%)/CTR +0.99(钟). **病根**: 15m 段 12 笔出场=11 钟+1 SL 腿(BANK 02:46 −6.75%)+0 TP 腿(TP 2.5×ATR 90m 内从未触及); 副: 多 11/−3.61 wr64% vs 空 1/+0.99, income 24h 多 176 fills wr39% −13.99 vs 空 68 wr74% +1.41(市值 24h −4.5%). **跨实例吃槽实锤**: 08:16:34 main 日志「当前已持仓2个，达到最大并发仓位1」=ON+majors ETH; 源码 strategy_signal.go:667-679 FetchPositions 全账户 + manager.go:294-319 isAllowedSymbol symbols="" 恒 true(不查 bl ⇒ CC-34 "BTC/ETH 入 main bl" 不解槽位) ⇒ mcp1 下 ON 09:16 到钟后 main 归零至 ETH 出场(最迟 20:16). 止损核对: main 腿✓ max_hold✓, majors 腿✓; 无裸奔; 无撞车. 429: 五窗分批 65s ⇒ 08:17-08:25 0 条(前三小时 :17 各 1 组=自伤已止, 纪律固化). CTR/ON 跨所 1m 回放基差失真 ⇒ 不采(证据不足). **本轮建议(板 #1959; TG 10832)**: [攻-1] DS 可执行 Go 热键 take_profit_pct=0.10+stop_loss_pct=0.20(ROI; lev10 =+1%/−2% 价; resolveTPSLFromROI :316-329 各自>0 替换 ATR 腿) | 0/12 TP 腿, 非 BANK MAE 最深 −1.27%, 7/12 到过 +1%; 反事实 −0.35%→+0.25~0.5%/笔 | 验: 腿距 1.00/2.00%·TP 腿成交占比 ≥40%·亏单 ≤−6.5U·均净 ≥+0.15; owner 等价=hunger 三键(第 5 次). [攻-2] DS 可执行 mcp 1→3(Σ0.75 过 L534; 锁到期) | majors 吃槽下 mcp1=main 归零; 13.9/日<地板 19; 252 信号/h 0 开 | 验: audit mcp=3·开仓/h ≥1.5·北极星 ≥0. 观察: 空 wr74% vs 多 39% 持续 n≥30 ⇒ 下轮议 lcp 0→0.10(需重启窗). FGI 71 Greed; BTC 80394(−1.0%) ETH 2579(−2.1%); dom 58.9%; trending ONE/BP/ZAMA/PENGU/PONS/STONK/BTC/NEAR/ZEC/HYPE |
