...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·feed89(种子bl13=期望态✓;BICO残留已释@08-15 09:2x rotate,overlap0) | running | pct0.08 sides=[buy,sell] **long_premium=0.35(FIX@08-14 18:47Z)** tpl567;_exp=**FIX长溢价0.15→0.35**(long_thr0.70→0.90;证据=48h长侧n20 wr30/−11.79过20笔门,病根=逆势栈0.70恰等长门,S12先例;keep=08-15 19:00Z长侧24h净≥−2U∧组均净较−0.216改善;劣化=长侧≤−6U或组净恶化→回0.15再议[sell]latch;全文config._exp)+**继承RECOVER刹线**(6h空侧≤−8U→重latch[buy];03:2x读−1.29未触);**FIX段读@T+14.4h(09:2x轮)**:长n2/−1.44零增(6h长0笔,0.90门节流在效),空n13/−12.27wr23(+ROBO−3.33/APR−1.93皆#30型)=空侧段主刀不变;臂现值分化:臂1长24h−1.44≥−2U✓/臂2组段均毛−0.687劣于−0.216✗(19:00Z评估轮以纯段24h窗当值为准,按侧拆臂:臂2恶化源=空侧非FIX触及路径);09:2x RECOVER读6h空−5.37未触−8U;sid伪影纪律照旧(§3) |
| qt-trend-long | 827ffe8c | 趋势动量多 | ACE/TUT/BICO/COTI(feed4=种子4✓@08-15 03:20 CAP种子卸载;aging_watch=TUT/BICO advisory) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;_exp v3常驻:**累计n26/−0.40回落负**(+BICO超时−0.47@06:51;归因复核:CAP12:38笔属main[开11:38在CAP晋升前,开仓时点池归属]与账链自洽);早结门净>0✗;劣化−5U/canary−5U(现6h+0.21)未触;费覆🟢24h+0.145vs0.133=1.09×薄;**终裁08-16 06:35Z**当值:净>0=keep/−5U<净≤0=证据不足结案S24留用(现值−0.40落此格);ACE 48h+3.44/COTI+3.56双扛旗∧ACE trending;全史git+config._exp |
| qt-fade-short | 21519f1b | 冲高回落空 | 1000CAT/ARC(种子✓;aging_watch全2币) | running@08-13 12:45Z | **tpl576(S25)** pct0.04 mcp2 sell;_exp v2续:累计n8/−2.63零增(现池零成交**第12轮**,want.fade=[]连续;非载具故障[06:19在评:1000CAT空0.48/ARC0.24<0.55门]);评期=累计n≥15或**08-16 12:50Z**(明日到点n8<15将再触证据不足格→届时议池补灌或停驶取舍);自动保险6h≤−6U(0✓) |
...
- 隔离区(规则≤−4U∧n≥4): 4/CYS/TST/龙虾/BMT/BTW/**H**(+@08-14 21:26,48h n6/−4.26全空wr17;孤儿4已释08-13归档)。**池列值=快照,权威=每轮对账器输出**。**对账器现版v1.3权威副本=quanty-ledger分支ops/route_pools.py@08-14(=334dae1内容;谱系61b1bb4←377c567←f970704;默认分支工作树只有v1.0初版——禁直接跑,实证2例错误plan)**:出池只认头注规则或隔离(失格币aging_watch);隔离表arg4;add互斥只排他专家池(v1.2误把main feed入排除集=晋升封死,COTI案实证修复);晋升币同轮移出main(封v1.1单轮重叠窗,执行序=先main remove后专家add);brk/lowvol出池阈值未注册前无自动出口(#42)
- 保证金: Σ_running=main0.08×5+trend0.05×3+fade0.04×2=**0.63≤0.75✓**(08-14 14:4x复核,rotate不动pct/mcp)
- 互斥不变式: feed层✓overlap0(BICO残留已释@08-15 09:2x,BICO仓06:51超时平后rotate成功;main89/trend4/fade2)>**种子层=期望态✓@08-15 03:20**(main bl13含H无CAP;trend种子4币;CAP释回main发现漏斗;重启免疫达成)>⚠️引擎互斥闸未部署;aging=trend2/fade2 advisory;重播种规律第4例(第2例无端型,升§3):feed播回auto100含bl币(信号层bl在防零交易风险)→热rotate自愈;种子同步后专家池重启免疫实证(trend4/fade2零漂移);pre-restart IDLE行93 vs API91=频道层订阅残留伪影(重启自清,观测勿当违规)
...
| 30 | S21类(代码gate) | 追跌空反弹拒空veto候选(gate7e,暂缓中): short且跌势陈旧拒;draft单维300m阈值族**证伪@08-07**(误杀24%>10%门,收紧复审仍12%,−10~−14带无分离力);下一迭代=加第二判别维(距60m低点反弹幅/自低点时间) | 追跌型累计10例/−24.28+晨午簇候审15(vision T+1定标待做)〔审计全史见git 121e975 #30行〕 | **n=16/−37.71**+候审15·暂缓(+2@08-15 09:2x CG5m定标:ROBO 06:56空低42m前∧自低+4.86%→中段SL−3.33;APR 07:52空低23m前∧自低+8.36%∧距180m高−31.9%砸盘反弹→6m快SL−1.93;+1@06:2x VELVET 04:40空低166m前+4.02%→SL−1.77;前例AIO×2/DOLO全文git 42e4fc8) | 执行门=确认型≥20或owner核准;影子通道S23 WS vs AS已随#37冻结;误杀审计先行原则保留 |
...
|---|---|---|---|---|---|
| 08-15 09:12-09:3xZ | 例行轮(max) | close: 1h0/3h−4.57(4)/6h−5.16(7,wr43)/12h−5.52(14,wr50 be64=−14pp)/24h−17.97(42,wr40 be57=−17pp) | FGI34/BTC+0.15%/mcap+0.19%无降压;trending∩池=ACE(trend)+AKE/UNI等(main) | ①ROUTE:BICO残留释放落地(仓06:51平→rotate成功,feed90→89 overlap0全绿;对账器v1.3 plan仅此一项,want.fade=[]第12轮) ②#30定标+2=**16/−37.71**(ROBO/APR空皆追反弹型,CG5m双维正证) ③trend累计修正**n26/−0.40**(BICO超时−0.47;CAP12:38按开仓时点归主main,账链自洽) ④0原子包(三_exp槽占:FIX今19:00Z/trend明06:35Z/fade明12:50Z;#11队首候FIX评后窗,本段空侧又+13笔/−12.27证据) | 钱包≈227.0(avail188.4+押41.7−浮3.10;2空仓VELVET+1.71/APR+1.49) ;FIX段T+14.4h:长n2/−1.44✓vs空n13/−12.27wr23主刀;臂2组段均毛−0.687劣于−0.216✗(19:00Z纯段窗裁);RECOVER6h空−5.37/−8U未触;trend6h+0.21/fade6h0/组6h−5.16全未触线;死法24h:快SL9/−15.91+中段SL7/−16.15主刀,TP类12/+17.98,超时10/0;费覆:组🔴−0.428vs0.133禁提频(main🔴−0.620/trend🟢1.09×薄);audit零无主;三载具日志活性✓(main09:19 IDLE feed90→89) |
| 08-15 06:16-06:3xZ | 例行轮(max) | close: 1h0/3h−0.60(3)/6h−0.43(7,wr57)/12h−7.10(18,wr39 be53=−15pp)/24h−8.65(49,wr47 be56=−9pp) | FGI34/BTC−0.34%/mcap+0.16%无降压;trending∩池=ACE(trend)+LINK/ROBO/LAB/VELVET(main) | ①ROUTE:对账plan=main−11(无端重启重播种漂移);热rotate−10落地feed100→90,BICO被has_open_position拒(持仓属trend,账户级判;bl在防)下轮重试;无晋升无新隔离;bl13种子=期望✓ ②无端重启第2例→§6计数2升§3平台事实(预登记判据履行) ③#30+1=14/−32.45(VELVET空CG定标) ④0原子包(三_exp槽占:FIX今19:00Z/trend明06:35/fade明12:50;#11队首候FIX评后窗;#8候main槽) | 钱包≈231.3(avail196.7+押34.9+浮−0.33;2新仓:BICO多@trend05:51/AVAAI空@main05:47);FIX段T+11.5h:长n2/−1.44臂1✓∧组均净−0.177优于−0.216臂2✓vs空n11/−8.88wr18段主刀;RECOVER6h空−1.51未触;trend累n25/+0.07首转正(早结门毛均净✗等终裁);fade零成交第11轮;死法24h:快SL16/−29.34主刀,快TP+饥饿+中段TP合+21.95全正,超时11/−0.48;费覆:组🔴−0.177vs0.129禁提频(main🔴−0.328/trend🟢1.7×);四保险未触;audit零无主(仅03:20自PATCH×2);三载具06:19信号活性实证 |
| 08-15 03:12-03:4xZ | 例行轮(max) | close: 1h−1.23(1)/3h+0.17(4)/6h−0.36(7,wr57)/12h−11.67(24,wr38)/24h−9.80(54,wr48 be54=−6pp) | FGI34/BTC−0.49%/mcap−0.14%无降压;trending∩池=ACE(trend)+ALICE/UNI/LAB/APR(main)+CAP(回main) | ①ROUTE:对账plan={}零rotate;**种子层同步落地**(全组空仓窗两原子窗:trend symbols5→4去CAP 11s✓;main bl换CAP入H 10s✓;重播种带回11bl币[信号层在防]→热rotate−11自愈feed89 overlap0;候重启窗待项全结案,种子=期望态=重启免疫) ②#30定标+1=**13/−30.68**(AIO 00:35空:低点6m前已出+已反弹2.41%仍追空→+9%轧死;§4) ③0原子包(三_exp槽占:FIX今19:00Z/trend明06:35/fade明12:50;#11队首候FIX评后窗;#8候main槽释放) | 钱包232.64全空仓(较上轮−0.02);FIX段T+8.4h:长n2/−1.44节流在效vs空n9/−7.60wr11主刀不变;trend累n24/−0.61(终裁明晨需>0,费覆🟢1.64×首达);fade第10轮零成交(ARC 0.48近门);死法24h:快SL17/−30.11主刀,饥饿+快TP+21.49全正,超时12/−1.18;费覆:组🔴−0.181vs0.121禁提频(main🔴−0.321/trend🟢);近6h企稳−0.36;四保险未触;audit零无主;三载具重启后信号活性实证 |
| 08-15 00:14-00:4xZ | 例行轮(max) | close: 1h+0.14(1)/3h−0.53(3)/6h−6.67(11,wr27)/12h−15.80(24,wr33)/24h−13.17(57,wr46 be54=−8pp) | FGI34/BTC−0.79%/mcap−0.59%无降压;trending∩池=ACE(trend)+ALICE/UNI(main) | ①ROUTE:**CAP出trend**@00:19(出池规则48h nL6/L净−0.21<0命中;池内3笔−1.74同向更差;churn1)feed5→4 overlap0复核✓;bl期望=换CAP入H候重启窗 ②0原子包(三running _exp槽全占:FIX今19:00Z/trend明06:35/fade明12:50;brk gated候组费覆🟢现🔴;#30候FIX评后窗为main队首) ③FIX段T+5.6h早读:长n2/−1.44(节流生效)vs空n6/−7.36wr0(ALICE=S20边界+AIO/DOLO=#30型+3负超时)=未触路径主刀;长劣化线−6U未触不提前动;19:00Z判读须按侧拆臂 | 钱包232.66全空仓(较上轮−0.65);24h载具:main40/−14.19wr38(长15/−12.45)/trend17/+1.02wr65/fade零成交第9轮;trend累n23/−1.02终裁明06:35需>0(ACE/COTI扛旗CAP已卸);死法24h:快SL17/−28.81主刀,超时14/−1.42,快TP+10.42+饥饿TP+7.70全正;费覆组🔴−0.231vs0.121(main−0.355/trend滑🔴0.060vs0.074组内零🟢);四保险未触(RECOVER空6h−4.60/−8U);audit零无主;三载具K线/信号活性实证 |
| 08-14 21:15-21:4xZ | 例行轮(max) | close: 1h−6.04(4,wr0)/3h−6.13(8,wr12)/6h−11.30(17,wr29)/12h−12.44(28,wr36)/24h−15.09(56,wr43 be54=−11pp) | FGI29/BTC−0.82%/mcap−0.71%无降压;trending∩池=ACE+CAP(trend)+AKE/LAB/UNI(main) | ①ROUTE:**H隔离**(48h n6/−4.26全空wr17达线)热移除@21:26 feed92→91 overlap0,隔离区6→7,bl desired14候重启窗 ②#30追跌空反弹+2例=**12/−27.72**(AIO砸底追空/DOLO陈旧腿,CG5m定标;ALICE=S20边界期现分离非泄漏) ③0原子包(四_exp槽全占:FIX明19:00Z/trend 08-16 06:35/fade 08-16 12:50/brk gated;#11队首候FIX评后窗) | 钱包233.31全空仓(较上轮−9.07=FIX后段亏损兑现);FIX段早读:长侧仅AKE n1/−1.82(0.90门高置信仍接刀),空侧n5/−6.30wr0;劣化线滚窗伪影解释注记见§1.5(不提前回滚);RECOVER空侧6h−3.48/−8U未触;trend累n22/−1.16 canary−1.88;fade第8轮零成交;死法24h:快SL18/−31.24主刀,超时13/−0.55拉平,饥饿+快TP+15.43全正;费覆组🔴−0.269 vs 0.100(main🔴−0.361/trend🟢1.1×);audit零无主;引擎21:23信号评估在跑✓ |
...
> 瘦身注 08-15(06:3x轮更新)：更老运行日志行随轮裁剪(08-14 15:49轮ROUTE自愈+CAP种子同步要点已存§1.5+git;08-14 18:05告警轮-2011竞态定案已存§3+§6+git 313676f;08-14 09:28轮S24评期v2+14:38轮CAP晋trend/#46落地要点存git a3804f3;08-14 06:41轮brk评判FAIL要点存brk _exp+§1.5+#47;08-14 00:32轮v1.3对账器要点存§1.5对账器行),全史见 git 历史。