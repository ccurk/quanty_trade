...
|---|---|---|---|
| 2026-09-20 04:1x-04:3x(v6.0 #7) | 上轮(03:27)= [攻-1] hunger_mode_enabled=true(lev2 下 sl 0.04=2% 价) / [攻-2] owner UI mcp 1→3(第 3 次); 携带 MIN_TRADES 30→10 / BANK 拉黑 | **DS 23:54 后仍 0 改动**(样本门 6h 13<30 ⇒ [skip]; mcp 锁 05:39Z, max_hold+pct 锁 05:54Z; hunger 仍 false, mcp 仍 1). **03:31:57Z admin(1) 两条 PATCH 48ms 内: main {leverage 2→10, order_amount_pct 0.125→0.25}(audit 1950) + majors {order_amount_pct 0.25}(1951), 无 _exp 伴随 ⇒ 非 DS 自锁路径(:572 必写 _exp)/非 qt_breaker(只降 pct) ⇒ owner 值恢复, 候认领**. 03:19:26Z 重启=部署 7bc5a96+7a14c46 实证: 03:31:09 "跳过信号：交易对连亏熔断中 BANK 连亏=1 短冷却30m" 行; strategy_execution.go 夹带 [0.2,2] ⇒ conf_sizing_max_mult 0.8 自此真生效 ⇒ 下一笔名义 131.5×0.25×10×0.8≈263U(上一笔 38U, ×7) | **效果**: 03:03 后 0 平仓 ⇒ 北极星无新读数; 15m 段仍 n10 毛 −0.91 均 −0.091 wr70%(main n9 −1.89: BANK 3 笔 −3.30 vs 其余 6 笔 +1.41). 逐笔 04:16Z: 1h 0 / 3h 3/−1.41 / 6h 9/+0.58 wr78% / 12h 63/−4.35 / 24h 142/−24.56(空 48/−20.53 wr35% 全 1m 时代); avail 131.5; 持仓 1(ROSE 多 03:16:03 lev2 开 腿 tp .007551/sl .007167 +0.44 MFE +1.49%); majors 0 仓. 吞吐: 03:46/04:01/04:16 三 bar 各 34/122/117 条★信号 0 开(ROSE 占 mcp1 唯一槽; strategy_signal.go:784 logMaxPosSkipOnce 同 openCount 只打一行 ⇒ 03:31 后"跳过本批信号"静默≠没跳); VTHO 0.958(24h +4.30)/MANTRA 0.961/SOPH 0.898 弃. **病根**: lev10×pct0.25 每笔 ×7, 而 v40 候选 SL 距(2×ATR) 04:01/04:16 顶部=CELR 18.4%/AKE 10.6%/AVA 10%/ZIL 7.1%/C 6.7% ⇒ 一次腿成交 −18~−48U, 10x 强平线≈−9% 在腿内侧, 零金额帽. **1m 回放(vision) 15m 段 11 笔 MAE**: VANA −0.46/ATOM −0.35/BANK(赢) −0.53/NIL −0.16/POWR −0.62/SUI −0.84/PUNDIX −1.29/ETH −0.20/ROSE −0.14 vs BANK 亏单 −5.79(21:16)/−6.97(02:46) ⇒ 2% 价帽只砍亏单零误杀: 段 −0.91→+1.71. 止损核对: ROSE 腿 ✓, majors 0 仓 ✓ 无裸奔; 隔离无撞车. **本轮建议(板 04:26:53Z 3 条 7.9KB 弃 01:27 条; TG 发)**: [攻-1] hunger_mode_enabled=true + hunger_stop_loss_pct=0.20(ROI, lev10=2% 价≈5.3U; tp 0.30/after 1 不动; 两键热且不在冻结集; DS 停摆 ⇒ owner UI) 验 "饥饿模式触发…sl=20.00%" 行·亏单 ≥−6U·赢单不因 hunger_sl 出场·段均净 ≥+0.15; [攻-2] owner UI mcp 1→3(第 4 次, 先帽后槽) 验 开仓/h ≥2·n≥15 均净 ≥0. owner 权限项: 03:31 认领 / MIN_TRADES 30→10 / BANK 拉黑. 0 交易键写入(diff=[_ai_task_cc]). FGI 71; 市值 24h −4.6%; BTC dom 58.9%; trending∩池 ENA/AVAX/ONE(bl)/ZEC/NEAR/AKE(bl)/HYPE/PENGU |
| 2026-09-20 03:1x-03:3x(v6.0 #6) | 上轮(02:37)= [攻-1] owner UI main mcp 1→3 / [攻-2] owner 改 MIN_TRADES 30→10 + 事实#4; 携带 hunger true | **DS 23:54 后仍 0 改动**(audit admin 最新 23:54:08; config mcp1/hunger false/max_hold90/lev2/pct0.125/max_mult0.8 diff NONE; majors bl 仍 [BNB,SOL,XRP]); owner 未动(MIN_TRADES :72 仍 30) ⇒ DS 第 4 轮 [skip](6h 10 笔<30). **源码定案**: deepseek_optimize.py 0 处引用 _ai_task_cc, ops/ai_task_bridge.py 不在仓库 ⇒ 留言板 DS 不读, 建议唯一通道=TG→owner; hunger_mode_enabled 在 DS 白名单(validate() :379-384 布尔直通, BOUNDS (0,0) 仅占位); symbol_blacklist FORBIDDEN(:118); max_mult 0.8 被 strategy_execution.go:47 钳回 1.0(日志 mult=1.00)=空改. **03:19:26Z backend 整体重启**(开机自恢复, 两实例自拉, runtime 1789874366; origin/main 新 4 提交 363b3f3/6771c1a/ed67489(腿按步长四舍五入)/7bc5a96 02:47Z 单笔亏损后 30m 短冷却 loss_cooldown_minutes 默认 30 ⇒ 候=owner 部署, 验=03:33 后 BANK 信号被 "短冷却30m" 拒); 主池重播种含 bl 币, Go 闸在拦(跳过信号：交易对在 blacklist) | **效果**: 无法评(0 改动). 北极星 15m 段(21:16→): 上轮 n7 +0.50 均 +0.072 → 本轮 n10 −0.91 均 −0.091 wr70%(main n9 −1.89; majors ETH 空 +0.98 TP 腿 02:40:57); mcp1 段 main 4 开/3h41m≈26/日, 已平 n4 −1.71. 逐笔 03:20Z: 1h 3/−1.41 3h 4/−1.13 6h 10/−0.91 12h 67/−5.80 24h 151/−30.31(空 54/−28.63 wr31% vs 多 97/−1.68 wr45%); avail 131.4; 持仓 1(ROSE 多 03:16:03 conf1.0 腿 tp .007551/sl .007167 order 4000001911957379/80 +90 钟). **病根**: BANK 一币吃掉整段: 去 BANK 6 笔 +1.41(wr5/6 均+0.24 全钟出场) vs BANK 3 笔 −3.30(22:01 −1.49 钟/23:31 +0.76 钟/03:03 −2.57 SL 腿 18m, −6.75% 名义); BANK 15m ATR 3.6-4.1%(1m 时代 1.1-1.3%) ⇒ 2×ATR 腿 −7.4% 价; 赢单币 15m ATR: ATOM 0.65-0.71/POWR 0.36/SUI 1.14-1.23/PUNDIX 0.56-0.59; BANK 48h 7 笔 −2.84 wr3/7; 24h 最差 AR −9.08/CROSS −7.12/XTZ −5.88/OP −5.48, 最好 HEI +8.44/ROBO +5.58/VTHO +4.30. 槽位: 02:46 bar 92 信号 1 开(BANK 1.267)/03:01 148 信号 0 开(BANK 占)/03:16 128 信号 1 开(ROSE 1.889; GRASS 1.607/G 1.273/AVAX 1.271 候选开仓失败). 止损核对: ROSE 腿 ✓, ETH 腿成交 ✓ ⇒ 无裸奔; 隔离无撞车. v40 只读键复核: 无 max_atr_pct/min_atr_pct_for_trade(死键), 读 atr_sl_mult/atr_tp_mult/min_confidence/cooldown_sec/bar_agg_minutes/max_candidates. **本轮建议(板 03:27:19Z, 3 条 7.6KB 弃 00:28 条; TG 10814)**: [攻-1] hunger_mode_enabled=true(hunger_sl 0.04 ROI=lev2 下 2% 价, quick_trade_monitor roi≤−4% 即平, 只紧不松; BANK −2.57→−0.76 ⇒ 段 −1.89→−0.08; lev 回 10 须 hunger_sl=0.02×lev) 验 q=饥饿模式触发 有行·任一亏单 |pnl|≤1.0U·15m 段均净≥+0.15; [攻-2] owner UI mcp 1→3(第 3 次) 验 开仓/2h ≥2×·候选开仓失败 归零; 携带 MIN_TRADES 30→10 / BANK 拉黑=owner 权. 0 交易键写入(diff NONE). FGI 71; 市值 24h −4.7%; BTC 80187(−1.3%); trending∩池 TRUMP/AVAX/ENA/ZEC/NEAR/PENGU/ZAMA/G/OP/SUI/PRL |
