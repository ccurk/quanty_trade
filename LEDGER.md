...
| qt-trend-long | 827ffe8c | 趋势动量多 | ACE/TUT/COTI(feed3=种子3✓;aging_watch=全池advisory[COTI 08-21起3笔2W1L,ACE/TUT零发,出池规则无一命中];破荒史git f43756c) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;**低波解锁三值包@08-22 04:1x(owner直令)**: mces null[连开闸off]+adt0.5+lcp0.149[#65修];**_exp=open(EXP低波解锁,进度n=5/−2.39@08-22 09:1x[5笔入场全落0.5-1.0解锁区:ACE2笔−4.73含闪崩−3.67,COTI2+TUT1全胜+2.35],劣化n≥8∧净≤−4U回滚三值,评n≥8或08-24 12Z)**;程序=stop[poll1]-PATCH-start✓running✓feed3✓;**常驻保险=滚动6h净≤−5U→stop(继承)**;S24 keep史+BICO归因修正史git f43756c;§4#55需求已被本包吸收 |
...
| 08-22 06:1x-06:4xZ | 例行轮(max) | 1h+0.56(10)/3h−3.11(11)/6h−3.11(11)/12h−4.64(15,wr53/be~65)/24h毛−2.93净−3.67(24,wr58/be65) | FGI71 Greed/BTC77.2k+2.5%/MCap+0.6%无降压;trending∩池=PUMP(已出feed) | **ROUTE 1动作(不计原子包)=热清#22重播种泄漏11币**(05:50:44Z引擎无audit不明重启[统计行池91→100跳变实锤,2000行窗唯一一次],10清/COLLECT挡仓下轮,feed100→90,bl17闸全程无违例;TG问owner是否重部署);**0原子包HOLD**(两_exp攒n中:trend低波解锁n=1/−3.67[ACE 05:06闪崩:SL挂−3.5%瀑布击穿成交−12.5%=滑点税−2.6U,斩后30s再−8%RSI6.2=guard反省~2.9U,1.4×满置信仓29.4U,n=1不动],v2低波适配n=2/+1.38[HANA+1.38破荒✓];劣化线n≥8与载具保险[trend 6h−3.67距−5线1.33U]站岗);波动率05:00Z暴力回归=组爆发14笔/70min+11仓全short在飞(10main+1fade2,名义274U/margin137U,avail80.9,mcp200自阻尼预期行为);刹车全绿[6h−3.11 vs −17.4/24h−3.67 vs −43.6钱包~218];组费覆24h均毛−0.12<0.13🔴禁提频[fade2+0.80✓/trend🔴/main−0.21🔴];待落0 | 死法24h:快SL主血(ACE−3.67/PUMP−1.67轧空trending币);fade2 24h n=6/+4.82 wr67组内唯一正车 |
