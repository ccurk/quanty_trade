...
| qt-fade-short-v2 | 7583727a | 冲高回落空(tpl887/S28+S29;谱系576/S25→823) | HANA/COLLECT/MELANIA/BTR/VELVET(feed5✓;VELVET入池#52@08-26/BTR#35;MELANIA出池线触发但deferred@#36=defer至_exp终裁;史git) | running | S28衰竭签名直入@08-23 21:24Z(#66修复+#65epsilon永久化;apply三复检✓);**_exp=open·B延期@08-25 21:18Z:评期=段n≥16或08-28 21Z先到,到期签名域仍n0→auto-C停v2(FLEET预注册);终裁按入场路径拆分;段锚@08-28 09:3x=段n9毛−0.079净≈−0.28全常规签名域n0(HANA3毛+0.058/BTR+0.269/+1.014/−0.768/−0.933fastSL/VELVET−0.176超时60m/BTR+0.457trailing37m;closed行口径);二元段净>0→keep否则rollback tpl576/S25;劣化线段n≥8∧≤−4U未触**;保险6h≤−6U停(继承);预案/checkpoint/烟雾债全史git 830a46c/91b3276/48ca3ce/f0e03bf;连开3拦BTR×4@08-27-28全常规+异币入场复位实证(多币池cap自愈,v2无须mces改动);低波三值包ROLLBACK@08-23=组级知识(git a2e845f) |
...
| main断流观测(三闸交集关门) | 本轮main笔数=12/24h@08-28 09:3x(档5+非档7,管道畅;scp回0.05后档流停,预期回落非档节奏~5-8/日) | 08-28 09:3x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| 收养错归属亚型(#57族;§4#72) | **n=1维持**(post-fix新增0,复核08-28 09:3x✓:4h窗v2新行3条全sid=7583727a真归属,21519f1b行0=18Z FIX评pass轨) | 08-28 09:3x | 判据:自bl后再现sid错归属行→#72升部署主诉求;18Z评期=FIX v2终裁点 |
| main行零归属(空sid;§3 closed回填缺口) | 本轮4h窗main池新行5条全空sid(MAGMA/TAC/JCT/CLO/SKR)@08-28 09:3x=结构性签名维持 | 08-28 09:3x | 无P&L实害;判据:crash loop根因修复后仍空sid→升M通道close-sync候修;每轮扫main池closed行空sid计数 |
