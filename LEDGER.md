...
| 58 | E9类(main扩仓) | **main pct 0.08→0.10**(config-only;Σ=0.10×5+0.05×3=0.65≤0.75✓;回滚=回0.08) | main载具费覆首次12h/24h双🟢@08-17 09:2x(24h n12/+4.74 avg+0.395=3.8×费 wr83全空侧;12h+0.167=1.6×);硬边界#1按载具判=允许,组口径🔴不锁单载具扩仓但#57在飞收养竞态=fade config接管main赢家仓(BEAT/BLUAI实证)→扩仓入缺陷不洁 | n=12段 | 候选@09:2x;**门=①a451d32部署+#57双行归零观察2轮 ②main 24h费覆🟢维持 ③执行窗现拉复核净为正**;执行走EXP _exp预注册(main槽空闲) |
...
| 08-17 09:2x-09:5xZ | 例行轮(max) | @09:20: 1h+0.32(1)/3h+1.19(2)/6h−0.75(4)/12h−0.80(6,wr50 be61)/24h+1.13(17,wr65 be61,wr−be+4pp) | FGI31/BTC+0.5%/市值+0.5%无降压;trending∩池=BEAT(main)+ACE(trend在飞)+BTW隔离在防 | ①0原子包HOLD(组24h费覆🔴avg+0.066<0.109续锁#55#47;**main首次12h/24h双🟢**0.167/0.395→**#58扩仓候选登记**,门=#57部署验证2轮+main双🟢维持;双_exp槽空闲无在飞) ②ROUTE plan={}(bl13逐项一致✓;aging_watch=trend全池advisory;无隔离候选) ③**#18翻案:幻影未归零**7隙型行(BEAT4/VELVET3方向翻转sid空,最新08:08)滤行纪律保留 ④刹车全绿(6h−0.75/24h+1.13 vs −17.8/−44.4,trend6h−1.18>−5,main空6h+0.43>−8,Σ0.55✓);a451d32未部署(feed88无重启;幽灵02:37后静默;BEAT08:21仍fade sid=#57续存) | 死法24h:WIN11/+7.53,fastSL3/−4.51,timeout2/−1.05,hunger1/−0.85;载具拆分=main n12/+4.74(wr83,**全空侧10W2L**)/trend n2/−2.03(wr0;ACE多09:01在飞+0.72已BE锁盈SL入场上方1%)/ISO残1/−1.61(BICO隔离前末笔)/ghost n2/+0.02;**24h组级长侧0W3L/−3.64=市场付钱给空头**;钱包≈222(avail205.8+ACE仓);充值信号未触(12h净负);⏭a451d32部署观察/#58门追踪/ACE在飞结果 |
...
> 瘦身注 08-17 09:4x：03:12行随轮裁(BICO隔离轮,要点存§1.5隔离区+§6结案;全文git f4d2c56)。前注链(07:3x/00:4x/18:4x/15:5x/12:5x等)压缩归档,全史见 git 历史。