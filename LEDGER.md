...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·**feed89@08-22 15:2x(MELANIA晋升出→fade,rotate零挡)·前feed90@09:2x(重播种#23=07:54:47Z无audit不明重启[今晨第2次,fade2 START行为锚],泄漏10=隔离6+专家4,热清10/10零挡[全账户空仓],COLLECT本次未回流=掉出auto宇宙;bl17交易闸全程无违例)**(#22=05:49:44Z清10/1挡+#20史git;宇宙换血史git 18a2dbf) | running | pct0.08 sides=[buy,sell] **long_conf_premium=0.35(#61c终裁rollback@08-19 15:3x,门0.90=多头事实关闸,#61族基线)** tpl567;**trailing(act1.0/cb1.2%)+BE(1.0)=基线几何(#49终裁KEEP@08-16 18:2x)**;**_exp=closed rollback(#61c终裁,全文存_exp+§4#61/#63;#61b浮点边界破案史git 0940c62+95e4c9f)**;#49 verdict存git;#49终数存_exp.verdict史+git+§4#49;RECOVER刹线6h空≤−8U继承;#11降级观察(§4);**BICO已隔离@08-17 03:2x**(§6结案) |
| qt-trend-long | 827ffe8c | 趋势动量多 | **COTI/TUT**(种子2=feed2✓@08-22 15:1x #67落地;ACE隔离@12:22[48h−4.40 n=4机械线];aging_watch=TUT advisory;破荒史git f43756c) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;**低波解锁三值包@08-22 04:1x(owner直令)**: mces null[连开闸off]+adt0.5+lcp0.149[#65修];**_exp=open·n8评期中间裁决@08-22 12:2x=延评一次(n=8段毛−1.84净≈−2.04落预注册空档[keep门净>0未达/rollback门≤−4U未触];ACE闪崩−3.67=段亏78%,除该笔7笔+1.83 6W1L;COTI连开3/3胜+1.30;延至n≥16或08-24 12Z二元终裁[净>0→keep否则回滚,不再延];劣化线≤−4U与6h−5U保险持续站岗;_exp延评文本已落库@15:1x #67)**;**进度@15:2x: n=10/16段毛−0.46(切ACE后2/2胜+1.38,COTI 5笔TUT 1笔)**;程序=stop[poll1]-PATCH-start✓running✓feed3✓;**常驻保险=滚动6h净≤−5U→stop(继承)**;S24 keep史+BICO归因修正史git f43756c;§4#55需求已被本包吸收 |
| qt-fade-short-v2 | 7583727a | 冲高回落空(tpl576/S25继承) | HANA/COLLECT/**MELANIA**(feed3@08-22 15:2x MELANIA晋升自main[48h S+2.29 nS3 wr100%头注fitF];种子仍2→#68窗写回;⚠️#57-ROUTE病理活测第3例[VELVET/BULLA先例],看护=隔离线/出池线/保险线既有三层) | running | 建壳@08-21 16:5x(tpl576/S25继承,config继承史+首笔HANA−0.94+黄金窗零发单三层拦机制链git f43756c);**FLEET评期提前结案@08-22 04:1x**(管道域PASS=11.5h伪行0/收养0/保险绿;盈利域不可判=n1结构性饥饿,verdict全文config._exp.prior_fleet_verdict);**低波适配三值包@04:1x(owner直令)**: minatr0.35+adt0.5+scp0.049[#65修]=梯度防护(≥0.5全分/0.35-0.5需raw0.75/<0.35拦);**_exp=open(EXP低波适配,进度n=5/毛+0.92@08-22 15:2x[新增10:53 HANA+0.21@0.5-1.0带;带级@09:1x:地板带0.35-0.5仅1笔−0.11 vs 带线−3U✓/0.5-1.0带2笔+0.82/≥1.0基线1笔−0.00;观察:段内空单入场RSI32-47动量路径为主非RSI>75衰竭档],劣化n≥8∧净≤−4U回滚三值+带级护栏0.35-0.5带净≤−3U单独回滚地板,评n≥8或08-24 12Z)**;程序=stop[poll1]-PATCH-start✓running✓feed2✓;保险=6h≤−6U停(继承);载具累计n6/毛−0.03(含前包−0.94)@15:2x |
...
- 隔离区(规则≤−4U∧n≥4)【13】: 4/CYS/TST/龙虾/BMT/BTW/H/APR/AIO/BICO/BEAT/XNY/**ACE**(+ACE@08-22 12:22[48h n4/−4.40=闪崩滑点−3.67+快SL−1.06+2平胜;trending榜上仍隔离=失血证据压过入池信号;热rotate出trend即时生效,main bl本就含ACE故bl17内容零变化仅语义重分类,种子写回随#67])(+BEAT[n9/−4.19混合血统,main era仅−0.76 rehab须知]+XNY[n6/−4.23全main空]@08-17 13:0x;+BICO[n8/−4.05资金费磁铁§6结案]@08-17 03:2x;+AIO/APR/H等史git;逐条全文git bb3b883)。**池列值=快照,权威=每轮对账器输出**。**对账器现版v1.4权威副本=quanty-ledger分支ops/route_pools.py@08-22**(v1.4=roster遮蔽修复:ROSTER同角色双壳时stopped旧壳[21519f1b]覆盖running新壳[7583727a]的running态→fade差分v2上线以来静默跳过,MELANIA晋升条达标无plan实证@15:18;修复=running壳优先;头注阈值零改动;谱系v1.3@08-14←61b1bb4←377c567←f970704;v1.0默认分支禁跑;演进史git bb2e)。**arg4输入纪律(08-15实证):隔离表必须X/USDT形态**(裸名norm不match feed键→漏移)。出池只认头注规则或隔离,失格=aging_watch advisory;brk/lowvol出池阈值未注册(#42)前无自动出口。最近跑@08-22 15:18(v1.3暴bug后v1.4复跑): **plan={}但want.fade含MELANIA=遮蔽bug漏差分→手工代执行晋升(先main.remove后fade.add@15:2x,churn1/4,rotate零挡)**;v1.4复跑回归=plan{}✓aging_watch=trend.TUT+fade.HANA✓;desired bl**18**(+MELANIA)种子层缺口1→#68;前跑12:20: plan=trend.remove ACE(隔离新增,不限流),热rotate 12:22执行✓feed COTI/TUT,desired bl17=actual零缺口✓(ACE重分类内容不变),want.fade=COLLECT持平(HANA无出池条件nS3/S净+1.48),want.brk=COTI/HANA/MOVE/ONG/PUMP/TUT(#47锁),隔离12币48h零成交✓;前轮09:16清#23泄漏10币史git d0e40d9;15连空史git 2ce0fb4系,前史git f623b98/044907d
- 保证金: Σ_running=main0.08×5+trend0.05×3+fadev2 0.04×2=**0.63≤0.75✓**(08-21 16:5x FLEET建壳重算;前史0.55见git)
- 互斥不变式: feed层@08-22 15:2x复核=main89/trend2/fadev2 3**两两∩∅**(MELANIA唯一在v2;若重启回灌main由v1.4对账器plan.main自愈+互斥闸兜底);种子层=main bl**17** vs desired**18**(+MELANIA)=缺口1待#68;重播种**#23=08-22 07:54:47Z清10零挡;#22=05:49:44Z清10/1挡;#20=08-19首例实证bl币可直漏feed('重启免疫'=交易闸级非feed级)**(#8-#19史git);引擎互斥闸✓live;**fade壳seed5与main auto理论重叠=停机态无违例**(不变式限定running载具;若owner UI复活fade须先重划池,互斥闸+TG示警兜底);隔离币零成交✓(复核@08-21 09:2x,48h窗隔离12币零平仓行)
...
| # | 类型 | 内容（含完整意图） | 登记轮 | 状态 |
|---|---|---|---|---|
| #68 | 种子同步 | ①v2下个PATCH窗(如_exp评判窗)symbols种子写回["HANA/USDT","COLLECT/USDT","MELANIA/USDT"] ②main下个重启/PATCH窗symbol_blacklist 17→18(+MELANIA/USDT,=对账器desired_bl@15:18);未同步期风险=重启回灌MELANIA进main feed,由v1.4 plan.main热清+引擎互斥闸兜底 | 08-22 15:2x | open(纯种子卫生不阻交易) |
...
| 08-22 15:1x-15:3xZ | 例行轮(max) | 1h 0(0)/3h毛+3.60(4)/6h净+3.03(12)/12h净+0.36(44,wr64/be61)/24h净−0.83(50,wr64/be64) | FGI71 Greed/BTC76.9k−1.0%无降压;trending∩池=TRUMP,PUMP | **0原子包;#67落地**(15:11真空仓窗:trend种子写回+_exp延评文本,poll1即stopped,三值包完好);**ROUTE=MELANIA晋升fade**(48h S+2.29 nS3 wr100%,先main.remove后v2.add,churn1/4,main feed90→89,v2 feed3;#57-ROUTE病理活测第3例注records§4);**对账器v1.4**(roster遮蔽bug修复:stopped旧壳盖running v2壳→fade差分自v2上线静默跳过,MELANIA案暴雷;修复回归plan{}✓;头注阈值零改动);#68登记(v2种子+main bl18种子同步);刹车全绿[6h净+3.03/24h净−0.83,avail221.29]两保险绿[trend段6h+1.93/v2 6h+0.21];trend _exp n=10/16段毛−0.46(切ACE后2/2胜);v2 _exp n=5/8毛+0.92;组费覆24h毛均+0.006<0.091🔴禁提频(6h段+0.26>0.094首🟢=修复兆头);充值不发[24h负] | 死法24h:快SL8笔−10.54主血管(ACE×2−4.73已隔离/PUMP−1.67)/硬超时7笔−1.83/饥饿5笔−1.43/赢25+13.95;载具拆:main n32/净+0.60(MELANIA+2.29最佳)/trend n12/净−1.29(全ACE血)/v2 n6/净−0.14;audit全claude_cron无无主改动;feed稳无重启 |
| 08-22 12:1x-12:3xZ | 例行轮(max) | 24h毛−6.50净−7.76(50) | FGI71 | **ROUTE=ACE隔离**(热rotate出trend,隔离区12→13)+**trend _exp n8延评一次**(段毛−1.84空档;verdict_n8全文已入config._exp@15:1x)+#67登记;0原子包;费覆🔴 | stub;全文git 7de65756 |
| 08-22 09:1x-09:3xZ | 例行轮(max) | 24h毛−3.57净−4.81(44) | FGI71 | **ROUTE热清#23重播种泄漏10币+0原子包HOLD**(trend _exp n5/−2.39;v2 n4/+0.71;TG询owner疑crash loop) | stub;全文git 7de65756^ |
