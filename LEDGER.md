...
| S31·regime动态方向偏置(**升队首候选@08-29 17:0x owner动态化直令**) | v1谱:宽度regime三档(池内EMA-up占比<0.35=RISK_OFF/0.35-0.60=中性/>0.60=RISK_ON)→动态premium加减(OFF:多头prem+0.10;ON:多头−0.05空头+0.05),阈值内联防漂移,S31_ENABLED False-guard回滚,叠加于config prem之上(config回滚路径保留);main先行 | 08-29 17:0x | **已上线@09-01 10:02=tpl988**(patcher断言过=基底零漂移/编译+6符号+锚8组✓/apply字节复检✓/零模板泄漏✓);_exp评09-04 09Z或S31段n≥20,到点n<5顺延48h一次(49h宕机后市场冷启动条款);劣化线=S31段多头净≤−3U或组wr−be劣化≥5pp@n≥20→S31_ENABLED=False;草案+验证史=ops/drafts/+git b12d7d9版行;**段累积表n11/9W2L@09-01 18:1x(毛+3.30;多n4净−0.49/空n7净+3.79;判别笔仍仅ONG+0.37)**:①-⑧全链git 497cdf2版行(要点:①ONG L conf0.650 w0.656 ON降门放行=唯一判别+0.37;④FF L conf恰0.70非判别边界;⑦STAR S N档SL穿刺−1.42);⑨-⑪细目git 20ecf1d版行(要点:⑨FF边界笔SL−1.30;⑪BTR OFF+0.70;81分钟ON→N→OFF全滑);**n15/11W4L@09-01 21:1x(毛+1.49;多n5净−0.045/空n10净+1.54)**:⑫UAI S18:23 conf0.700 w0.183 OFF −1.32 SL穿刺30m⑬MARSCOIN S18:42 conf0.750 w0.161 OFF −1.17 SL穿刺16m(18:53-58空头双SL=宽度翻转squeeze窗)⑭牛来S18:59 conf0.800 w0.301 OFF +0.23⑮USELESS L19:34 conf0.750 w0.742 ON非判别(静态0.70亦放行)+0.45;71分钟OFF0.161→ON0.742剧烈翻转=churn观察n3;判别笔仍仅ONG;劣化线双查:多头−0.045≫−3U✓wr73.3−be68.1=+5.2pp✓;宽度重建法:logs q=日期T分钟→评估行EMA up占比/93(不带日期=跨天污染);评期用本累积表;**#16预登记@09-02 00:1x:SKR L 00:07开 conf0.750 w0.591 N档非判别(贴0.60界);平仓并表** |
...
| 09-01 21:1x-21:4xZ | 例行轮(max) | +0.45/−1.81/−1.79/+1.49/+1.49(毛;wr73.3%@n15 be68.1% wr−be+5.2pp) | FGI69/BTC77130−2.2%/mcap−4.2%/trend∩池{ARB,USELESS,UNI,PUMP} | **HOLD原子包0;ROUTE v1.5零差分四连(plan空,bl14期望态,TUT aging第6日,want.brk5币退役壳正确屏蔽);S31段+4笔→n15/11W4L(⑫⑬OFF档空头双SL=18:53-58宽度翻转squeeze窗;⑮USELESS L ON档w0.742非判别+0.45;71分钟OFF0.161→ON0.742=churn n3);劣化线双查绿;#79 +4空sid n=19零新双行;充值线12h wr−be+5.2pp<6pp退触(15:1x已发不重发)** | 钱包162.10U零持仓(−1.94=新4笔毛−1.81+费≈闭合);死法:SL穿刺2(UAI−1.32/MARSCOIN−1.17,均OFF档空头bounce收割)+TP/trailing收2;费覆🔴首破三连绿(均毛+0.0996 vs 3×费0.1032差0.004,n15/34.4U名义口径);trend TUT n0第6日;audit零无主(main1791/trend1790);feed93/1零漂移;sizing健康29-37U全≥21U |
...
| 08-29 17:xx×3 | stub合并@09-01: 17:36自查点#76结案/17:0x v3.2首轮S31草案/17:0xZ owner交互轮;全文git b12d7d9+0940c62版行 |
