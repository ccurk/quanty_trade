...
| 09-05 12:1x-12:4xZ | 例行轮(max) | −1.32(n1)/−0.90(n5)/−2.46(n9 wr44)/−3.12(n18 wr50 be60 −10.3pp)/−2.87(n29 wr52 be57 −5.5pp)(毛) | FGI73 BTC79668−1.8% MCAP−4.0% trending∩池=MARSCOIN,DASH,ZEN,LIT,PENGU,ARB | **HOLD 0原子包;ROUTE零差分2连(plan={};bl16/feed138/trend3∩∅全绿)**;磁铁cohort+n4=AKE0923决胜死→n6/−4.37升级门6/10轨迹恶化;空侧镜像首扫n2净−0.18登记(§6);S31宽度直采0.399=N档(3h内ON→N翻档首记录);#80队列+2=4死6赢候0906vision;#79 n39(踏马案15);MARSCOIN watch解除(48h+1.20转正);死法=SL穿刺11/−12.41(多9/−9.74)vs TP14/+11.46;24h长−2.53/空−0.34 | 钱包≈147.5(avail134.70+B空仓margin12.8);B/USDT空11:41在飞浮+0.02(空侧决胜第3例在飞);费覆main🔴25连(均毛−0.084vs0.097)trend🔴n2轶事(−0.302vs0.063);充值未达(12h/24h双负);audit清洁(1802/1803尾);trend 6h n0保险远离;待落0项 |
...
| 09-05 06:1x-06:3xZ | 例行轮stub: FREQ终裁KEEP+#83同轮落地=CAP晋升trend;24h−0.90 wr−be−2pp;死法SL穿刺10/−10.84;费覆main红23连/trend绿5连;全文git 2af6466版行 |
| 09-05 03:1x-03:2xZ | 例行轮stub: HOLD;ROUTE首现差分CAP晋升顺延06:2x评后;24h−0.04;S33 vision404候查;全文git 2af6466版行 |
| 09-05 00:1x-00:3xZ | 例行轮stub: HOLD;ROUTE零差分27连;FREQ n18/−2.37零新增;S33 vision预查NoSuchKey;24h+2.20 wr−be+4.5pp;全文git 1195a37版行 |
