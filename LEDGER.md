...
| qt-breakout-follow-v2 | 3b646bf4 | 突破追动量(S26内核+S27复活锚) | **{BTR,LIGHT,MAGMA,我踏马来了}**@08-29自main接走(BAS按v1.5 plan下轮裁,churn4/4已用) | running | **tpl973** pct0.05 mcp2 lev2 cd180 minconf0.60 sides双向 trailing(1.0/1.2%)+BE1.0;**_exp=open·FLEET复活@08-29 15:02(owner提频直令;评09-01 15Z或段n≥15;自动保险=滚动6h净≤−5U→stop;劣化回滚=stop+RETIRED占位+4币经bl_sync释放回main)**;MAGMA账户级隔离网继承(n5/−3.53,再亏≥0.47→隔离不论在哪池);live实证@14:49=S26核产分0.800被S21/22正常veto;旧壳FAIL翻案史见2111f5f9行 |
...
- 隔离区(规则≤−4U∧n≥4)【13】: 4/CYS/TST/龙虾/BMT/BTW/H/APR/AIO/BICO/BEAT/XNY/ACE(逐条血统/日期全文git bb3b883/8a797ec/bb2e系)。**池列值=快照,权威=每轮对账器输出**。**对账器v1.5权威副本=quanty-ledger分支ops/route_pools.py@08-29**(v1.5=roster增补breakout复活壳3b646bf4,阈值零改动;谱系v1.4←v1.3←61b1bb4;v1.0默认分支禁跑)。**arg4隔离表必须X/USDT形态**(08-15实证:裸名norm不match feed键→漏移)。出池只认头注规则或隔离,失格=aging_watch advisory;brk/lowvol出池阈值未注册(#42)前无自动出口。最近跑@08-29 15:0x(v1.5)=**plan{BAS→breakout}按头注线defer下轮(churn4/4已用)+bl_sync desired19(+BAS,待其移池采)**;12:1x(v1.4)零差分+**MAGMA 13:25Z自查点已裁=12:09空仓12:17平+0.192盈(7.7m TP)未触网,CB重置,48h滚n5/−3.53→新网=再亏≥0.47即≤−4U(08-30 09:15Z最老−0.69滚出松至−2.85)**;09:1x同零差分+**MAGMA watch裁决续(05:48空仓06:48硬超时平+0.051未触'再亏≥0.22'网→48h滚n4/−3.73全空,n≥4已满足,新机械网=再亏≥0.27即≤−4U隔离,盈笔重置CB,08-30 09:15Z最老行−0.69滚出则松至−3.04,不越权提前动)**;06:2x/03:1x/00:1x同零差分；前次@08-28 21:1x(v2停机后)=**plan{}零rotate差分+bl_sync desired14已采(main空仓窗PATCH bl19→14=fade5释放,audit1781;隔离13+TUT不变)**;#36/#62/#63/#64 defer链随v2退役池解散结案;want.breakout档案={BAS,BTR,LIGHT,MAGMA,我踏马来了}@08-29 09:1x同5币(#47门🔴判未熟维持);defer史=#62@12:2x首现/#63@15:2x依据全文=8af6490链;零差分史连9止@#61;aging=trend[TUT]+fade4 advisory;trending∩池={ENA,CHIP,LIT,TRUMP}全main池非专家条件;want.breakout={ARIA,BTR,ONG}档案(#47门🔴);#47门=费覆连2形式但判未熟@08-26(两轮同靠VELVET单笔,门判据补强BOOK见§7 15:1x行);#51-#58零差分与热清/执行史git 9957041/1ae847c/91b3276/830a46c/188af33/66048a9
