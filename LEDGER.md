...
| main行零归属(空sid;§3 closed回填缺口) | **16/16@08-25 18:2x**(48h窗main池成交行全空sid持续;始08-23 18:24 UAI;TUT重启窗亚例08-24 17:19详git 91b3276;21:2x复核:新行BAS/KOMA仍空,v2三行sid全正常) | 08-25 21:2x | 无P&L实害(income/守护/池互斥归因全旁路);判据:crash loop根因修复后仍空sid→升M通道close-sync候修;每轮扫main池closed行空sid计数 |
...
| 08-25 15:1x-15:4xZ | 例行轮(max) | income:1h−0.18/3h−0.18/6h−1.45/12h−0.98/24h净−0.68(REAL−0.30佣−0.39资费+0.02;n13 wr61.5/be63.4=−1.9pp;毛均−0.023<0组🔴禁提频连2;main毛均+0.087=2.9×🔴边缘) | FGI74/BTC79165−0.7%/市值−3.1%无降压;trending∩main=ZRO,PUMP,LIT,ENA,AERO,STX | **0原子包HOLD;ROUTE#44零差分(连8);v2段n0→1:13:37 HANA空60m超时−0.17=常规fade路径非签名域(conf恰0.600疑epsilon放行→§6新观测;13:36候选bar RSI67.6<75+量0.43被拦=S28域42h仍0样本);21Z预案维持推荐B+TG已更新owner(字面裁决段净−0.19<0=以对照路径轶事否决未测机制);零重启(main1288→1457/trend390→562/v2 1356→1522);audit 1769/1771/1766/1770封顶零无主;config零漂移** | 钱包169.16 avail全额0持仓;24h逐笔n13毛−0.30:main n10+0.87(wr80,VELVET+1.63trail最佳/TAC−1.35慢磨59m最差)/trend n1−0.76(昨17:33重启速开例,今日0笔TUT门内静默)/v2 n1−0.17/壳n1−0.24(pre-fix;#72二连清)/幻影0新增;死法:赢8+3.69 vs fastSL3−2.47 vs 慢磨超时2−1.53;main空sid17/17;#58/#47门关;充值未触(12h/24h双负) |
