...
| 2026-09-20 12:1x-12:3x(v6.0 #15) | 上轮(11:22 板#1962)= [攻-1] owner UI main mcp 1→2 / [攻-2] take_profit_pct 0→0.10; DS 松绑 3 行 | **DS 第 12 轮 0 交易键改动**: audit admin 最新仍 #1954 06:22:16; 11:37/11:52/12:07 三拍无 admin 写; 12:25Z config main mcp1 tp0 sl0 lev10 pct0.25 max_hold90 hunger off max_mult0.8 全同; majors lev10 pct0.25 mcp2 max_hold720 bl BNB/SOL/XRP 同; tpl1057 hash 6c087f2c/tpl1056 766b576a 未变. **owner 未 UI 改**. DS 门关: 6h pair_count 17<30(CTR 10 fills 13:46 滑出→7, ON 7 fills 15:16→0). 我方写: 板 #1963 12:26:06 仅 _ai_task_cc(2 条 6564B; 10:26 条按 8KB 裁掉; 复读 mcp1/tp0/sl0 不变 ✓) | **效果**: 无改动 ⇒ 无前后; 1h 平仓 0 笔 ⇒ 北极星 0. 交易所 income(12:16Z 全账户): 1h 0 · 3h 7 fills(ON)/毛+0.07 费−0.15 净−0.08 · 6h 17 fills(CTR+ON 2 仓 全空)/毛+1.06 费−0.54 资+0.05 净+0.58 · 12h 38 对/毛−1.79 费−1.23 净−3.02 wr63% rr0.36(多 20/−4.26 wr30% · 空 18/+1.19 wr100%) · 24h 221 realized/毛−7.91 费−6.59 资+0.05 净−14.45(pairs 84 incomplete 多 65/−2.44 空 19/−1.75); daily 09-20 −1.39(9)/09-19 −32.2/09-18 −5.22; avail 130.35(BRETT 前, 钱包≈149). **病根+新证据**: main 09:16:40→12:17:04 零开仓 181min, 11:46/12:01/12:16 三批 235 信号(多 122 空 123, conf≥0.8 152) 0 开, 槽被 majors ETH 占(strategy_signal.go:662-679; isAllowedSymbol manager.go:294-320 symbols="" ⇒ 恒 true 且不查 bl ⇒ main bl+ETH 不能解锁); **12:17:04 BRETT 空 50159@0.005185(260U, conf0.95 mult0.8, 滑点 −0.35%) 得开=12:17:00 交易所拉取瞬时失败漏放**: 同批 CATI「按余额百分比计算后的初始保证金<=0」(strategy_execution.go:147, avail 读 0) + FetchPositions err→:662 循环跳过→openCount 0; 12:17:05 下一批即「已持仓2个 达到最大并发1」; 疑与本 cron 12:16:30-49 七次 ctx/positions 拉取撞 429 相关(未证). 止损核对: BRETT 腿 tp0.0050966(−1.70%)/sl0.0052558(+1.36%) order 4000001913083503/504 ✓ 钟 90=13:47Z; majors ETH 腿 tp2561.87/sl2592.81 ✓ 钟 20:16Z; 12:22 BRETT +0.35/ETH +0.19; 无裸奔无撞车. OKX: BRETT 12:17-12:22 lo0.005174(MFE −0.21%); OKX ON-USDT-SWAP≠币安 ON(价 70) 弃; CTR OKX 无/币安 fapi 地域拒/Bybit 拒. 宏观: FGI 71 Greed; BTC 80461(−1.1%) ETH 2579(−2.4%) SOL 108.6(−2.9%) BNB 753(−1.9%); mcap −4.75%/24h btc_dom 58.9; trending AKE/STONK/ZEC/ONE/BP/ZAMA/FIRO/FET/PENGU/NEAR. **本轮建议(板 #1963; 第 3 次重发, mcp 值上调; TG 见 tg.json)**: [攻-1] owner UI main mcp 1→3(最低 2)(Σ0.75=EXPO_MAX 不越; 保证金峰≈0.2+0.16+0.13=49% avail 逐仓递减) | main 有效并发=mcp−majors 持仓数(majors mcp2 可双仓 BTC+ETH) ⇒ 3 才保证≥1; DS 23:39 砍 mcp→1 违反 owner 09-18「缩 mcp 不是刹车杠杆」直令 | 验: 12:31/12:46/13:01 批开仓≥1·下轮 1h 平仓≥1·6h pair_count≥30. [攻-2] 同次 tp 0→0.10(normalizedTPSLPct 0.10=ROI 10%=1.0% 价@lev10; resolveTPSLFromROI :316-322 只换 TP 腿) | 6h 两空 CTR +0.34%/ON +0.02% 钟出, ATR TP 腿 −1.53%/−3.15% 未触; BRETT 腿 −1.70%; 15m 段 13 仓 TP 命中 0; 07:1x 回放 7/12 到过 +1% | 验: 腿距 1.00%·5 仓内 TP≥30%·均净≥+0.15. DS 松绑 MIN_TRADES 30→10(:72)/:327/:329/:298. 🎓 有效并发=mcp−兄弟实例持仓数; 同一 bug 锁死+漏放双向. 下轮验: 12:31-13:16 批开仓数; config mcp/tp; BRETT 出场方式(TP/SL 腿或 13:47 钟)+净额; ETH 腿; 6h pair_count. |
