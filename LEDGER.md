...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·feed89(黑名单18在库⊃期望14;**第2次无端重播种100@22:5x-00:18窗→ROUTE−11再自愈@08-13 00:25**;孤儿3[KAITO/DODOX/BLUAI]留feed待种子同步,AIO/4/DYM/1000CAT不在本次auto集) | **running@08-12 22:20Z(全组复飞令;[buy]latch维持)** | pct0.08 sides=[buy](刹车latched) tpl567;**S23评期已裁@08-13 00:33Z=证据不足·结案**(跨段求和可观测A组n=19<20门[seg1 15+seg2 3+本段1,本段两拍00:18/00:26一致AS0/1];主判据AL vs WL=1/4 vs 0/3纯噪声方向暂反;代码在场纯观测;重开判窗=#37;_exp槽名义空,清写入#45) |
| qt-trend-long | 827ffe8c | 趋势动量多 | TUT/BICO/ACE(种子同步✓;**aging_watch=全3币**@08-12 18:2x对账器[48h窗TUT−2.26/BICO−0.93各n1+ACE 0笔失格],v1.1语义保留在池) | **running(连续)@08-12 13:41Z·22:20全组start未触及本载具(22:17-22:24零预热行实证)=canary段锚无扰** | **tpl575(S24定制)** pct0.05 mcp3 buy trailing on;_exp FIX在飞:**S24累计段n7/−2.13 wr43**=段1 n5/+1.06(31.4h,纠错口径见git)+canary段n2/−3.19(TUT**穿刺**−2.26@108s闪崩−6.34%+BICO**饥饿**−0.93@53m);评期=**累计48h≈08-13 06:19Z或段n≥15先到**,劣化线n≥10∧净≤−5U未触;canary保险滚动6h现0/−5U未触(段亏2笔已出6h窗;权威=audit1717+台账,config._exp未含→#45) |
...
| #43(冻结@02:38Z停机直令) | RECOVER执行包 | 门=组逐笔6h≥0∧24h≥0(**≥0含0,n=0视为0**——latch下零成交是结构性上限,止血即达门;此解释先于数据登记防移门柱;组口径承12:3x轮先例)→步=main sides=[buy]→[buy,sell]空仓窗stop→PATCH→start原子,同PATCH写回刹线:unlatch后6h main空侧净≤−8U(≈钱包3.1%,镜像brake_20260809原触发型短burst)→重latch sides=[buy]续用同键;执行轮先复核无新刹车触线∧宏观降压未触发 | 08-10 18:2x | open,冻结维持;门读数: 12:38Z首读→18:14Z第2读→08-12 00:17Z第3读→06:26Z第4读→**12:34Z连续第5读达标**(第4/5读6h=0✓∧24h=0✓[双窗n=0=预注册视0];第3读6h=0✓∧24h=+0.35✓;无移门柱)→**18:2x第6读不达标**(6h−3.19<0=canary段亏,达标链重断,unlatch候双转正重来)→**22:19复飞令到冻结解除,执行前复核(第7读)FAIL**(24h−3.19<0)→**08-13 00:3x第8读FAIL**(6h=0✓∧24h−3.19✗)→续候(TUT/BICO≈今15:22滚出24h窗后天然复位,预计18:1x轮首验);执行窗=门成立∧全组空仓窗(=main空仓窗,回声行自愈已证) |

| #45(扩@22:4x) | _exp补写×4 | 四载具config._exp补写resume_note(评期重锚累计口径;trend另含canary_insurance):trend原PATCH 13:54:27Z被500拒(running锁,audit1717载荷留痕);fade/brk/main 22:20复飞后同样running锁。**重锚权威=§1直令条(08-12 22:19+补录)+§1.5各行**,约束力不受config缺载影响;**main payload追加@08-13 00:3x**: s23_closure速记(证据不足结案00:33Z)+_exp槽清空 | 08-12 18:2x扩22:4x | open,阻塞=四载具running(不停机>簿记);落地窗=各载具自然stopped窗或eval结案verdict动作同PATCH原子带上 |
