...
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·**feed140@09-04 09:1x复核∩∅(08-29史链git 13edbef版行)** | running | **pct0.08@09-03 21:2x(E9劣化线ROLLBACK;史0.10@03:46owner直令,段n21/−9.42)** sides=[buy,sell] **bl17@09-05 21:1x(#84:+BULLA;隔离13+TUT/USELESS/CAP/BULLA,重启免疫闭合;史git)** **select_limit200@09-07 09:2x(FREQ2 _exp扩面150→200;前150常规@FREQ KEEP@09-05)** feed186@09-07 09:3x∩∅✓(重播种200泄漏cohort111含10隔离+4trend→二次rotate remove14 feed186;q直查4trend币零评估行=硬判据;⚠️start异步播种须二次rotate补清纪律不变) **scp=0.05@08-28 09:33(EXP提频终裁rollback)** **lcp0.15门0.70@08-29(提频直令+S30;史#61c 0.90系git)** tpl990(S32关guard)@09-03 18:2x;**trailing(act1.0/cb1.2%)+BE(1.0)=基线几何(#49KEEP)**;**_exp=open·FREQ2扩面@09-07 09:2x(sl150→200;劣化线cohort滚动净≤−4U或feed断流/评估饥饿→回150,费覆口径cohort均笔毛≥3×来回费≈0.069;eval_after=09-09或cohort n≥15先到;基线快照git qt_feed_main_pre138)**;前三verdict(FREQ KEEP@09-05/E9 ROLLBACK@09-03段n21−9.42/S32 ROLLBACK@09-03段多n3−3.00关guard保码残余§4#80)全文归档ops/exp_archive/main_exp_closed_20260907.json(原config._exp被FREQ2覆写);S31=基线常规监控(KEEP verdict全文移档ops/exp_archive/s31_verdict_20260902.json,原config._exp已被S32覆写);前_exp S30 KEEP@09-01(史git 0940c62);RECOVER 6h空≤−8U继承;#11观察(§4) |
| qt-trend-long | 827ffe8c | 趋势动量多 | **TUT+USELESS+CAP三币**(**BULLA降级出池@09-07 12:4x**[在池段nL6/L净−1.18/wr33%触预注册降级门滚动nL≥6∧L净<0,armed 4/6@09-06→6/6;对账器v1.5全窗L净+1.87被晋升前+2.905大赢污染不提案=头注「在池期间」语义以台账段数据裁决;热rotate毕feed3✓+trend空仓窗stop poll1-PATCH种子3币-start running复读全绿(lcp0.149/pct0.05/mcp3/_exp closed无损)=重启免疫同窗闭合;BULLA孤儿态双层安全(全feed外+main bl17仍拦),回main绑§5#86;**promo_hold:再提名须09-07 15:46Z污染行滚出后规则A重新达标**];BULLA晋升史@09-05 18:2x规则A[48h L净+3.05/nL5/wrL80%,热rotate;bl17@#84+种子4币写回@09-06 00:2x空仓窗(stop poll1-PATCH全diff仅symbols-start running feed4)=重启免疫双层闭合;降级=池内滚nL≥6∧L净<0回main;BULLA空侧n8+0.46near平=损失微弱;trend段BULLA n4/−1.28@09-06 12:2x(+09:19穿刺−0.77;降级门nL≥6∧L净<0=4/6 watch)];CAP晋升@09-05规则A/USELESS晋升@09-02规则B(细目git e6f5b0f);种子PATCH同窗落库=重启免疫;出池按头注滚动nL≥6∧L净<0;COTI出池@08-24;ACE隔离@08-22;史git f43756c) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on **lcp0.149@09-03(#65 epsilon修复;裁决KEEP@09-04段n5/−0.314未触线+conf=0.7000边界直证1例;verdict=config._exp;史0.15)**;**_exp=closed(现值=#65 verdict KEEP@09-04;前史连开解锁PASS-KEEP@09-01 verdict=audit+git)**;mces史git b12d7d9;低波解锁线维持关闭,重开须新regime证据;**常驻保险=滚动6h净≤−5U→stop(继承)**;aging_watch[TUT,USELESS]advisory按对账器头注线(滚动nL≥6∧L净<0)独立看护(USELESS解压@09-04 09:1x:08:34多赢+0.900,滚6 L净+0.42>0出池条远离;仍trending∩池);三值包全史git 8a1d995/f71d825/5df52d2/492779a |
| ~~qt-breakout-follow-v2~~ | 3b646bf4 | 突破追动量·退役@08-29 21:1xZ评判FAIL | — | stopped(gated,勿auto-start)·RETIRED/USDT占位@08-29 22:21Z落地(§5维护注08-29) | **_exp=closed·FLEET复活评判FAIL@08-29 21:1x(评期段n≥15先到:段n15/毛净−1.90/wr13%<expect毛净>0;分界后实名义段n7/−1.34 wr1/7独立同向=多空双亏震荡双面收割;假设证伪:4币main均值回归−8.05离池→brk顺势仍亏→病根=币非原型,隔离网才是对的工具;sizing六键修复有效21-23U与裁决无关;保险线未触−1.69>−5U=按期评判;verdict全文config._exp)**;退役落地@22:21Z全绿(尾步细节§5维护注08-29;末3笔遗仓BTR多/NIL空双盈+NIL竞态多hunger平);**遗仓币记账收养仍活@09-01(#79双行,BTR三案,详§6)**;复活=新壳FLEET;双写/种子写回/翻案全史git 6093c9f版行 |
...
- 隔离区(规则≤−4U∧n≥4)【13】: 4/CYS/TST/龙虾/BMT/BTW/H/APR/AIO/BICO/BEAT/XNY/ACE(逐条血统/日期全文git bb3b883/8a797ec/bb2e系)。**池列值=快照,权威=每轮对账器输出**。**对账器v1.5权威副本=quanty-ledger分支ops/route_pools.py@08-29**(v1.5=roster增补breakout复活壳3b646bf4,阈值零改动;谱系v1.4←v1.3←61b1bb4;v1.0默认分支禁跑)。**arg4隔离表必须X/USDT形态**(08-15实证:裸名norm不match feed键→漏移)。出池只认头注规则或隔离,失格=aging_watch advisory;brk/lowvol出池阈值未注册(#42)前无自动出口。**MAGMA网:解除@09-04 03:1x(复挂判据=磁铁型死法再现;史git bf52ca3);MARSCOIN promo_hold失效@09-06留main(L失格nL1;S n7/+1.72 wr86%最强面,want.fade重现@18:1x=壳退役无动作;48h+3.66隔离线远离;再提名=规则A重达标∧空侧衰减[S净<+1.0或nS<4];双向皆盈再现→v1.6空侧否决阈值ROUTE _exp[校准锚BULLA空/MARSCOIN空];全条款史git 838122c/e6f5b0f);KOMA watch:48h n3/−2.68零新,两大亏行(09-05 13:31/14:18)本日15前滚出窗预期解压;PORTAL解压出watch@09-06 18:1x(48h n0滚出);AKE watch:48h n4/−0.61@09-07 12:4x(+0.044赢/−0.874穿刺,净续改善距门3.39)**;对账史(09-01清扫/08-30/08-29链)=git b12d7d9版行;#51-#58史git 9957041/1ae847c/91b3276/830a46c/188af33/66048a9
- 保证金: Σ_running=main0.08×5+trend0.05×3=**0.55≤0.75✓**(09-03 21:2x E9回滚;前史0.65@E9扩仓03:46-21:20)
- 互斥不变式: feed层@09-06 00:2x复核=main137/trend4(TUT,USELESS,CAP,BULLA)**∩∅**(trend池币∩main=∅∧隔离13∩main=∅热执行后实测;bl17期望态达成@#84)(v2退役壳+老壳双RETIRED占位=交易/feed层收养封闭,**记账归属层仍漏@09-01(#79双行升级,末代持仓币绑定绕RETIRED闸,详§6)**;重播种漏9热清9/9;隔离13币零在feed✓);种子层bl=18(desired达成@#70);**退役壳自bl5=收养向量封闭**;重播种法医学详§3(签名=top回落~202;bl闸零违例);#20=bl币可直漏feed(交易闸级非feed级);#24/#23及#8-#19史git;引擎互斥闸✓live;**fade壳seed5与main auto理论重叠=停机态无违例**(不变式限定running载具;若owner UI复活fade须先重划池,互斥闸+TG示警兜底);隔离币零成交✓(复核@08-21 09:2x,48h窗隔离12币零平仓行)
...
下一个新锚点编号：**S33**(S23-S32已用)。⚠️锚点自S24起分fork谱系: main=S4..S23+S30+S31;trend=+S24;fade-v2=+S25+S28;breakout=+S26(其均值回归核档案化)。apply前grep按该载具fork谱系核验。原注记:(历史上 S10 曾存在于注释引述，编号不复用)。
...
| # | 类型 | 内容 | 依据 | 复现计数 | 状态 |
| 85 | 观察(组死法·regime病理) | **SL穿刺簇=当期唯一主失血道但无可行动修复族@09-06 21:1x**:48h n19/−17.55多空对称(S10/L9)跨日均布(穿刺率两日同≈33%无regime边);深度法医学=16/19深穿刺(mv3.8-5.3%/3-13m gap-through远超SL理论宽2-3%)=−17.41/99%失血,浅仅3/−0.14→**加宽SL证伪**(救不了gap-through反放大真趋势亏);veto签名族#80已证伪;regime-sizing无期望边 | closed48逐笔mv×hold;深例KOMA−5.34%/13m·BULLA−4.33%/9m·CAP−4.18%/10m | n=19(48h) | 观察;出路=#80新特征族(orderflow/资费截面)或regime转活;重开:①穿刺净≤−25U/48h②浅穿刺占比>40%→SL几何才重开③新特征族数据可得 |
| 80 | 代码候选(main多头;S33) | **设计轮证伪@09-05 08:2x——双子签名不apply,S33编号未消耗**:vision精测9案(6死3赢,SKR0902跨日拼接)判别子全域重叠(回调死0.54-7.19%vs赢1.83-7.80%;RSI最近邻死赢对67.6/67.8差0.2分;台账4估3错:PORTAL回调估1.4%实3.32%/MARS0904估'日高−0.8%再触'实距日高8.69%[16:33插针+3.5%拒回后接刀]/CAP赢估距顶10m实3m);签名(a)距顶≤8m∧回调<1.5%仅逮1/6死且距误杀+3.26赢例0.33pp,(b)距6h高≤1%仅逮1/6放宽到2%即误杀;9点7特征任何布尔组合=定义级过拟合,证据标准禁发货 | 全表+定义+残差定性+重启判据=ops/exp_archive/s33_calibration_20260905.json;启动判据史+收敛史git ab10f1d/2680d89/6d82e95/8cbc094版行 | n=4启动判据史达成;精测后死赢不可分 | **退回假设库攒证据**:重启线=新特征族≥15死+≥8赢精测表分离≥80%∧不误杀top2赢例;出路候选=regime/sizing/特征族更换(orderflow/资费截面)非再加入场veto层;**精测队列兑现@09-06 08:5x自查点(vision retry#1到档)**:11案全测入档→表=11死9赢(s33_calibration json cases batch2;RSI口径考订=Cutler SMA14,旧案双exact+KOMA22.8预估三角验证);全域扫描=零误杀最佳双clause 64%(pb≥1.92∧rsi≥53.7,7/11)/放宽≤1非top2误杀73%,均<80%线→**几何+RSI特征族枯竭于近倍表(20案)再证**(rsi死22.8-67.6vs赢23.8-67.8几乎重合),残差定性(原型下跌regime固有方差)加固,阈值落案例值=过拟合风险同前,不发货;距15死差4,死例T+1逐例追加纪律继续;队列史git 8729d22/ad3c8d4 |
...
| 11 | E8 类 | short跨币修补:`breadth_max_for_short` null→0.50设计定稿@08-15(config-only;宽度门L1713 veto;回滚=null;设计全文git d19c710前史) | 依据链git+§1.5#49终数;短侧n26/+0.04已打平 | 2/2达成→病灶消退 | **降级观察@08-16 18:2x**:08-09依据(24h空−15.20 burst)在#49基线几何下未再现→撤出候选队列;**重升门=main空侧24h≤−8U复现**(届时以#49段为基线重算keep线再上_exp);watch@09-03 21:1x:**空侧扩散恶化三连**——24h空n20/−5.79距门2.21(链−3.41→−4.60→−5.79→−6.01→−2.56@06:2x断后09-04 09:1x回−4.18→12:2x大幅解压−1.99[n13,BTC反弹日穿刺簇滚出窗]→15:2x −2.26→**21:2x 24h空n12/+1.71转正首读**(穿刺簇滚出+BULLA双空赢3.22);BTC反弹日空侧收割市况主导史;史细目git f477a04版行);过门即重启#11(breadth_max_for_short null→0.50,以#49段为基线重算keep线上_exp);史读−2.41@08-21 |
...
| 58 | E9类(main扩仓) | **兑现@09-03=E9扩仓rider(pct0.08→0.10)落地**: owner live直令[增加开仓数量]覆盖原自设门(费覆双绿/#79双行归零/main行归属恢复,全未达但直令优先);预注册=S32 _exp内rider_e9(劣化线24h组净≤−8U或费覆连🔴48h∧rider段净<0→回0.08);下一档0.12=Σ顶0.75须新直令或rider段证据 | 直令+rider全文config._exp;门史与三翻转史git f3c6469 | n=12段(史) | **结案;E9裁决=ROLLBACK@09-03 21:2x**(24h−9.03≤−8U∧钟到点段n21/−9.42双条件;pct回0.08;verdict=config._exp.e9_verdict);史全文git 64ede74版行 |
| 52 | 引擎候修(M通道) | **stop校验双洞+复活路径**:①validateStrategyCanStop把sid=""仓当不存在+auto池跳过交易所侧校验→带仓stop可过闸(修法=exchange侧校验在auto池用全量active仓判);②stop后≤40s自动回running复现机制未定(requestRestart候选);顺手项=stop回执改真沉降或带async标注 | 18:27全录grab50.log+源码strategy_lifecycle.go L233-270/strategy_runtime.go L135;XNY sid=""行实证;+CAP09-03 15:14案2(active行sid=""空归属,main开仓链日志实锤W-bar多conf0.68,交易所TP/SL已挂+main在管=实害0);+MARSCOIN09-04 00:13案3(sid=""行,main链conf0.80多+BE→trail 3m收割+0.03=守护覆盖闭环)+PORTAL09-04 00:1x案4(sid=""在飞)+CAP09-04 02:52案5(active行sid="",main链conf0.80多W-bar mult1.4 qty688@0.04831,02:52:35 TP/SL双挂=守护覆盖)+ZEST09-04 12:13案6(active行sid="",main链conf0.72空W-bar mult1.4 qty242,12:13:35 TP/SL双挂=守护覆盖,实害0) | n=6(main) | 候选;dev分支claude/dev-*走M通道,部署权owner;先复现②再动手;运维注=sid=""行不卡stop(洞①反向便利),重启后收养闸+交易所TP/SL兜底;**18:2x升级注=sid=""已系统化(48h窗42/58行全空归属)停逐案计数**,守护覆盖6/6验证实害0,归因按池不受影响,候部署不变 |
...
| # | 类型 | 内容（含完整意图） | 登记轮 | 状态 |
|---|---|---|---|---|
| 86 | main窗 | bl17→16(−BULLA/USDT)+BULLA回main核验(重播种含则验交易闸释放,否则rotate add;二次rotate清漂移纪律照旧)——执行窗=**FREQ2评期结案同一空仓窗**(评期内避免main重启重播种污染cohort/饥饿信号;平台自发重启提前发生则顺窗提前执行,期间bl闸+对账器兜底) | 09-07 12:4x | open |
> 维护注 09-05 21:2xZ：#84 落地结案删行——21:13逢全账户空仓窗:main stop[poll1即stopped]-PATCH bl16→17(+BULLA/USDT)-复读bl17✓关键字段无损-start✓running;重播种150→rotate热清12(首发rotate被start异步播种后至覆盖,二次rotate生效,验证=被移除币零评估行);feed138三交集∅;全文git本轮版行。
> 维护注 09-05 06:2xZ：#83 落地结案删行——FREQ评判KEEP后同轮执行:规则A复核达标(CAP 48h L净+2.43/nL3/wrL67%)+CAP空仓;main rotate remove hot feed139✓→main空仓窗stop[poll1]-PATCH(_exp终裁+bl16)-start全绿→trend空仓窗stop[poll1]-PATCH(种子3币)-start全绿feed3含CAP✓;main重播种150漂移热清12残留0(∩bl=∅);全文git本轮版行。
> 维护注 09-04 07:3xZ：#82 落地结案删行——07:28自查点逢trend空仓窗(USELESS已平,仅VELVET=main仓挂壳):stop poll1即沉降-PATCH #65 verdict KEEP-start-复读全绿(lcp0.149/_exp closed/种子2币在位);verdict全文config._exp+audit。
> 维护注 09-03 01:2xZ：#81 落地结案删行（bl14→15+USELESS=重启免疫闭合;全文git 4be520c版行）。
> 维护注 08-29 22:2xZ：#78 落地结案删行（brk退役+bl20→14;全文git 4be520c版行）。
> 维护注(指针@09-02 12:4x): #74落地=git 2aa13b1;#70落地=git 17251a9系;#68落地=git 0940c62系(全文各自当轮版行)。
...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=11/24h@09-07 06:2x(静默06:0x解除窗新4笔+在飞2;ATR中位0.16;判据远离;史git 1965aac) | 09-07 00:1x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| #79·closed行sid按symbol旧绑定继承(#77族新亚型) | 两形态:①**双行**(main行+末代壳行同笔PnL双写,壳行tp/sl null裸奔,出场治理权=两行落库序竞态,08-30 03:34壳饥饿档45m真接管收割−0.61实锤;判别特征=末代持仓币BTR/NIL/COLLECT类,泛池币牛来/USELESS零双行)②**空sid**=binance_only视图伪影(全量视图sid=main齐);binance_only对双行币dedup保壳行=池归因陷阱 | 09-01 12:5x | 归因纪律:sid冲突以载具日志开仓链为准,逐笔归因用全量视图+日志链;机制修复并入#77 ownership单一化(候owner部署),部署后复验消失;案8-21细目与计数史(n38→45;案19=COLLECT首例非良性亏)=git链ed40296/e97b10c/a317555/ed1ba85/1417e31/558c235/7565b0e/8729d22/933abbd版行；**n=51@09-07 12:4x(+5 COLLECT空sid=fadeV2,出场全正常hold35-38m赢4亏1=良性续档;12:08新活跃COLLECT空同绑)**;n46史@09-06 18:1x(+COLLECT1521空SL−0.811),均sid=末代持仓币判别续命中(48h壳行8=COLLECT/VELVET/踏马);S14CB同窗隔离COLLECT240m=引擎级自保护叠加;史git e6f5b0f |
| S31·regime动态方向偏置(**结案KEEP@09-02 06:3x**) | v1谱=宽度三档(EMA-up<0.35 OFF多+0.10/0.35-0.60 N/>0.60 ON多−0.05空+0.05)阈值内联+False-guard,上线09-01 10:02=tpl988;评判KEEP@09-02(段n22/15W7L毛−0.11,ON档多n3均+0.73 vs N/OFF n5净−1.99,劣化线双绿);verdict全文ops/exp_archive/s31_verdict_20260902.json+git 1417e31/eea7cb7/558c235系 | 08-29 17:0x | 常规监控;复核判据:多头累计≤−5U或ON档均净转负→议关guard;verdict后多头4笔+1.96@09-02判据远离；+09-05 09:2x宽度首直采=0.65(138币eval行EMA-up90/138)=ON档实证@−3.2%大盘日；门反证=当日多头死亡簇入场分0.75-0.90均非OFF窗产物且ON降门带[0.65,0.70)零死亡入账=S31非本轮失血向量,残差定性(原型固有方差)成立；宽度直采纪律入轮程(eval行EMA趋势聚合)；regime翻转速度=单日内;直采史全链git ff561cc/933abbd/044689a/e6f5b0f(OFF史最深0.196@09-06 15:1x);直采链0.652→0.493→0.196→0.623→**0.601(83/138)@09-06 21:1x**→0.826@09-07 00:1x→**0.413(57/138)@09-07 03:1x=ON→N,七摆→0.449(62/138)@06:2x→0.790(109/138)@09:3x ON→**0.656(122/186)@09-07 12:4x ON驻留(分母切186=FREQ2扩面后全feed,同步直证零评估饥饿)**,日内振荡新常态,三态全命中,判据(多头累计≤−5U或ON档均净转负)远离(摆史git 18ebd9a/e770261) |
| funding磁铁·他币再现watch(重开@08-26;BICO条引用) | era史n2/−2.83+BICO/ACE史=git 9b9c39d/86e771d/8a797ec/bb3b883;**S30深档减半实证@09-02(+0.85良性收束)** | 08-27 00:2x | **S30已上线@08-29(owner提频直令跳磁铁门,设计按定稿字面实现)**;watch=疫苗效果验证(磁铁死法计数);era史n2/−2.83留档;疫苗期细目+源码定案+排除案git 8729d22/ad3c8d4版行;**下修议案呈owner@09-05(温和+0.20→+0.10,深+0.10→+0.05)+升级门预注册:多头决胜cohort n≥10∧净≤−3U→S33下修_exp自动执行(劣化线=下修后多头段n≥15净劣于前同窗→回滚),owner否决即关闭**;**多头cohort史git ad3c8d4/e6f5b0f**;**空侧镜像(≥等值同口径,资金费率>0.0003:+0.20;独立观测不入多头cohort;判据=空侧决胜累计n≥6∧净≤−3U→议短侧入S33包)**:方向不对称结构化=空侧+0.20在赚不动(史n11/+0.84细目git ff561cc链);空侧批史git 933abbd/e6f5b0f;逐轮决胜扫描纪律=新入场评分行含资费bonus且减bonus后<门即计入;(15:1x AKE0605多决胜−0.019→多cohort n7/−4.39=7/10;18:1x BROCCOLIF3B空+0.120→镜像n19;细目git e6f5b0f/18ebd9a);**+09-06 21:1x决胜空双闭NAORIS+0.144/DOOD−0.737→镜像n21/+0.68(细目git 8917d4e);+09-07 03:1x DOOD空+0.056决胜→镜像n22/+0.74;案23 COLLECT空平+0.097@09-07 06:47→**镜像n23/+0.84**;空侧门未触;多头cohort n7/−4.39零新=7/10** |
...
| 09-07 12:3x-12:5xZ | 例行轮(max) | 6h+0.67/12h+2.02/24h-0.90(n12wr67/n18wr78be64/n26wr65be69) | FGI71贪 BTC79466-0.65% 市值-3.14% trending∩池=USELESS | **ROUTE:BULLA降级出trend——在池段nL6/L净-1.18触预注册门(armed4/6→6/6);对账器全窗+1.87被晋升前+2.905污染不提案=「在池期间」语义裁决;热rotate feed3✓+trend窗stop poll1-PATCH种子3币-start复读全绿同窗闭环;promo_hold至15:46Z污染行滚出;回main绑§5#86(FREQ2评期结案窗);0原子包(FREQ2在飞3h仅n2禁扰)** | FREQ2:cohort n2/-0.31»-4U线,eval行186/186=零评估饥饿直证,哈基米首赢+0.348;修正归因(晋升时点感知):main48h n46/-1.15(原-4.15误挂BULLA晋升前+2.9),trend48h n12/+1.10;死法24h穿刺n6/-4.18主血道,TP/早收n15/+4.29;24h空n17/-0.82 #11门远;审计1804后零无主;钱包≈115(avail81.4+3仓保证金34);Σ0.55✓;刹车全绿;ROUTE零差分终结于11(降级为台账段裁决非对账器提案);待落1(#86);pre138基线未入库缺口→补post186快照+cohort操作定义(开仓≥09:25Z∧48h窗此前零行∧非trend/隔离)入ops/exp_archive/freq2_feed_post186_20260907.json |
| 09-07 09:1x stub: FREQ2扩面sl150→200落地(_exp劣化线cohort滚净≤-4U;重播种泄漏14二次rotate清毕feed186;12h转正wr91费覆绿avg+0.204;穿刺主血道48h n19/-17.55 #85不可行动维持;三verdict归档ops/exp_archive;全文git 68e804b版行 |
| 09-07 06:2x stub: HOLD12连;ROUTE零差分9连;窗新4笔全胜+1.16静默解除;12h转正wr86 be76费覆绿;COLLECT空=S30决胜23例;S31宽0.449 N;48h空-5.00;AKE watch n4/-2.19;钱包114.1;全文git ca34406版行 |
| 09-07 03:1x stub: HOLD11连;ROUTE零差分8连;DOOD空+0.06=镜像n22/+0.74;宽0.413七摆;48h空−5.98;死盘98%;全文git 1965aac版行 |
| 09-07 00:1x stub: HOLD10连;ROUTE零差分7连;3.7h零新平仓管道直证活;宽0.826深ON六摆;48h空−7.10;死盘99%;费覆全🔴;全文git e770261版行 |
> 瘦身注(指针集@09-07 00:1x归并): 09-05..09-06各轮stub指针集(933abbd/610475d/14eca0b/ff561cc/2af6466/6a3383a/ad3c8d4/e6f5b0f/838122c/044689a内含;09-06 12:1x[MARSCOIN promo_hold/充值首触]+09:1x[S33精测不发货]并入)=git 8917d4e版§7原文;09-06 18:1x/21:1x stub并入(18ebd9a/8917d4e)。
|---|---|---|---|---|---|
