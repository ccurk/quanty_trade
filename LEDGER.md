...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·**feed91@08-23 12:2x(#27热清9/9;bl18种子完好)**(#25/#26清13/13;#24清11;前史git 18a2dbf+492779a) | running | pct0.08 sides=[buy,sell] **long_conf_premium=0.35(#61c终裁rollback@08-19 15:3x,门0.90=多头事实关闸,#61族基线)** tpl567;**trailing(act1.0/cb1.2%)+BE(1.0)=基线几何(#49KEEP)**;**_exp=closed rollback(#61c;史§4#61/#63+git 0940c62)**;RECOVER刹线6h空≤−8U继承;#11降级观察(§4) |
| qt-trend-long | 827ffe8c | 趋势动量多 | **COTI/TUT**(种子2=feed2✓#26重启后重建正确;ACE隔离@08-22 12:22;aging=COTI+TUT;破荒史git f43756c) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;**_exp=open·#69三值包重申请@08-23 09:18Z**(adt0.5+lcp0.149+mces off;终裁二元=新段净>0→keep否则回滚[adt1.0/lcp0.15/mces3];eval=n≥16或08-25 09:18Z;劣化线n≥8∧≤−4U;**进度@12:2x段n=0**[3h零信号,feed2 K线在流=路径活,长多平市静默属预期];否决窗空置+程序史git 492779a);原三值段终裁rollback(n18净−0.40)+ex-ACE归因(n14净+4.11 wr86%)全文git 5df52d2+config史;**常驻保险=滚动6h净≤−5U→stop(继承)**;三值包全史git 8a1d995/f71d825;S24 keep史git f43756c |
| qt-fade-short-v2 | 7583727a | 冲高回落空(tpl576/S25继承) | HANA/COLLECT/**MELANIA**(feed3=种子3@08-22 18:2x #68写回落库✓;MELANIA晋升自main@15:2x[48h S+2.29 nS3 wr100%];⚠️#57-ROUTE病理活测第3例[VELVET/BULLA先例],看护=隔离线/出池线/保险线既有三层) | running | 建壳@08-21 16:5x(tpl576/S25继承;git f43756c);**FLEET评期结案=管道PASS**(verdict=config._exp.prior_fleet_verdict);**低波适配三值包@04:1x(owner直令)**: minatr0.35+adt0.5+scp0.049[#65修]=梯度防护(≥0.5全分/0.35-0.5需raw0.75/<0.35拦);**_exp=open·中间裁决@21:2x=延评一次(落空档;verdict_n8全文config._exp+git 8a797ec;终裁n≥16或08-24 12Z二元[段净>0→keep否则回滚三值]不再延;劣化线n≥8∧≤−4U+带级护栏−3U+6h保险−6U站岗)**;**进度@08-23 12:2x: 段n13/16毛−0.16净≈−0.46 wr31%(4W/9L);新笔COLLECT 11:33空45m hunger_sl平±0.00(带级当轮捕获✓:ATR0.36=地板带第4笔,raw0.75过梯度门,0.75×0.8=0.600 vs 门0.599压线过;带累计4笔−0.33 vs −3U护栏远);超时簇5/13为最大死法;MELANIA fade era n5/−0.86全账户nS8/+1.44出池线未触;标本④⑤→§4#66不变**;程序=stop[poll1]-PATCH-start✓(嵌套体二次实锤史§3+git 8a797ec);保险=6h≤−6U停(继承) |
...
| 08-23 12:1x-12:4xZ | 例行轮(max) | 1h0(0)/3h0(0)/6h净−0.85(0平,income)/12h净+0.45(3,wr100)/24h毛+1.57净+1.48(13,wr54/be48=+6pp) | FGI66 Greed/BTC77.0k−0.2%/市值−3.2%无降压;trending∩main=ENA/PUMP/XPL | **HOLD 0原子包**(两_exp未到门:trend段n0[门n16或08-25 09:18Z]·v2段n13/16净≈−0.46偏回滚[终裁08-24 12Z];ROUTE=#27重播种12:02:59热清main9币[隔离7+专家2]feed100→91残留0;重启实锤#25/26/27=04:32/07:13/12:02间隔2.7-4.8h疑crash loop→TG报owner;刹车全绿[6h−0.85/24h+1.48]载具保险绿;费覆24h毛均+0.060<0.090🔴禁提频;充值信号12h/24h双正但12h n3+6h负=修复见效未证不发) | 死法24h:WIN7/+4.02,超时4/−0.99全v2,SL2/−2.24;载具:main5/+1.54 wr80,trend1/+0.32(TUT),v2 7/−1.08 wr29🔴;COLLECT带级当轮捕获✓(0.600 vs 门0.599压线过,45m hunger平±0=带4笔−0.33);干涸6h零平仓=平市+门紧+重启搅动;audit零无主;幻影0;sid空5行(BTR2/TRUMP2/MELANIA1)=收养行池归因无碍 |
