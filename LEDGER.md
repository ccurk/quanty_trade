...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=9/24h@21:1x(ARIA档笔SL−0.83+ONG多0.90门−1.39;feed83计数429-431连续=17:26后零新重启) | 08-26 21:1x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| funding磁铁·他币再现watch(重开@08-26;BICO条引用) | **n=1 era: ONG多19:04Z conf0.9000(RSI<35+0.20/资费−0.00872触+0.20/多空比+0.15/EMA up+0.30)→4m快SL毛−1.386=接刀**;前例ONG多−1.92@08-21(#61族);史BICO n8/−4.05隔离、ACE n4/−4.40隔离〔git 8a797ec/bb3b883〕 | 08-26 21:2x | 机制=评分层对深负资费发多头奖励,0.90门唯一能凑齐的组合恰=磁铁画像;判据: **funding<−0.003多单亏损再现n≥3或era累净≤−4U→S30候选**(资费bonus设下限/深负反转减分);ONG币级距隔离线远(48h n1) |
| short双窗负 | 0维持(逐笔配对为主口径)〔git 6a93e93〕 | 08-06 | 新增空头亏损事件逼近4.6c门→评估 |

## 7. 运行日志（每轮一行，新行追加在表首）

| 时间(UTC) | 档位 | 五窗净额 1h/3h/6h/12h/24h | 世界 | 决策 | 备注 |
| 08-26 21:1x-21:3xZ | 例行轮(max) | income:1h+0.25/3h−2.01/6h−1.90/12h+0.06/24h净−1.67(REAL−1.37佣−0.30资费0;rows n10 wr50.0/be56.3=**−6.3pp**;毛均−0.137<0→组🔴连3🟢断) | FGI65平/BTC78798+0.5%/mcap−2.41%无降压/trending∩池=BTR(fade) | **0原子包HOLD;ROUTE#54零差分(连2);登记×2=①funding磁铁watch重开(ONG多0.90门19:04 4m−1.386,资费−0.872%推门,§6判据挂S30候选门) ②-4411 TradFi-Perps平台事实(§3;SNXX已出feed零现患);三在飞全轨道内推进** | EXP提频档n1=ARIA空SL毛−0.83(距−3U线2.17U,评08-27 18Z或n≥15;18:10-21:12档内仅此1触发+18:11 S19拒1=档频~0.3/h实测远低普查预估);v2段n4=+BTR常规快赢+0.269(签名域~72h n0,auto-C倒计时~48h);trend~52h零笔TUT aging advisory;死法24h:赢5+4.76/SL4−5.17(ONG 4m穿刺最大单笔)/饥饿SL1−0.96;旧壳FIX pass再证(窗内sid=21519f1b新行0);钱包169.11(0持仓,15:1x 170.9→Δ−1.8=3h亏损一致);充值线未触(24h负);保证金0.63✓;待落0 |
