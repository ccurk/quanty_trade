...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=16/24h@09-06 18:1x(15:35后零新开仓≈2.7h;池ATR%中位0.15/93%<0.5=死盘更深;判据未触=引擎正确拒单) | 09-06 09:1x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| 09-06 18:1x-18:2xZ | 例行轮(max) | 0(n0)/−0.69(n2)/−2.33(n6 wr33 be84)/−2.57(n9 wr44 be78)/−2.82(n25 wr56 be71)(毛) | FGI73 BTC79825−0.2% 市值−3.56% trending∩池=PUMP,PENGU,ARB,UNI,ASTER | **HOLD 0原子包8连;ROUTE零差分5连(plan空;want.fade=MARSCOIN重现=壳退役无动作);无达门候选(S33决胜7/10;#80死例11/15;#11远[main24h空−0.63]);死盘ATR中位0.15/93%<0.5+6h wr33%=非提频窗** | 死法24h:SL穿刺5/−3.98 中段2/−0.96 饥饿2/−0.75 超时5/±0.00 WIN11/+2.86;归因main16/−0.47(wr69;多+0.16空−0.63;S14CB隔离COLLECT240m自保护)·trend4/−1.28(BULLA watch4/6零新)·壳5/−1.07;#79 n46(+COLLECT1521→1532壳行SL−0.81 sid=fadeV2,末代币判别续命中);S30镜像n19/+1.27(+BROCCOLIF3B超时+0.12);cohort n7/−4.39零新(升级门7/10);S31宽0.623(86/138)ON回翻=单日四摆;KOMA3/−2.68·AKE5/−2.14零新,PORTAL滚出48h解压除watch;audit零无主(两载具patch_config全对应台账);feed138/4∩∅隔离零泄漏;钱包115.07全avail空仓;充值信号未续触(12h−2.57);费覆main24h🔴回落(avg−0.029;首🟢仅存1轮=窗构成效应,09-05午强赢滚出)/6h🔴(avg−0.31)/trend🔴(avg−0.32);保证金0.55;待落0;瘦身(12:1x行stub化+§1.5/§6史压缩) |
| 09-06 15:1x stub: HOLD7连;ROUTE零差分;MARSCOIN promo_hold失效留main;费覆main24h首🟢断33连红(仅存1轮);S30 cohort n7/−4.39;宽0.196 OFF史最深;AKE watch新挂5/−2.14;全文git e6f5b0f版行 |
| 09-06 12:1x stub: HOLD6连;ROUTE首提名MARSCOIN晋升→promo_hold(#57族);充值信号首触发(12h+1.07/24h+0.85双正);S31宽0.493 N;死盘ATR0.18;全文git 838122c版行 |
| 09-06 09:1x+08:4x双stub: 24h转正+0.79 HOLD5连宽0.652 ON=git 838122c版行;S33精测11案扫描64/73%<80%不发货=git 044689a版行 |
