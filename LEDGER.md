...
| 09-09 15:1x-15:4xZ | 例行轮(max) | 1h−0.53(n1)/3h−1.39(n2)/6h−1.48(n4wr25)/12h−3.45(n15wr33be58=−25pp)/24h+1.34(n25wr56be51=+5pp;费覆毛额:12h−0.230🔴/24h+0.054vs门0.091🔴/48h+0.006🔴四轮连红) | FGI66贪 BTC−0.26% 市值−2.57% trending∩池VVV/PONS/NEAR/PUMP/LIT/PENGU+USELESS(trend) | **HOLD 0原子包(S33在飞n8/15禁叠加;费覆连红禁提频;ROUTE plan={}13连零差分;刹车/载具保险/宏观全无触发)+BOOK:§6新增硬超时磨损类计数器+预注册门(n≥20∧≤−3U→候选包,窗=S33评期后)** | S33段n8/−0.388均−0.049 vs 基线−0.512(HEMI行值漂回=懒生成三证);镜像n38维持(窗内空bonus行0);S31宽15:21直采0.122(23/188)深OFF十六摆(12:27 0.529N→3h腰斩,多头门0.80=弱盘抬门在岗);24h死法:TP赢14/+7.39\|SL族4/−3.08\|硬超时5/−1.50全负\|近超时磨损2/−1.46;12h失血=main空头慢阴跌磨损非方向错;audit零无主(顶1808=S33自写);feed189/3∩∅bl16✓;Σ0.55✓;钱包153.7空仓(−1.5);待落0;trend24h n2/+0.29wr100%;#79无新增n63 |
