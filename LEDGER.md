...
| main 通才(平台名 Meme_合约信号计算引擎_1) | 8eb182b6 | 通才(S4..S23+S30+S31+S33;S32关guard;tpl998 hash 3e311e8b) | **owner 11:06Z 重置: symbols ""+max_price 1e12 ⇒ filter 路径 300 池(select_limit 300)**; feed 265(CC 11:4x rotate remove 35: bl∩feed=∅, ∩majors=∅) | running(pid 58521 START 11:08:43Z) | **09-19 12:4xZ 复核同值; 11:4x 现值: 注入 min_conf0.35/cd180/atr 2.0/2.5/warmup50; pct0.125(DS 07:08, owner 值 0.25, lock-1789810634 至 09-20 09:37Z) lev5(DS 10:09 裸改, owner 值 10, watch_ds) mcp3(DS 09:37 未声明, owner 令 10; 11:16 起绑定) sides 双向 hunger OFF(owner 11:06) tp,sl pct0(交易所腿=信号 ATR 括号, 钳 0.3/lev) trailing/BE 关 max_hold45 sl_ratio0.03/tp_ratio0.06 bl45 conf_sizing 0.6-1.0 auto_optimize enabled=false(apply=true/dry_run=false 上膛)**; 7 币段(07:21→11:08) 终读 n12 +17.34 wr50% |
...
| CC-31 | M候选(括号重锚) | strategy_position.go:476 前按 (成交价−信号 entry) 平移 tp/sl(或 ×成交/信号比), 阈值 |滑点|>0.25×ATR 才平移; 依据 H-0919f; 部署=owner; 回滚=不平移(默认关) | 09-19 12:4x | open(候 n≥20 或 owner 令) |
...
| 计数项 | 读数 | 更新轮 | 备注 |
| **09-19 12:4x 读数(DB 去重; income 括号)** | 1h n6 −0.07 / 3h n13 +7.03(income +3.19) / 6h n34 −7.83 wr26%(income −13.1: 毛 −7.0 费 −6.1) 多 +1.56 空 −9.39 / 12h n98 −29.3 wr35% 多 +4.63 空 −33.93(wr17%) / 24h n240 −40.85 wr42%(income −97.6; 毛 −40.7 费 −56.8) 多 −22.5 空 −18.4; 24h 死法: <2m 亏 n43 −86.5, 2-5m 亏 n42 −75.9, 5-15m 亏 n34 −53.7, 赢<5m n51 +85.2, 赢≥5m n48 +101.4, 超时 n16 +1.1; 300 池段(main ≥11:08) n5 −0.95 wr40% hold<5m 亏 1/3(刀关后 33%, n 小); 成交 conf 11:08 后 n10 0.36-0.55(门槛 0.35✓); 括号滑点(信号价→成交) n7 中位 +0.15%, ZAMA +1.71%/SWARMS +1.39%; 48h 规则命中新增 0(M n3 −9.05/OP n2 −5.36/VVV n2 −5.18 候 n≥4) | 09-19 12:4x | 11:4x 读数全文=git 8c71bb0 版§6; 下轮: 段 n≥15 复读 hold<5m 亏占比 + 滑点>0.5% 占比 |
...
## 7. 运行日志（每轮一行，新行追加在表首）
| 2026-09-19 12:1x-12:4x | 定时轮: 管道活(REST 200; 429 簇 11:08-11:09 282 次 FetchCandles 预热 + 零星 12:0x-12:1x 查腿/查仓); 钱包≈163(avail 129.6+2 仓保证金 33.2); income 1h −0.52/3h +3.19/6h −13.1(毛 −7.0 费 −6.1 ≈−8% 触报警线, owner 13:4x 令不缩表)/12h −45.3/24h −97.6(入金 +142 另列)🆘; DB 24h n240 −40.9 wr42%(多 −22.5/空 −18.4; 12h 空 n46 −33.9 wr17% vs 多 +4.6); 300 池段(main, 11:08 起) n5 毛 −0.95 wr40%: ZAMA 45m 超时 −2.13/WCT 45m −0.28/FHE SL −1.33/HEI TP +1.49/SWARMS +1.30, hold<5m 亏 1/3; 止损完整性: main 5/5 腿✓(ZAMA 11:11 429 回滚失败裸奔 28s→补设)/majors XRP 腿✓ 11:52 TP +0.88, max_hold 45/720; 隔离: feed265∩bl45=∅, ∩majors5=∅, 无同 symbol 跨实例仓; DS: 11:33 后 0 PATCH, lock-1789810634(pct 冻至 09-20 09:37), _ai_task_ds null; 429 实害: 主单丢 4(NAORIS/B/AGLD/majors SOL '保证金≤0')+守护跳过 9; mcp3 跳过 10(11:16-11:44); lev5 watch post n7 −2.02(n<10); **改动: 0 交易键; _exp_cc +reads_1240/h0919f, 留言板 12:24Z(7 条 8.0KB) 复读✓**; 新假设 H-0919f 括号锚信号价(strategy_position.go:476; ZAMA 滑点 +1.71%)→CC-31; 宏观 FGI71 BTC +4.3% 市值 +1.2% trending∩feed=PENGU/ZEC/ZAMA/UNI/ENA/TAO/ARB/PONS; 下轮=13:15 定时, DS 13:09 节拍对账(6h −13.1≤−4U 预警再砍 pct) |
| 2026-09-19 11:1x-11:4x / 10:1x-10:3x / 09:1x-09:3x / 08:1x-08:5x / 08:2x(检查轮) / 07:1x-07:3x / 06:1x-06:4x / 05:3x-05:5x / 05:1x-05:5x / 03:3x-03:5x / 00:1x-00:4x | 全文=git 8c71bb0(11:1x-11:4x 行)/29d8478(10:1x-10:3x 行)/c75a1c3(09:1x-09:3x 行)/2d9c837(08:1x-08:5x/08:2x/07:1x-07:3x 三行)/6b44db7 版§7(逐行 git d19a237/4c56565/4c56565/f48d043/c06ab72) |
