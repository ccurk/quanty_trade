...
| main断流观测(三闸交集关门) | 本轮main笔数=20/24h@09-03 00:2x(末close23:39/新open00:06 T在飞;判据未触) | 08-30 00:1x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| #79·closed行sid按symbol旧绑定继承(#77族新亚型) | 两形态:①**双行**(main行+末代壳行同笔PnL双写,壳行tp/sl null裸奔,出场治理权=两行落库序竞态,08-30 03:34壳饥饿档45m真接管收割−0.61实锤;判别特征=末代持仓币BTR/NIL/COLLECT类,泛池币牛来/USELESS零双行)②**空sid**=binance_only视图伪影(全量视图sid=main齐);binance_only对双行币dedup保壳行=池归因陷阱 | 09-01 12:5x | 归因纪律:sid冲突以载具日志开仓链为准,逐笔归因用全量视图+日志链;机制修复并入#77 ownership单一化(候owner部署),部署后复验消失;**n=32@09-03 00:2x**(+MAGMA22:22双行第8案:main行+壳行同PnL+0.0949壳行tp/sl null,binance_only又dedup保壳行;同窗UAI22:01/BULLA23:39全量视图单行sid=main正常);史读n=31@09-02 15:2x(+BTR12:36第6案[回填时序证据]+BTR13:35第7案;T12:42/ZKC/牛来单行=泛池币无双行)/n=29@12:3x(+BTR11:01第5案+UAI空sid)/n=27@09:1x/n=26@06:3x(细目git ed1ba85版行);史:MAGMA第2币种@03:1x/BTR三案升级链@09-01 18:1x(#77级实锤)细目git 1417e31/558c235版行 |
| S31·regime动态方向偏置(**结案KEEP@09-02 06:3x**) | v1谱:宽度regime三档(EMA-up占比<0.35 OFF/0.35-0.60 N/>0.60 ON)→premium加减(OFF:多+0.10;ON:多−0.05空+0.05),阈值内联,S31_ENABLED False-guard;上线@09-01 10:02=tpl988 | 08-29 17:0x | **评判KEEP@09-02 06:3x(n≥20门先到)**:段终表n22/15W7L毛−0.11(多n9净−1.09/空n13净+0.98);ON档多头n3均+0.73(①ONG⑮USELESS⑲SKR) vs N/OFF n5净−1.99,末笔⑳SKR03:43−1.30 conf0.95门法不可辨但两种归档结论同向=expect达;劣化线双绿(−1.09>−3U;wr−be−0.3pp,段内峰+5.2pp@n15→−0.3滑落如实记录=末7笔4L);判别笔全段仅①ONG(+0.37 conf0.650 w0.656 ON降门放行);verdict全文config._exp;逐笔①-⑲链git 1417e31/eea7cb7/558c235系版行;宽度重建法=logs q=日期T分钟→评估行EMA up占比(固化@09-01 12:4x);后续=常规监控,复核判据:多头累计≤−5U或ON档均净转负→议关guard;**verdict后多头4笔+1.96@09-02 18:1x(+PROM+0.065 BE保本)判据远离** |
...
| 09-03 03:1x-03:5xZ | 例行轮(max) | +0.02(n1)/−1.30(n2)/−0.61(n6 wr67)/−1.26(n8 wr62.5 be73 −10.1pp)/−1.54(n19 wr63 be68 −4.5pp)(毛) | FGI65/BTC77685 +0.34%/市值−2.03%/trending∩feed=AKE,ARB,ENA,LIT,UNI | **原子包1=S32接刀冷却EXP上线(tpl989)**:#80升门(ZKC全链日志第4实锤,LIKE%取证突破日志窗),6例4死2赢A/W-bar完美分离,stop→PATCH _exp→apply→start全绿,代码字节一致+config零泄漏+重播种100热清12→feed88残留0;ROUTE零差分十二连;刹车未触(6h−0.61/24h−1.54 vs 12.7/31.8线);烟雾task40排队(引擎预热中,下轮验完成) | 空头48h −2.29全系UAI单币(ex-UAI空头n19净0.00 wr68);UAI n5/−2.29距隔离1.71续watch;MAGMA网n2/−1.08距2.92;trend双币48h n0(TUT 4.7d/USELESS晋升后6h静默,aging advisory);费覆24h🔴(avg−0.081 vs +0.101线)12h🔴(−0.157,昨夜🟢二连被BULLA−1.37/AKE−1.31空单打断);S23影子cohort(19h) A-bar1胜6负vs W-bar4胜3负;#79零新增;audit无主改动0 |

| 09-03 00:1x-00:3xZ | 例行轮(max) | −1.37(n1)/+0.22(n3)/+0.22(n3)/+2.36(n10 wr70.0 be57.9 +12.1pp)/−1.63(n20 wr60.0 be64.3 −4.3pp)(毛) | FGI65/BTC77194−0.2%/mcap−2.7%/trend∩池{ARB,ENA,LIT,UNI} | **HOLD原子包0(12h费覆🟢二连强化+wr−be+12.1pp=S31基线修复趋势成立,无新证据簇不动刀);ROUTE v1.5零差分十一连(plan空,aging=TUT+USELESS双advisory留池,bl_sync desired15=§5#81);#81排自查点01:15Z抢窗(main bl14→15+USELESS/USDT)**→**01:15Z r1落地✓(bl15落库+重播种热清12 feed88残留0;详§5维护注09-03)** | 钱包159.3U(avail145.5+T margin14.3+浮−0.45);T多00:06:34在飞(S31 verdict后第5笔);增量3笔+0.22=UAI空+1.50(13.7m回拉)/MAGMA空+0.09/BULLA空SL穿刺−1.37(9.1m);死法24h=7×SL穿刺(空4笔−5.05分散4币+多接刀3笔−3.91=#80族存量)+1×硬超时(AGT);费覆24h🔴十连(avg−0.081 gap−0.181@ntl33.2U;20笔/日)/12h🟢二连(avg+0.236 gap+0.134,n10);UAI 48h回拉−2.29/n5距隔离1.71;MAGMA网n2/−1.08距线2.92;#79 n=32(MAGMA22:22双行第8案);S31 verdict后多头5笔+2.42(T多00:20平+0.47);S32/#80零新增(n3/反证n2);池ATR中位0.22(10/75过门)低波续暖;audit零无主(main1792/trend1793=上轮种子PATCH);margin Σ0.55✓;充值线未触(24h负,12h wr−be+12.1pp≥6pp两支已备) |
| 09-02 21:1x-21:4xZ | 例行轮(max) | 0(n0)/0(n0)/−0.65(n2)/+0.94(n9 wr66.7 be61.0 +5.7pp)/−1.85(n17 wr58.8 be64.8 −6.0pp)(毛) | FGI63/BTC77306+0.3%/mcap−2.65%/trend∩池{ARB,UNI,MARSCOIN}+USELESS(晋升) | **ROUTE:USELESS晋升trend执行(十连零差分后首计划;规则B trending∩池∧L净+0.81/nL3/wr100%;rotate双向→trend feed2/main feed89复核✓→trend空仓窗stop[poll1沉降]→PATCH symbols=[TUT,USELESS]复读落库→start running✓双币评估活;churn1≤4);原子包0=HOLD;bl同步14→15(+USELESS)登§5#81等main重启窗** | 钱包159.72U全空仓;**增量零新平仓轮**(末close16:52/末open16:29,零笔窗~4.9h):池ATR中位0.165<0.5(9/90币过ATR门)=死市防御性沉默,断流判据ATR支不满足不触查管道(管道实证活:90/90收K+硬过滤评估中+trend双币K线);死法24h=6×SL穿刺+1×硬超时(AGT);费覆24h🔴九连(avg−0.109 gap−0.208@ntl33.2U;17笔/日)**但12h首转🟢(+0.104 vs 0.098 gap+0.006,wr−be+5.7pp,n9薄)**;UAI −3.79/n4距隔离0.21零新增;MAGMA网n1续;S31 verdict后多头4笔+1.96判据远离;S32/#80零新增(死法n3/反证n2);#79 n31零新增;audit 1792/1790/1788零无主;margin Σ0.55✓;充值线未触(24h负) |
| 09-02 18:1x-18:3xZ | 例行轮(max) | 0(n0)/−0.65(n2)/+2.14(n7 wr71.4)/−0.24(n10 wr60.0 be61.3 −1.3pp)/−3.66(n21 wr57.1 be66.9 −9.8pp)(毛) | FGI63/BTC77370+0.2%/mcap−2.6%/trend∩池{ARB,SKR,LIT} | **HOLD原子包0;ROUTE v1.5零差分十连(plan空,bl14=期望态,TUT aging watch续,UAI −3.79/n4距隔离线0.21零新增)** | 钱包159.72U全空仓浮0;新平仓2:AGT S−0.71硬超时60.2m(15:05入36U震荡耗损型)+PROM L+0.065=BE保本离场22.7m(<hunger45m排除饥饿,#49几何按设计);S31监控:verdict后多头4笔+1.96;S30疫苗n1维持;#80零新增(死法n3/−3.89 反证n2/+3.74)S32续候;费覆24h🔴八连(avg−0.174 gap−0.275@均名义33.6U;21笔/日)12h−0.024微红/6h+0.306=3.0×费🟢;#79壳型n31零新增;+AGT主-主同笔双行1例(全量视图2行sid=main pnl差6e-5,binance_only已dedup账面无害=#18隙型族非#79收养型),全量视图新行sid=main齐;三壳RETIRED占位完好;audit零无主(1792/1790持平);feed90/1零漂移;刹车全距线(6h+2.14正/24h−2.3%);组保证金Σ0.55✓;充值线未触 |
| 09-02 15:1x-15:4xZ | 例行轮stub: HOLD;ROUTE零差分九连;#80第4实例结局BTR+2.36盈→反证分支生效S32改注有条件化;费覆🔴七连但3h/6h双绿;#79 n31;全文git 4a7b0ba版行 |
| 09-02 12:2x-12:5xZ | 例行轮stub: HOLD;ROUTE零差分八连;BTR12:24在飞=#80第4活体实例(结局裁门);UAI −3.79/n4距隔离0.21;费覆🔴六连gap−0.222;#79 n29;24h死法9亏−11.48三型;全文git c69176a版行 |
| 09-02 09:1x-09:3xZ | 例行轮stub: HOLD;ROUTE零差分七连;UAI 08:45 SL穿越+S19拦再入零接刀;#80不增累净−3.89;费覆🔴五连gap−0.158;#79 n27;全文git ed1ba85版行 |
| 09-02 06:2x | 例行轮stub: S31评判KEEP并入基线(段n22/15W7L毛−0.11,expect双达,劣化线双绿);ROUTE热清10币feed90;S32候选立案§4#80;费覆🔴四连首转负;#79 n26;全文git 910d5dc版行 |
