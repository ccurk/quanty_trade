...
|---|---|---|---|
| main断流观测(三闸交集关门) | 本轮main笔数=19/24h@09-06 21:1x(≈2.7h静默后窗新2笔恢复;低波折扣占比88%=死盘续;判据未触=引擎正确拒单;ATR中位史git 18ebd9a) | 09-06 09:1x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| 09-06 21:1x-21:3xZ | 例行轮(max) | −0.74(n1)/−0.59(n2)/−1.28(n4 wr50 be85)/−3.70(n9 wr33 be84)/−3.51(n22 wr50 be70)(毛) | FGI73 BTC79982+0.25% 市值−2.91% trending∩池=ARB,PUMP,NEAR | **HOLD 0原子包9连;ROUTE零差分6连(plan空;want.fade/brk=退役壳无动作);新知识落账§4#85穿刺簇法医学** | 窗新2笔均空侧决胜(NAORIS W-bar+0.144/DOOD A-bar SL−0.737)→S30镜像n21/+0.68(门净≤−3远);多cohort7/10零新;S31宽0.601(83/138)ON边缘=日内五摆;低波折扣88%死盘续;死法24h:SL穿刺7/−4.98超时4/−1.06赢11/+2.53;归因main15/−1.49壳4/−1.43·trend3/−0.59(BULLA watch4/6零新);#85=48h穿刺19笔中16深gap-through(mv3.8-5.3%/3-13m)−17.41=99%失血,加宽SL证伪,无可行动修复族;#79 n46零新(壳行8);KOMA3/−2.68·AKE5/−2.14零新;COLLECT CB240m≈21:21到期→#7域下轮观察;audit零无主;feed138/4∩∅;bl_sync desired=actual=17;钱包114.43全avail空仓;充值信号未触(12h−3.70);费覆组全🔴(main−0.154/trend−0.196 vs 3×费0.07);保证金0.55;avg_hold27m/22笔日;待落0;瘦身(18:1x stub化+§6/#79压缩) |
| 09-06 18:1x stub: HOLD8连;24h−2.82浅回撤;S30镜像n19多cohort7/10;宽0.623;#79 n46;PORTAL出watch;全文git 18ebd9a版行 |
| 09-06 15:1x stub: HOLD7连;MARSCOIN promo_hold失效留main;费覆main24h首🟢仅存1轮;宽0.196 OFF史最深;AKE watch新挂;全文git e6f5b0f版行 |
| 09-06 12:1x stub: HOLD6连;MARSCOIN晋升→promo_hold(#57族);充值信号首触发;宽0.493 N;全文git 838122c版行 |
| 09-06 09:1x+08:4x双stub: 24h转正HOLD5连宽0.652;S33精测不发货=git 838122c/044689a版行 |
> 瘦身注(指针集@09-06 18:1x归并): 09-05..09-06各轮stub指针集(933abbd/610475d/14eca0b/ff561cc/2af6466/6a3383a/ad3c8d4/e6f5b0f内含)=git e6f5b0f版§7两注原文。
|---|---|---|---|---|---|
