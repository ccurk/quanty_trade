...
| 载具 | id | 原型 | 池 | 状态 | 门/备注 |
|---|---|---|---|---|---|
| main 通才 | 8eb182b6 | 通才(S18-S23栈) | auto·**feed83@08-29 15:2x(ROUTE v1.5摘BAS,NIL→孤儿态待挂brk;前史feed85@14:5x=apply重播种热清15/15,HANA回池,4币→breakout池)** | running | pct0.08 sides=[buy,sell] **bl20@08-29 16:4x force窗(+BAS,NIL=desired20落地;隔离13+TUT+brk池4+BAS+NIL)** feed86@08-29 17:1x(v3.2首轮ROUTE清扫重启泄漏隔离8币out 94→86复核零残留;BTR残留待17:36自查点摘) **scp=0.05@08-28 09:33(EXP提频终裁rollback)** **long_conf_premium=0.15门0.70@08-29(owner提频直令+S30疫苗伴随;劣化回0.35;史#61c关闸0.90)** tpl972(+S30)@08-29;**trailing(act1.0/cb1.2%)+BE(1.0)=基线几何(#49KEEP)**;**_exp=open·EXP多头闸重开+S30疫苗@08-29 14:52(评08-31 15Z或多头n≥10;劣化线=多头段净≤−3U或磁铁型≥3→lcp回0.35,S30代码保留;前史ROLLBACK提频0.600档git 0940c62)**;RECOVER刹线6h空≤−8U继承;#11降级观察(§4) |
| qt-trend-long | 827ffe8c | 趋势动量多 | **TUT单币**(COTI出池@08-24 15:3x ROUTE#36触头注线;ACE隔离@08-22;史git f43756c/040d80d) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;**_exp=open·FIX连开解锁@08-28 03:3x(mces3→0 stop-poll1-PATCH-start✓;单币池cap=终身笔数上限死锁[§3连开条],防锤单=CB+cd180+reentry3m+6h保险;评08-31 00Z或TUT n≥3;回滚=cap3)**;⚠️mces=null曾两入#69三值包被双回滚(audit1755/1763)——本FIX=#69 verdict重开条款【新机制维度】行使:死锁语义08-28源码定谳为新证据,且只动cap、adt1.0/lcp0.15低波解锁线维持关闭;owner可一字段否决回cap3;config._exp误书'模板默认'以本条为准;史ROLLBACK#69终裁@08-25(段n11净≈−0.35→预注册回滚三值✓;**三次申请=churn禁区→trend低波解锁线关闭**,重开须新regime证据或新机制维度;verdict全文config._exp+git 5df52d2);**常驻保险=滚动6h净≤−5U→stop(继承)**;aging_watch[TUT]advisory按对账器头注线(滚动nL≥6∧L净<0)独立看护;三值包全史git 8a1d995/f71d825/5df52d2/492779a |
| qt-breakout-follow-v2 | 3b646bf4 | 突破追动量(S26内核+S27复活锚) | **{BTR,LIGHT,MAGMA,我踏马来了}**@08-29自main接走;+BAS,NIL挂池=16:22Z自查点押后(main侧已摘@15:2x孤儿态,先修sizing后挂) | running | **tpl973** pct0.05 mcp2 lev2 cd180 minconf0.60 sides双向 trailing(1.0/1.2%)+BE1.0;**_exp=open·FLEET复活@08-29 15:02(owner提频直令;评09-01 15Z或段n≥15;自动保险=滚动6h净≤−5U→stop;劣化回滚=stop+RETIRED占位+4币经bl_sync释放回main)**;MAGMA账户级隔离网继承(n5/−3.53,再亏≥0.47→隔离不论在哪池);live实证@14:49=S26核产分被S21/22正常veto;**⚠️sizing缺陷定谳@15:2x=壳缺order_amount_mode+conf_sizing→5U粉尘单(§3新条,违足额单仓直令),FIX六键=待落#76自查点16:22Z(trig_01TMgm);复活段@16:4x=n5/−0.39(2W3L,BTR打摆4笔−0.45,MAGMA多+0.05),全5U尺寸**;**⚠️双写污染@16:3x定谳(§4#77): brk每仓被main双记账+main守护共管(hunger 5/8 vs 3/3不同→45m+段实验污染;<45m段参数恰同=可用)**;旧壳FAIL翻案史见2111f5f9行 |
| ~~qt-fade-short-v2~~ | 7583727a | 冲高回落空·退役@08-28 21:2xZ终裁auto-C | — | stopped(gated,勿auto-start)·RETIRED/USDT占位@audit1780 | **_exp=closed·FLEET终裁@08-28 21:25Z双维度FAIL(签名域全窗n0+段净≈−0.70;auto-C字面执行;RETIRED占位=运维闸;tpl887在DB+谱系576/823/887存git;池5币已释放;复活=新壳FLEET;verdict全文config._exp+段细目git 8af6490链)**;**08-29 BTR行=main交易错标本壳(§6亚型B)**;预案/checkpoint史830a46c/91b3276/48ca3ce/f0e03bf;低波三值包组级知识a2e845f |
...
- 隔离区(规则≤−4U∧n≥4)【13】: 4/CYS/TST/龙虾/BMT/BTW/H/APR/AIO/BICO/BEAT/XNY/ACE(逐条血统/日期全文git bb3b883/8a797ec/bb2e系)。**池列值=快照,权威=每轮对账器输出**。**对账器v1.5权威副本=quanty-ledger分支ops/route_pools.py@08-29**(v1.5=roster增补breakout复活壳3b646bf4,阈值零改动;谱系v1.4←v1.3←61b1bb4;v1.0默认分支禁跑)。**arg4隔离表必须X/USDT形态**(08-15实证:裸名norm不match feed键→漏移)。出池只认头注规则或隔离,失格=aging_watch advisory;brk/lowvol出池阈值未注册(#42)前无自动出口。16:2x-16:4x自查点=**MAGMA网n6/−3.48(15:59 brk首MAGMA多+0.053盈笔改善,距−4线0.52,维持)**;主线撤=停机窗连环战(§3/§4#77);最近跑@08-29 15:2x(v1.5)=**plan{BAS,NIL→breakout}(want满6/6,churn2/4);main侧remove已执行feed85→83(斜杠形态二发成功,首发裸名静默no-op=§3新事实);brk侧add押后#76 sizing修复(16:22Z自查点);bl_sync desired20(+BAS,NIL,待窗采)**;15:0x(v1.5首跑)=BAS defer churn4/4;12:1x=零差分+MAGMA 13:25自查点裁+0.192未触网→**现行网=48h滚n5/−3.53,再亏≥0.47即≤−4U隔离(08-30 09:15Z最老−0.69滚出松至−2.85)**;09:1x/06:2x/03:1x/00:1x零差分+MAGMA网v1裁决史=git bf52ca3/ed40296;08-28 21:1x=bl_sync bl19→14已采(audit1781)+#36/#62-64 defer链结案;aging=trend[TUT] advisory;trending∩池@15:2x={BTR(brk池,榜上)}+{ENA,LIT,TRUMP}main池;#47门旧档案(ARIA,BTR,ONG/费覆连2判未熟)已被FLEET复活取代结案;#51-#58史git 9957041/1ae847c/91b3276/830a46c/188af33/66048a9
- 保证金: Σ_running=main0.08×5+trend0.05×3+brk0.05×2=**0.65≤0.75✓**(08-29 FLEET+0.10;前史0.55/0.63见git)
...
下一个新锚点编号：**S31**(S23-S30已用)。⚠️锚点自S24起分fork谱系: main=S4..S23;trend=+S24;fade-v2=+S25+S28;breakout=+S26(其均值回归核档案化)。apply前grep按该载具fork谱系核验。原注记:(历史上 S10 曾存在于注释引述，编号不复用)。
...
| # | 类型 | 内容（含完整意图） | 登记轮 | 状态 |
|---|---|---|---|---|
| 76 | FIX | brk(3b646bf4)空仓窗: stop-poll至stopped-PATCH原子写{order_amount_mode:percent_balance,conf_sizing_enabled:true,conf_sizing_min_notional_usdt:21,conf_sizing_min_mult:0.6,conf_sizing_max_mult:1.4,conf_sizing_conf_hi:0.55,_exp尾注FIX伴随sizing修复分界}-start验running;修复确认后rotate add [BAS/USDT,NIL/USDT]斜杠形态,验feed4→6;顺手MAGMA机械网复核 | 08-29 15:2x | open·16:22自查点brk有仓defer;**retry#2=17:36自查点在飞(trig_01YPFKcz验活@17:0x,老会话执行)**;17:0x v3.2首轮不抢窗(BTR仓在);brk stop若吞查logs q=failed(§3) |
...
| main断流观测(三闸交集关门) | 本轮main笔数=16/24h@08-29 17:0x(6h n2;−6.02中−4.79=已移交brk4币拖尾+NIL−1.40,残余池+0.17打平;漏斗活) | 08-28 18:1x | 判据不变:再现6h+零笔且池ATR中位≥0.5→查管道;每轮记main笔数 |
...
| S31·regime动态方向偏置(**升队首候选@08-29 17:0x owner动态化直令**) | v1谱:宽度regime三档(池内EMA-up占比<0.35=RISK_OFF/0.35-0.60=中性/>0.60=RISK_ON)→动态premium加减(OFF:多头prem+0.10;ON:多头−0.05空头+0.05),阈值内联防漂移,S31_ENABLED False-guard回滚,叠加于config prem之上(config回滚路径保留);main先行 | 08-29 17:0x | **执行窗=main当前_exp(多头闸+S30)评期到点接棒(08-31 15Z或多头n≥10先到),不烧在飞实验——其多头段样本兼作S31校准集;**v1草案已预制+验证@08-29 17:1x=ops/drafts/{s31_apply_patch.py,s31_notes.md}**(patcher全替换点唯一性断言,基底漂移即拒;py_compile✓6符号✓单元冒烟8场景✓;apply轮以现拉current_code跑patcher,锚点日期sed为实际apply日)**;劣化线届时预注册(草案:S31段多头净≤−3U或组wr−be劣化≥5pp@n≥20→guard关);owner可令"现在就换"提前 |
...
| 08-29 17:0x-17:2xZ | v3.2首轮(max) | −0.05/−1.77/−1.25/n12 −1.88/n23 −6.07(wr52/be80,毛均−0.264🔴六轮连红) | FGI68/BTC78066+0.5%/mcap−3.0%/trend∩池{PUMP,ENA} | **HOLD原子包0;ROUTE清扫=重启泄漏隔离8币out main feed94→86零残留(BTR留17:36);S31 v1草案预制+验证入ops/drafts/(patcher锚点断言+冒烟8场景,apply=main _exp评期接棒);#76不抢窗(17:36自查点验活);归因:24h组−6.07中−4.79=已移交brk4币拖尾伤+NIL−1.40孤儿,main残余池+0.17=路由已对症;brk段n6/−0.37全5U粉尘BTR打摆5笔;幻影行+1(TAC,累n2);无刹车无保险线** | 钱包≈165.8U;三_exp未到评期(多头n1/TUT n1/brk n6/15);下一步17:36→18:09cron |
...
| 08-29 16:22-16:5xZ | 自查点(max) | 6h n8−1.27 | — | **#76 defer(brk有仓)→连环战: ①MAGMA网n6/−3.48盈笔维持 ②发现main stop被吞→源码定谳异步乐观stop+幻影双写卡窗(§3) ③#77双写+双守护实锤(main管brk仓EXIT_AUDIT;M通道候部署) ④force窗bl20落地(desired20✓重启免疫) ⑤feed清扫94(BTR幻影卡待强平) ⑥无端重启n+1(15:30-16:26窗,BAS/NIL曾漏回56m零成交零害) ⑦retry#2排17:35** | brk复活段n5/−0.39全5U;踏马16:2x平;台账push本行 |
| 08-29 15:1x-15:4xZ | 例行轮(max) | −1.60/−1.08/n5 −1.86/n9 −2.71/n19 −5.76(wr53/be79,毛均−0.303🔴) | FGI68/BTC77932−1.9%/mcap−4.4%/BTR上trending | **病根轮: brk-v2粉尘单定谳(壳缺order_amount_mode+conf_sizing→notional默认→5U,源码§3)→1原子包=FIX#76六键排16:22Z自查点(trig_01TMgm);ROUTE v1.5=BAS,NIL→brk,main侧remove执行feed85→83孤儿过渡(裸名no-op→斜杠二发,§3);bl_sync desired20待窗;S30期首多NIL−1.40=温和档设计内+未接种入场,磁铁n1/多头段−1.40>−3U线;MAGMA网−3.53未动;brk首两单BTR −0.21秒穿+翻多在飞;trend TUT+0.33(FIX n1/3);无刹车** | 钱包≈166.3U(150.92可用+15.4保证金);三_exp未到评期;烟雾37/38行为代偿闭环(双载具live出单) |
| 08-29 14:3x-15:1xZ(owner live) | 交互轮(max) | 24h n18毛−3.97/12h n7−1.10(开仓口径);费覆🔴(红线被owner直令覆盖降级为评判指标) | FGI68/BTC77585−2.4%/mcap−4.7% | **owner提频直令→2原子包:①EXP多头闸重开+S30疫苗@main(lcp0.35→0.15门0.90→0.70;S30两位点;tpl567→972;stop-PATCH[lcp+bl18+_exp]-start-apply全链✓字节级一致✓零泄漏✓;评08-31 15Z或多头n≥10;劣化=多头段≤−3U或磁铁≥3→lcp回0.35) ②FLEET复活breakout载具(3b646bf4;壳tpl887→apply S26内核+S27=tpl973;池BTR/LIGHT/MAGMA/踏马自main接走;重播种漏15热清15/15→feed85,HANA回池;pct0.05 mcp2 lev2 cd180 minconf0.60双向;自动保险6h≤−5U→stop;评09-01 15Z或n≥15;live实证S26核产分+S21/22 veto正常);保证金0.65✓;对账器v1.5(roster+3b646bf4)plan=BAS→breakout defer下轮churn4/4;烟雾37/38 queued(状态端点404,live日志代偿);S31候选登记** | 决策依据=14:2x漏斗切片:22min 2000评估90.6%<0.55+多头55行被0.90墙拦(NIL/MAGMA 0.70+在内)+0.55-0.60空头档68行=08-28实测负档不放;频率买在质量通道(多头面+第二载具)不买垃圾档;MAGMA 12:09仓+0.192盈13:25自查点已裁未触网 |
| 08-29 12:1x-12:3xZ | 例行轮(max) | 24h n19毛−1.03净≈−1.45(wr58/be61,毛均−0.054🔴) | FGI68 | **HOLD;MAGMA 12:09空仓在飞→13:25自查点已裁+0.192盈未触网(新网≥0.47);ROUTE v1.4零差分;S30门LIGHT案不相关** | stub@08-29 15:1x;全文git ed40296 |
| 08-29 09:1x-09:4xZ | 例行轮(max) | 24h n23毛−0.82净≈−1.33(wr61/be63,毛均−0.036🔴) | FGI68 | **HOLD;MAGMA新机械网≥0.27;ROUTE v1.4零差分;S30门维持n2;LIGHT空在飞** | stub@08-29 15:1x;全文git 836ef84 |
| 08-29 06:1x-07:0xZ | 例行轮(max) | 24h n28毛−2.10净≈−2.73(wr54/be59,毛均−0.075🔴) | FGI68 | **1原子包=#72b(553c8c3推claude/dev-adoption-attribution候部署;BTR 04:29案实锤亚型B跨owner域陈旧orderMeta收养);ROUTE零差分;MAGMA watch双机械网;充值信号断** | stub@08-29 12:2x;全文git 0f4c6ac |
| 08-29 03:1x-03:4xZ | 例行轮(max) | 24h n28+0.22(wr57/be57,毛均+0.008🔴«3费0.067) | FGI68 | **HOLD;ROUTE零差分;充值信号6轮连触后断;S30门AKE案核验非磁铁型n2维持;MAGMA watch距隔离线一步CB2** | stub@08-29 12:2x;全文git 0f4c6ac |
| 08-29 00:1x-00:3xZ | 例行轮(max) | 24h n27+3.06(wr63/be54=+9pp,毛均+0.113🟢) | FGI68 | **HOLD;ROUTE零差分;充值信号第6轮形式续触owner悬;S30磁铁门n2维持;SPX短仓开00:05链✓** | stub@08-29 09:x;全文git c1850f9 |
...
> 瘦身注(压缩@08-29 15:1x): 08-29 09:1x=836ef84; 08-29 12:1x(漏斗证据+自查点裁决全文)=ed40296。
> 瘦身注(压缩@08-29 12:2x): 08-29 06:1x(#72b亚型B实锤+553c8c3候部署全文)与08-29 03:1x(S30 AKE案核验+MAGMA CB2 watch全文)=0f4c6ac。
> 瘦身注(压缩@08-29 09:2x): 08-28 21:1x(v2终裁auto-C+bl_sync bl19→14全文)与08-29 00:1x(充值信号第6触+SPX开仓链)=c1850f9。
> 瘦身注(压缩@08-29 03:3x): 08-28 15:1x(HOLD+充值信号第3触TG呈报[BAS集中度告警]+三_exp在飞评期未到+MELANIA签名域擦肩案)=27367d3。
|---|---|---|---|---|---|
