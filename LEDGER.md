...
| qt-trend-long | 827ffe8c | 趋势动量多 | ACE/TUT/COTI(feed3=种子3✓;**aging_watch=ACE/COTI/TUT advisory@08-17 21:2x**[ACE 48h L n6/+0.41续<1.5失格线,保留;COTI n2/−0.89;TUT 48h零笔];S24 keep后漂移观察→24h n5/+0.73 wr60%) | running | **tpl575(S24)** pct0.05 mcp3 buy trailing on;**归因修正@09:2x**:BICO 04:02(+0.57)/07:57(−1.90)两行盖trend sid实为main开仓(trend日志零开仓行,main日志全链;S24 keep判据'36h零新笔'修正后仍真);正牌08-16=ACE+0.02@06:46+COTI多在飞@09:30;**_exp=closed@06:35:12Z: S24终裁keep结案**(预注册当值格'净>0=keep':链n33/+0.024>0;末笔08-15 18:17 BICO−0.91,终裁前36h零新笔=03:11后零笔复核@06:35;程序=真空仓窗stop[poll1沉降]-PATCH-start,种子3币完好);**常驻保险(继承canary)=滚动6h净≤−5U→stop本载具**;实验槽空闲;候选EXP降prem=§4#55(费覆红线内只登记) |
...
| 18 | M通道 | closed窗口边界播种修复(幻影行族根因) | 幻影三形态全史+标本链见git 26eaf24 #18行(BTW隙5幻影/镜像行/ROBO整60m例) | n/a | **修复部署@08-15**(f4848f8封边界播种;隙型=另一路径未封,形态与矛盾链存git bb3b883);观察4翻案7隙行/观察5同窗0/观察6拉5全旧→观察8@21:2x拉0幻影(45/45全实);行集随重拉波动=懒生成方向;滤行纪律无限期保留;结案重置=隙型机制源码查明或#56部署后复核 →**观察14@08-18 18:2x:0/22全实(连8轮)** |
...
| 61 | E7类观察(main) | **main多头溢价墙→#61实验族**:22h零笔分解=多头候选撞门;族史=#61(prem0.35→0.25,门0.80快照口径错)→#61b(→0.20,门0.75,天花板0.76直查)→**#61c在飞@08-18 21:2x(→0.19,门0.74,浮点边界破案:0.750原生档=主流量被0.75精确门拒,§3天花板条补记)** | 三层机制全落源码+日志:0.80不可达/0.75浮点拒/0.76 ATR拦;全史git d19c710系+ba346aa+0940c62+95e4c9f | 在飞 | 裁决按_exp预注册(eval 08-21 12:30Z或段n≥15;段6h≤−5U或载具6h≤−8U提前回滚;rollback=0.35);判据:eval期段n≥10净>0=keep并议下一步;段仍n=0→议低波折扣校准或epsilon代码修复(非再降门) |
...
| 58 | E9类(main扩仓) | **main pct 0.08→0.10**(config-only;Σ=0.10×5+0.05×3=0.65≤0.75✓;回滚=回0.08) | main载具费覆首次12h/24h双🟢@08-17 09:2x(24h n12/+4.74 avg+0.395=3.8×费 wr83全空侧;12h+0.167=1.6×);硬边界#1按载具判=允许,组口径🔴不锁单载具扩仓但#57在飞收养竞态=fade config接管main赢家仓(BEAT/BLUAI实证)→扩仓入缺陷不洁 | n=12段 | 候选@09:2x;**门=①a451d32部署+#57双行归零观察2轮 ②main 24h费覆🟢维持 ③执行窗现拉复核净为正**;执行走EXP _exp预注册(main槽空闲);**门②失守@13:0x轮**(main 24h avg+0.009🔴/12h−0.485🔴);**门②复得@18:1x**(main24h avg+0.203=1.4×🟢,n4薄);门①a451d32未部署续锁=不可执行 |
...
| 08-19 00:15-00:3xZ | 例行轮(max) | 1h0(0)/3h0(0)/6h−2.28(1)/12h−0.06(3)/24h+4.85(7,wr71) | FGI46/BTC+0.24%/市值+0.19%无降压;trending∩main=VVV | **0原子包=HOLD**(零新平仓笔[末笔仍JCT 20:28],#61c在飞n=0未到评期08-21 12:30Z,队列空);ROUTE plan={}(want.fade=STAR/brk=ACE·CLO·JCT存档);刹车全绿;fade gated续停✓ | **#61c流量观测**:PATCH后2.9h多头上尾=0.720×26(PROM/SHAZ/RIF等)+0.700×2,**0.750原生档零出现**(隔夜静默;臂活性已证:门0.74正确拒PROM0.72@00:13,评分线00:17持续);两引擎IDLE活性✓(trend 3/3);死法24h:WIN5(STAR×3+4.97 CLO×2+2.22)+SL2(JCT−2.28 ACE刮痕−0.06)零穿刺零饥饿零超时;费覆:组24h avg+0.69(n7)🟢 main+0.82(n6,wr83)🟢 trend n1🔴(#55续锁);幻影0/21连10轮;audit零无主(末条21:20本方PATCH);bl15=desired✓ feed90泄漏0;钱包224.60空仓3.9h;12h非双正→充值不触发 |
| 08-18 21:13-21:4xZ | 例行轮(max) | 1h−2.28(1)/3h−2.28(1)/6h−0.06(3)/12h−0.06(3)/24h+4.85(7,wr71) | FGI41/BTC+0.4%/市值+0.2%无降压;trending∩main=VVV | 1原子包=**EXP#61c prem0.20→0.19(门0.74)·#61b浮点边界破案**:0.75原生档10行全拒(JCT/ALPINE/VELVET/1000RATS,左结合0.7499999999999999<0.75精确门,L794-797)+0.76档11行全ATR<0.5拦+0.78+零出现⇒#61b段结构n=0;空仓窗全序poll1沉降,PATCH零泄漏;重播种#19补刀清10→feed90泄漏0;ROUTE plan={};刹车全绿;#55续锁(trend 24h n1净负费覆🔴) | 死法24h:TP/trailing 5W(STAR×3+4.97 CLO×2+2.22)+SL2(JCT−2.28/17.8m ACE刮痕−0.06/2.6m),零穿刺零饥饿零超时;费覆:组24h avg+0.69🟢 main24h avg+0.82(n6,wr83)🟢;trend24h n1🔴48h n7/+0.29均净0.04🔴;幻影0/22连9轮;audit零无主(末条21:3x本方PATCH);钱包224.60空仓;12h非双正→充值信号本轮不触发 |
| 08-18 18:13-18:4xZ | 例行轮(max) | 1h+0.38(1)/3h+2.22(2)/6h+2.22(2)/12h+2.55(4,wr75)/24h+7.13(6,wr83 be4) | FGI41/BTC+0.6%/市值+0.25%无降压;trending∩main=VVV(BTW隔离在榜≠rehab) | 0原子包;**⚖️幽灵STAR翻案=头条**(5/5开仓信号在main日志流+trend对照+buy-only铁判据→§3翻案注;main真24h n5/+7.19 wr100=CLO×2+STAR×3);ROUTE plan={}(want.brk+CLO存档);刹车全绿;**充值信号真触发呈owner**(12h/24h双正+12h wr−be68pp,n4/6薄如实注记;常备令→建议充至250-300U);#61b段多头n=0流量观察(0.76上尾6次全ATR%<0.5拦,臂非死,§4#61);#47组费覆门首达成但呈追加门建议(候#56/#57部署) | 死法24h:trailing锁盈5W(CLO+1.84过TP续跑/+0.38回吐锁盈实录)+刮痕1(ACE−0.06/2m),零穿刺零饥饿零超时=#49几何满分轮;费覆:组24h avg+1.188=11.8×红线🟢/48h avg+0.267=2.6×🟢;main🟢 trend 24h n1🔴(#55续锁);trend 13:43 ACE信号无成交n=1观察;#60→15;幻影0/22连8轮;audit零无主(末条=15:32本方PATCH);钱包226.94空仓 |
| 08-18 15:17Z | 例行轮(max) | 24h+5.57(6,wr67) | FGI41无降压;trending∩main=VVV | 1原子包=**EXP#61→#61b空臂修正**:prem0.25→0.20(门0.75;根因=评分天花板0.76,36h直查0.78+零出现,§3天花板条),metric/评期/刹车全不变,rollback=0.35,真空仓窗全序零漂移;重播种#18补刀清11→feed89泄漏0;ROUTE plan={};刹车全绿 | "24h利幽灵主导/ex-ghost"口径→18:2x翻案作废(STAR本就main);死法24h:WIN4/+6.01 超时1/−0.38 trailing刮痕1/−0.06;幻影0/22连7轮;钱包224.79;全文git 0940c62 |
| 08-18 12:21Z | 例行轮(max) | 24h+6.12(8,wr62) | FGI41 | 1原子包=EXP#61执行 prem0.35→0.25(空仓窗全序);重播种#17补刀清13→feed87;ROUTE plan={};#55 12:00Z审议=续锁(trend载具费覆🔴,硬边界#1按载具判);刹车全绿 | #61的0.80门快照口径错→15:1x证伪转#61b;"ex-ghost"口径→18:2x翻案作废;全文git ba346aa |
|---|---|---|---|---|---|
